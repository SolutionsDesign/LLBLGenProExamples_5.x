...
namespace NWService.Dtos.Persistence
{
	...
	public static partial class OrderDetailPersistence
	{
		...
		/// <summary>Linq specific partial method for obtaining projection adjustments for the projection method <see cref="ProjectToOrderDetail(System.Linq.IQueryable{NWService.Dal.EntityClasses.OrderDetailEntity})"/></summary>
		...
		static partial void GetAdjustmentsForProjectToOrderDetail(ref System.Linq.Expressions.Expression<Func<NWService.Dal.EntityClasses.OrderDetailEntity, NWService.Dtos.DtoClasses.OrderDetail>> projectionAdjustments);
		/// <summary>QuerySpec specific partial method for obtaining projection adjustments for the projection method <see cref="ProjectToOrderDetail(EntityQuery{NWService.Dal.EntityClasses.OrderDetailEntity}, NWService.Dal.FactoryClasses.QueryFactory)"/></summary>
		/// <param name="projectionAdjustments">Set this argument in an implementation of this partial method to a projection lambda similar to the generated projection in <see cref="ProjectToOrderDetail(EntityQuery{NWService.Dal.EntityClasses.OrderDetailEntity}, NWService.Dal.FactoryClasses.QueryFactory)"/></param>
		/// <remarks>QuerySpec specific</remarks>
		static partial void GetAdjustmentsForProjectToOrderDetailQs(ref System.Linq.Expressions.Expression<Func<NWService.Dtos.DtoClasses.OrderDetail>> projectionAdjustments);
