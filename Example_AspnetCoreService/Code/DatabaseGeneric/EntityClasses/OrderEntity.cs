...
namespace NWService.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class OrderEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("OrderEntity", InheritanceHierarchyType.None, false, (int)NWService.Dal.EntityType.OrderEntity, typeof(OrderEntity), typeof(OrderEntityFactory), false);
				AddNavigatorMetaData<OrderEntity, EntityCollection<OrderDetailEntity>>("OrderDetails", a => a._orderDetails, (a, b) => a._orderDetails = b, a => a.OrderDetails, () => new OrderRelations().OrderDetailEntityUsingOrderId, typeof(OrderDetailEntity), (int)NWService.Dal.EntityType.OrderDetailEntity);
				AddNavigatorMetaData<OrderEntity, CustomerEntity>("Customer", "Orders", (a, b) => a._customer = b, a => a._customer, (a, b) => a.Customer = b, NWService.Dal.RelationClasses.StaticOrderRelations.CustomerEntityUsingCustomerIdStatic, ()=>new OrderRelations().CustomerEntityUsingCustomerId, null, new int[] { (int)OrderFieldIndex.CustomerId }, null, true, (int)NWService.Dal.EntityType.CustomerEntity);
				AddNavigatorMetaData<OrderEntity, EmployeeEntity>("Employee", "Orders", (a, b) => a._employee = b, a => a._employee, (a, b) => a.Employee = b, NWService.Dal.RelationClasses.StaticOrderRelations.EmployeeEntityUsingEmployeeIdStatic, ()=>new OrderRelations().EmployeeEntityUsingEmployeeId, null, new int[] { (int)OrderFieldIndex.EmployeeId }, null, true, (int)NWService.Dal.EntityType.EmployeeEntity);
				AddNavigatorMetaData<OrderEntity, ShipperEntity>("Shipper", "Orders", (a, b) => a._shipper = b, a => a._shipper, (a, b) => a.Shipper = b, NWService.Dal.RelationClasses.StaticOrderRelations.ShipperEntityUsingShipViaStatic, ()=>new OrderRelations().ShipperEntityUsingShipVia, null, new int[] { (int)OrderFieldIndex.ShipVia }, null, true, (int)NWService.Dal.EntityType.ShipperEntity);
			}
		}
