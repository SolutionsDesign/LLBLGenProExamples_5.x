...
namespace NWService.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class EmployeeEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("EmployeeEntity", InheritanceHierarchyType.None, false, (int)NWService.Dal.EntityType.EmployeeEntity, typeof(EmployeeEntity), typeof(EmployeeEntityFactory), false);
				AddNavigatorMetaData<EmployeeEntity, EntityCollection<EmployeeEntity>>("Employees", a => a._employees, (a, b) => a._employees = b, a => a.Employees, () => new EmployeeRelations().EmployeeEntityUsingReportsTo, typeof(EmployeeEntity), (int)NWService.Dal.EntityType.EmployeeEntity);
				AddNavigatorMetaData<EmployeeEntity, EntityCollection<OrderEntity>>("Orders", a => a._orders, (a, b) => a._orders = b, a => a.Orders, () => new EmployeeRelations().OrderEntityUsingEmployeeId, typeof(OrderEntity), (int)NWService.Dal.EntityType.OrderEntity);
				AddNavigatorMetaData<EmployeeEntity, EmployeeEntity>("Employee", "Employees", (a, b) => a._employee = b, a => a._employee, (a, b) => a.Employee = b, NWService.Dal.RelationClasses.StaticEmployeeRelations.EmployeeEntityUsingEmployeeIdReportsToStatic, ()=>new EmployeeRelations().EmployeeEntityUsingEmployeeIdReportsTo, null, new int[] { (int)EmployeeFieldIndex.ReportsTo }, null, true, (int)NWService.Dal.EntityType.EmployeeEntity);
				AddNavigatorMetaData<EmployeeEntity, RegionEntity>("Region1", "Employees", (a, b) => a._region1 = b, a => a._region1, (a, b) => a.Region1 = b, NWService.Dal.RelationClasses.StaticEmployeeRelations.RegionEntityUsingRegionIdStatic, ()=>new EmployeeRelations().RegionEntityUsingRegionId, null, new int[] { (int)EmployeeFieldIndex.RegionId }, null, true, (int)NWService.Dal.EntityType.RegionEntity);
			}
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoRegion1() { return CreateRelationInfoForNavigator("Region1"); }
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathRegion1 { get { return _staticMetaData.GetPrefetchPathElement("Region1", CommonEntityBase.CreateEntityCollection<RegionEntity>()); } }
		...
		/// <remarks>Mapped on  table field: "Employees"."RegionID".<br/>Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		...
		public virtual EntityCollection<EmployeeEntity> Employees { get { return GetOrCreateEntityCollection<EmployeeEntity, EmployeeEntityFactory>("Employee", true, false, ref _employees); } }
		...
		{
			get { return _region1; }
			set { SetSingleRelatedEntityNavigator(value, "Region1"); }
		}
...
namespace NWService.Dal.RelationClasses
{
	...
	public partial class EmployeeRelations: RelationFactory
	{
		...
		/// <summary>Returns a new IEntityRelation object, between EmployeeEntity and RegionEntity over the m:1 relation they have, using the relation between the fields: Employee.RegionId - Region.RegionId</summary>
		public virtual IEntityRelation RegionEntityUsingRegionId
		{
			get	{ return ModelInfoProviderSingleton.GetInstance().CreateRelation(RelationType.ManyToOne, "Region1", false, new[] { RegionFields.RegionId, EmployeeFields.RegionId }); }
		}
