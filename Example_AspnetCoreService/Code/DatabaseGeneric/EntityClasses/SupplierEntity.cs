...
namespace NWService.Dal.EntityClasses
{
	...
	
	{
		...
		protected class SupplierEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("SupplierEntity", InheritanceHierarchyType.None, false, (int)NWService.Dal.EntityType.SupplierEntity, typeof(SupplierEntity), typeof(SupplierEntityFactory), false);
				AddNavigatorMetaData<SupplierEntity, EntityCollection<ProductEntity>>("Products", a => a._products, (a, b) => a._products = b, a => a.Products, () => new SupplierRelations().ProductEntityUsingSupplierId, typeof(ProductEntity), (int)NWService.Dal.EntityType.ProductEntity);
			}
		}
