...
namespace NWService.Dal.HelperClasses
{
	...
	internal class ModelInfoProviderCore : ModelInfoProviderBase
	{
		...
		private void InitCategoryEntityInfo()
		{
			...
			this.AddElementFieldInfo("CategoryEntity", "CategoryName", typeof(System.String), false, false, false, true,  (int)CategoryFieldIndex.CategoryName, 15, 0, 0);
