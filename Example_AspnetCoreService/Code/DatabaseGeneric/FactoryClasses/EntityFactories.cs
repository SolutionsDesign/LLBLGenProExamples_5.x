...
namespace NWService.Dal.FactoryClasses
{
	...
	{
		private readonly NWService.Dal.EntityType _typeOfEntity;
		...
		public EntityFactoryBase2(string entityName, NWService.Dal.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
