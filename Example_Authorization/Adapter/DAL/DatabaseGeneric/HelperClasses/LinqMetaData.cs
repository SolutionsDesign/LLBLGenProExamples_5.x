...
namespace SD.LLBLGen.Pro.Examples.Authorization.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		public DataSource2<CustomersEntity> Customers {	get { return new DataSource2<CustomersEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		
		/// <summary>returns the datasource to use in a Linq query when targeting EmployeesEntity instances in the database.</summary>
		public DataSource2<EmployeesEntity> Employees {	get { return new DataSource2<EmployeesEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		...
		public DataSource2<OrdersEntity> Orders {	get { return new DataSource2<OrdersEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
