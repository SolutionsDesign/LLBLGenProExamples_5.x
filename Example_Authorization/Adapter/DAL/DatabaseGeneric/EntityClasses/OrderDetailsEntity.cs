...
namespace SD.LLBLGen.Pro.Examples.Authorization.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public OrderDetailsEntity():base("OrderDetailsEntity")
		{
		...
		public OrderDetailsEntity(IValidator validator):base("OrderDetailsEntity")
		{
		...
		public OrderDetailsEntity(System.Int32 orderId, System.Int32 productId):base("OrderDetailsEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this OrderDetailsEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public OrderDetailsEntity(System.Int32 orderId, System.Int32 productId, IValidator validator):base("OrderDetailsEntity")
		{
			InitClassEmpty(validator, null);
			this.OrderId = orderId;
			this.ProductId = productId;
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			...
			{
				case "Orders":
					this.Orders = (OrdersEntity)entity;
					break;
				default:
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Orders":
					toReturn.Add(Relations.OrdersEntityUsingOrderId);
					break;
				default:
					break;				
			}
		...
		public virtual IRelationPredicateBucket GetRelationInfoOrders()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(OrdersFields.OrderId, null, ComparisonOperator.Equal, this.OrderId));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(OrderDetailsEntityFactory));
		}
#if !CF
		...
		private void SetupSyncOrders(IEntityCore relatedEntity)
		{
			if(_orders!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _orders, new PropertyChangedEventHandler( OnOrdersPropertyChanged ), "Orders", SD.LLBLGen.Pro.Examples.Authorization.RelationClasses.StaticOrderDetailsRelations.OrdersEntityUsingOrderIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(OrdersEntityFactory))),	(IEntityRelation)GetRelationsForField("Orders")[0], (int)SD.LLBLGen.Pro.Examples.Authorization.EntityType.OrderDetailsEntity, (int)SD.LLBLGen.Pro.Examples.Authorization.EntityType.OrdersEntity, 0, null, null, null, null, "Orders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)SD.LLBLGen.Pro.Examples.Authorization.EntityType.OrderDetailsEntity; }
		}
