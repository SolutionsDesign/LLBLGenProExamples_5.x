...
namespace SD.LLBLGen.Pro.Examples.Auditing.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// <inheritdoc/>
		protected override IEntityFactory GetEntityFactoryFromCache(int entityTypeEnumValue) { return EntityFactoryFactory.GetFactory((SD.LLBLGen.Pro.Examples.Auditing.EntityType)entityTypeEnumValue); }

		/// <inheritdoc/>
		protected override Type LLBLGenProEntityTypeEnumType
		{
			get { return typeof(SD.LLBLGen.Pro.Examples.Auditing.EntityType); }
		}
