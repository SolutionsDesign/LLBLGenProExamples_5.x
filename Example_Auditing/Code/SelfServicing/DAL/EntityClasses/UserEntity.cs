...
namespace SD.LLBLGen.Pro.Examples.Auditing.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private bool	_alwaysFetchAuditActionTypeCollectionViaAuditInfo, _alreadyFetchedAuditActionTypeCollectionViaAuditInfo;
		...
		public UserEntity(System.String userId, IPrefetchPath prefetchPathToUse):base("UserEntity")
		{
		...
		protected UserEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			_auditActionTypeCollectionViaAuditInfo = (SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.AuditActionTypeCollection)info.GetValue("_auditActionTypeCollectionViaAuditInfo", typeof(SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.AuditActionTypeCollection));
			_alwaysFetchAuditActionTypeCollectionViaAuditInfo = info.GetBoolean("_alwaysFetchAuditActionTypeCollectionViaAuditInfo");
			_alreadyFetchedAuditActionTypeCollectionViaAuditInfo = info.GetBoolean("_alreadyFetchedAuditActionTypeCollectionViaAuditInfo");
		...
		protected override void PerformPostReadXmlFixups()
		{
			...
			_alreadyFetchedAuditActionTypeCollectionViaAuditInfo = (_auditActionTypeCollectionViaAuditInfo.Count > 0);
		}
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				case "AuditInfo":
					...
					break;
				case "AuditActionTypeCollectionViaAuditInfo":
					toReturn.Add(Relations.AuditInfoEntityUsingUserId, "UserEntity__", "AuditInfo_", JoinHint.None);
					toReturn.Add(AuditInfoEntity.Relations.AuditActionTypeEntityUsingAuditActionTypeId, "AuditInfo_", string.Empty, JoinHint.None);
					break;
				default:
					break;				
			}
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue("_auditActionTypeCollectionViaAuditInfo", (!this.MarkedForDeletion?_auditActionTypeCollectionViaAuditInfo:null));
			info.AddValue("_alwaysFetchAuditActionTypeCollectionViaAuditInfo", _alwaysFetchAuditActionTypeCollectionViaAuditInfo);
			info.AddValue("_alreadyFetchedAuditActionTypeCollectionViaAuditInfo", _alreadyFetchedAuditActionTypeCollectionViaAuditInfo);
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "AuditActionTypeCollectionViaAuditInfo":
					...
					if(entity!=null)
					{
						this.AuditActionTypeCollectionViaAuditInfo.Add((AuditActionTypeEntity)entity);
					}
					break;
				default:
		...
		public virtual SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.AuditInfoCollection GetMultiAuditInfo(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedAuditInfo || forceFetch || _alwaysFetchAuditInfo) && !this.IsSerializing && !this.IsDeserializing && !this.InDesignMode)
			{
				...
				_auditInfo.GetMultiManyToOne(null, this, filter);
		...
		protected override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("AuditActionTypeCollectionViaAuditInfo", _auditActionTypeCollectionViaAuditInfo);
			return toReturn;
		}
		...
		{
			get { return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.AuditInfoCollection(), (IEntityRelation)GetRelationsForField("AuditInfo")[0], (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.UserEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.AuditInfoEntity, 0, null, null, null, "AuditInfo", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathAuditActionTypeCollectionViaAuditInfo
		{
			get
			{
				IEntityRelation intermediateRelation = Relations.AuditInfoEntityUsingUserId;
				intermediateRelation.SetAliases(string.Empty, "AuditInfo_");
				return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.AuditActionTypeCollection(), intermediateRelation,	(int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.UserEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.AuditActionTypeEntity, 0, null, null, GetRelationsForField("AuditActionTypeCollectionViaAuditInfo"), "AuditActionTypeCollectionViaAuditInfo", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		/// <summary> Retrieves all related entities of type 'AuditActionTypeEntity' using a relation of type 'm:n'.<br/><br/>
		/// </summary>
		/// <remarks>This property is added for databinding conveniance, however it is recommeded to use the method 'GetMultiAuditActionTypeCollectionViaAuditInfo()', because 
		/// this property is rather expensive and a method tells the user to cache the result when it has to be used more than once in the same scope.</remarks>
		public virtual SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.AuditActionTypeCollection AuditActionTypeCollectionViaAuditInfo
		{
			get { return GetMultiAuditActionTypeCollectionViaAuditInfo(false); }
		}
		...
		{
			get	{ return _alwaysFetchAuditActionTypeCollectionViaAuditInfo; }
			set	{ _alwaysFetchAuditActionTypeCollectionViaAuditInfo = value; }
		}
		...
		{
			get { return _alreadyFetchedAuditActionTypeCollectionViaAuditInfo;}
			set 
			{
				if(_alreadyFetchedAuditActionTypeCollectionViaAuditInfo && !value && (_auditActionTypeCollectionViaAuditInfo != null))
				{
					_auditActionTypeCollectionViaAuditInfo.Clear();
				}
				_alreadyFetchedAuditActionTypeCollectionViaAuditInfo = value;
			}
		}
		...
		{ 
			get { return (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.UserEntity; }
		}
