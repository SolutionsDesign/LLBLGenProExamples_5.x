...
namespace SD.LLBLGen.Pro.Examples.Auditing.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderAuditInfoEntity);
		...
		{
			this.PerformDesetupSyncRelatedEntity( _order, new PropertyChangedEventHandler( OnOrderPropertyChanged ), "Order", SD.LLBLGen.Pro.Examples.Auditing.RelationClasses.StaticOrderAuditInfoRelations.OrderEntityUsingOrderIdStatic, true, signalRelatedEntity, "OrderAuditInfo", resetFKFields, new int[] { (int)OrderAuditInfoFieldIndex.OrderId } );		
			_order = null;
		}
		...
		private void SetupSyncOrder(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _order, new PropertyChangedEventHandler( OnOrderPropertyChanged ), "Order", SD.LLBLGen.Pro.Examples.Auditing.RelationClasses.StaticOrderAuditInfoRelations.OrderEntityUsingOrderIdStatic, true, ref _alreadyFetchedOrder, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.OrderCollection(), (IEntityRelation)GetRelationsForField("Order")[0], (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderAuditInfoEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderEntity, 0, null, null, null, "Order", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual OrderEntity Order
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "OrderAuditInfo", "Order", _order, true); 
				}
			}
		}
		...
		{ 
			get { return (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderAuditInfoEntity; }
		}
