...
namespace SD.LLBLGen.Pro.Examples.Auditing.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected SupplierEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			_categoriesCollectionViaProducts = (SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.CategoryCollection)info.GetValue("_categoriesCollectionViaProducts", typeof(SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.CategoryCollection));
		...
		{
			get { return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.ProductCollection(), (IEntityRelation)GetRelationsForField("Products")[0], (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.SupplierEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.ProductEntity, 0, null, null, null, "Products", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		public static IPrefetchPathElement PrefetchPathCategoriesCollectionViaProducts
		{
			get
			{
				...
				return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.CategoryCollection(), intermediateRelation,	(int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.SupplierEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CategoryEntity, 0, null, null, GetRelationsForField("CategoriesCollectionViaProducts"), "CategoriesCollectionViaProducts", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		/// this property is rather expensive and a method tells the user to cache the result when it has to be used more than once in the same scope.</remarks>
		public virtual SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.CategoryCollection CategoriesCollectionViaProducts
		{
		...
		{ 
			get { return (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.SupplierEntity; }
		}
