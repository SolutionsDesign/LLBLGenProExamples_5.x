...
namespace SD.LLBLGen.Pro.Examples.Auditing.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class CategoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("CategoryEntity", InheritanceHierarchyType.None, false, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CategoryEntity, typeof(CategoryEntity), typeof(CategoryEntityFactory), false);
				AddNavigatorMetaData<CategoryEntity, SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.ProductCollection>("Products", a => a._products, (a, b) => a._products = b, a => a.Products, () => new CategoryRelations().ProductEntityUsingCategoryId, typeof(ProductEntity), (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.ProductEntity);
				AddNavigatorMetaData<CategoryEntity, SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.SupplierCollection>("SuppliersCollectionViaProducts", a => a._suppliersCollectionViaProducts, (a, b) => a._suppliersCollectionViaProducts = b, a => a.SuppliersCollectionViaProducts, () => new CategoryRelations().ProductEntityUsingCategoryId, () => new ProductRelations().SupplierEntityUsingSupplierId, "CategoryEntity__", "Product_", typeof(SupplierEntity), (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.SupplierEntity);
			}
		}
		...
		{
			return PerformMultiEntityLazyLoading<SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.ProductCollection>("Products", forceFetch, entityFactoryToUse, (c,r)=>c.GetMultiManyToOne(this, null, filter));
		}
		...
		public SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.SupplierCollection GetMultiSuppliersCollectionViaProducts(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
			...
			return PerformMultiEntityLazyLoading<SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.SupplierCollection>("SuppliersCollectionViaProducts", forceFetch, entityFactoryToUse, (c,r)=>c.GetMulti(filter, r));
		}
		...
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathSuppliersCollectionViaProducts { get { return _staticMetaData.GetPrefetchPathElement("SuppliersCollectionViaProducts", new SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.SupplierCollection()); } }
		...
		public virtual SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.SupplierCollection SuppliersCollectionViaProducts { get { return GetMultiSuppliersCollectionViaProducts(false); } }
		...
		{
			get	{ return GetAlwaysFetchValueForNavigator("SuppliersCollectionViaProducts"); }
			set	{ SetAlwaysFetchValueForNavigator("SuppliersCollectionViaProducts", value); }
		}
		...
		{
			get { return GetAlreadyFetchedValueForNavigator("SuppliersCollectionViaProducts");}
			set { SetAlreadyFetchedValueForNavigator("SuppliersCollectionViaProducts", value, true);}
		}
