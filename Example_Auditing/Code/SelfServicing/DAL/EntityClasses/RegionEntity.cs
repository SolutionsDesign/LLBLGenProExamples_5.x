...
namespace SD.LLBLGen.Pro.Examples.Auditing.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			_territories = (SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.TerritoryCollection)info.GetValue("_territories", typeof(SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.TerritoryCollection));
		...
		{
			get { return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.TerritoryCollection(), (IEntityRelation)GetRelationsForField("Territories")[0], (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.RegionEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.TerritoryEntity, 0, null, null, null, "Territories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		public virtual SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.TerritoryCollection Territories
		{
		...
		{ 
			get { return (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.RegionEntity; }
		}
