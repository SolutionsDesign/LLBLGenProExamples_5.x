...
namespace SD.LLBLGen.Pro.Examples.Auditing.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private bool	_territoriesReturnsNewIfNotFound;
		...
		{
			return PerformSingleEntityLazyLoading<EmployeeEntity>("Employees", forceFetch, _employeesReturnsNewIfNotFound, e=>e.FetchUsingPK(this.EmployeeId));
		}
		...
		public virtual TerritoryEntity GetSingleTerritories(bool forceFetch=false)
		{
			return PerformSingleEntityLazyLoading<TerritoryEntity>("Territories", forceFetch, _territoriesReturnsNewIfNotFound, e=>e.FetchUsingPK(this.TerritoryId));
		}
