...
namespace SD.LLBLGen.Pro.Examples.Auditing.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.CustomerCollection _customersCollectionViaCustomerCustomerDemo;
		private bool	_alwaysFetchCustomersCollectionViaCustomerCustomerDemo, _alreadyFetchedCustomersCollectionViaCustomerCustomerDemo;
		...
		protected CustomerDemographyEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			_customersCollectionViaCustomerCustomerDemo = (SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.CustomerCollection)info.GetValue("_customersCollectionViaCustomerCustomerDemo", typeof(SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.CustomerCollection));
			_alwaysFetchCustomersCollectionViaCustomerCustomerDemo = info.GetBoolean("_alwaysFetchCustomersCollectionViaCustomerCustomerDemo");
			_alreadyFetchedCustomersCollectionViaCustomerCustomerDemo = info.GetBoolean("_alreadyFetchedCustomersCollectionViaCustomerCustomerDemo");
		...
		protected override void PerformPostReadXmlFixups()
		{
			...
			_alreadyFetchedCustomersCollectionViaCustomerCustomerDemo = (_customersCollectionViaCustomerCustomerDemo.Count > 0);
		}
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				case "CustomerCustomerDemo":
					...
					break;
				case "CustomersCollectionViaCustomerCustomerDemo":
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue("_customersCollectionViaCustomerCustomerDemo", (!this.MarkedForDeletion?_customersCollectionViaCustomerCustomerDemo:null));
			info.AddValue("_alwaysFetchCustomersCollectionViaCustomerCustomerDemo", _alwaysFetchCustomersCollectionViaCustomerCustomerDemo);
			info.AddValue("_alreadyFetchedCustomersCollectionViaCustomerCustomerDemo", _alreadyFetchedCustomersCollectionViaCustomerCustomerDemo);
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "CustomersCollectionViaCustomerCustomerDemo":
					...
					if(entity!=null)
					{
						this.CustomersCollectionViaCustomerCustomerDemo.Add((CustomerEntity)entity);
					}
					break;
				default:
		...
		public SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.CustomerCollection GetMultiCustomersCollectionViaCustomerCustomerDemo(bool forceFetch)
		{
			return GetMultiCustomersCollectionViaCustomerCustomerDemo(forceFetch, _customersCollectionViaCustomerCustomerDemo.EntityFactoryToUse);
		}
		...
		/// <summary> Sets the collection parameters for the collection for 'CustomersCollectionViaCustomerCustomerDemo'. These settings will be taken into account
		/// when the property CustomersCollectionViaCustomerCustomerDemo is requested or GetMultiCustomersCollectionViaCustomerCustomerDemo is called.</summary>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return. When set to 0, this parameter is ignored</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified (null), no sorting is applied.</param>
		public virtual void SetCollectionParametersCustomersCollectionViaCustomerCustomerDemo(long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			_customersCollectionViaCustomerCustomerDemo.SortClauses=sortClauses;
			_customersCollectionViaCustomerCustomerDemo.MaxNumberOfItemsToReturn=maxNumberOfItemsToReturn;
		}
		...
		protected override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("CustomersCollectionViaCustomerCustomerDemo", _customersCollectionViaCustomerCustomerDemo);
			return toReturn;
		}
		...
		private void InitClassMembers()
		{
			...
			_customerCustomerDemo.SetContainingEntityInfo(this, "CustomerDemographics");
			_customersCollectionViaCustomerCustomerDemo = new SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.CustomerCollection();
		...
		{
			get { return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.CustomerCustomerDemoCollection(), (IEntityRelation)GetRelationsForField("CustomerCustomerDemo")[0], (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CustomerDemographyEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CustomerCustomerDemoEntity, 0, null, null, null, "CustomerCustomerDemo", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathCustomersCollectionViaCustomerCustomerDemo
		{
			get
			{
				...
				return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.CustomerCollection(), intermediateRelation,	(int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CustomerDemographyEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CustomerEntity, 0, null, null, GetRelationsForField("CustomersCollectionViaCustomerCustomerDemo"), "CustomersCollectionViaCustomerCustomerDemo", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		/// </summary>
		/// <remarks>This property is added for databinding conveniance, however it is recommeded to use the method 'GetMultiCustomersCollectionViaCustomerCustomerDemo()', because 
		/// this property is rather expensive and a method tells the user to cache the result when it has to be used more than once in the same scope.</remarks>
		public virtual SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.CustomerCollection CustomersCollectionViaCustomerCustomerDemo
		{
			get { return GetMultiCustomersCollectionViaCustomerCustomerDemo(false); }
		}

		/// <summary> Gets / sets the lazy loading flag for CustomersCollectionViaCustomerCustomerDemo. When set to true, CustomersCollectionViaCustomerCustomerDemo is always refetched from the 
		/// persistent storage. When set to false, the data is only fetched the first time CustomersCollectionViaCustomerCustomerDemo is accessed. You can always execute a forced fetch by calling GetMultiCustomersCollectionViaCustomerCustomerDemo(true).</summary>
		[Browsable(false)]
		public bool AlwaysFetchCustomersCollectionViaCustomerCustomerDemo
		{
			get	{ return _alwaysFetchCustomersCollectionViaCustomerCustomerDemo; }
			set	{ _alwaysFetchCustomersCollectionViaCustomerCustomerDemo = value; }
		}
				
		/// <summary>Gets / Sets the lazy loading flag if the property CustomersCollectionViaCustomerCustomerDemo already has been fetched. Setting this property to false when CustomersCollectionViaCustomerCustomerDemo has been fetched
		/// will clear the CustomersCollectionViaCustomerCustomerDemo collection well. Setting this property to true while CustomersCollectionViaCustomerCustomerDemo hasn't been fetched disables lazy loading for CustomersCollectionViaCustomerCustomerDemo</summary>
		[Browsable(false)]
		public bool AlreadyFetchedCustomersCollectionViaCustomerCustomerDemo
		{
			get { return _alreadyFetchedCustomersCollectionViaCustomerCustomerDemo;}
			set 
			{
				if(_alreadyFetchedCustomersCollectionViaCustomerCustomerDemo && !value && (_customersCollectionViaCustomerCustomerDemo != null))
				{
					_customersCollectionViaCustomerCustomerDemo.Clear();
				}
				_alreadyFetchedCustomersCollectionViaCustomerCustomerDemo = value;
			}
		}
		...
		{ 
			get { return (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CustomerDemographyEntity; }
		}
