...
namespace SD.LLBLGen.Pro.Examples.Auditing.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class ShipperEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("ShipperEntity", InheritanceHierarchyType.None, false, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.ShipperEntity, typeof(ShipperEntity), typeof(ShipperEntityFactory), false);
				AddNavigatorMetaData<ShipperEntity, SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.OrderCollection>("Orders", a => a._orders, (a, b) => a._orders = b, a => a.Orders, () => new ShipperRelations().OrderEntityUsingShipVia, typeof(OrderEntity), (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderEntity);
				AddNavigatorMetaData<ShipperEntity, SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.CustomerCollection>("CustomersCollectionViaOrders", a => a._customersCollectionViaOrders, (a, b) => a._customersCollectionViaOrders = b, a => a.CustomersCollectionViaOrders, () => new ShipperRelations().OrderEntityUsingShipVia, () => new OrderRelations().CustomerEntityUsingCustomerId, "ShipperEntity__", "Order_", typeof(CustomerEntity), (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CustomerEntity);
				AddNavigatorMetaData<ShipperEntity, SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.EmployeeCollection>("EmployeesCollectionViaOrders", a => a._employeesCollectionViaOrders, (a, b) => a._employeesCollectionViaOrders = b, a => a.EmployeesCollectionViaOrders, () => new ShipperRelations().OrderEntityUsingShipVia, () => new OrderRelations().EmployeeEntityUsingEmployeeId, "ShipperEntity__", "Order_", typeof(EmployeeEntity), (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.EmployeeEntity);
			}
		}
		...
		{
			return PerformMultiEntityLazyLoading<SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses.OrderCollection>("Orders", forceFetch, entityFactoryToUse, (c,r)=>c.GetMultiManyToOne(null, null, this, filter));
		}
