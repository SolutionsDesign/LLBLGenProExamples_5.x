...
namespace SD.LLBLGen.Pro.Examples.Auditing.FactoryClasses
{
			...
			where TEntity : EntityBase, IEntity
	{
		...
		public EntityFactoryBase(string entityName, SD.LLBLGen.Pro.Examples.Auditing.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity CreateEntityFromEntityTypeValue(int entityTypeValue) { return GeneralEntityFactory.Create((SD.LLBLGen.Pro.Examples.Auditing.EntityType)entityTypeValue); }
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(SD.LLBLGen.Pro.Examples.Auditing.EntityType)))
			{
				var factory = GetFactory((SD.LLBLGen.Pro.Examples.Auditing.EntityType)entityTypeValue);
	...
	public class ElementCreator : ElementCreatorBase, IElementCreator
	{
		...
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) {	return EntityFactoryFactory.GetFactory((SD.LLBLGen.Pro.Examples.Auditing.EntityType)entityTypeValue); }
