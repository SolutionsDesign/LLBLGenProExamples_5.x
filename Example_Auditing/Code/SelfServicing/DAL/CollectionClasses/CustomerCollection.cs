...
namespace SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses
{
	...
	public partial class CustomerCollection : EntityCollectionBase<CustomerEntity>
	{
		...
		public virtual bool GetMultiManyToManyUsingEmployeesCollectionViaOrders(IEntity employeeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			...
			return DAOFactory.CreateCustomerDAO().GetMultiUsingEmployeesCollectionViaOrders(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, employeeInstance, null, pageNumber, pageSize);
		}
		...
		public bool GetMultiManyToManyUsingEmployeesCollectionViaOrders(IEntity employeeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			...
			return DAOFactory.CreateCustomerDAO().GetMultiUsingEmployeesCollectionViaOrders(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, employeeInstance, prefetchPathToUse, 0, 0);
		}
		...
		public virtual bool GetMultiManyToManyUsingShippersCollectionViaOrders(IEntity shipperInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			...
			return DAOFactory.CreateCustomerDAO().GetMultiUsingShippersCollectionViaOrders(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, shipperInstance, null, pageNumber, pageSize);
		}
		...
		public bool GetMultiManyToManyUsingShippersCollectionViaOrders(IEntity shipperInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			...
			return DAOFactory.CreateCustomerDAO().GetMultiUsingShippersCollectionViaOrders(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, shipperInstance, prefetchPathToUse, 0, 0);
		}
