...
namespace SD.LLBLGen.Pro.Examples.Auditing.CollectionClasses
{
	...
	public partial class UserCollection : EntityCollectionBase<UserEntity>
	{
		...
		public bool GetMultiManyToManyUsingAuditActionTypeCollectionViaAuditInfo(IEntity auditActionTypeInstance)
		{
			return GetMultiManyToManyUsingAuditActionTypeCollectionViaAuditInfo(auditActionTypeInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, 0, 0);
		}
		...
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingAuditActionTypeCollectionViaAuditInfo(IEntity auditActionTypeInstance, IPrefetchPath prefetchPathToUse)
		{
			return GetMultiManyToManyUsingAuditActionTypeCollectionViaAuditInfo(auditActionTypeInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, prefetchPathToUse);
		}
