...
namespace SD.LLBLGen.Pro.Examples.Auditing.HelperClasses
{
	...
	internal class ModelInfoProviderCore : ModelInfoProviderBase
	{
		...
		{
			this.InitClass();
			InitAuditActionTypeEntityInfo();
			InitAuditInfoEntityInfo();
		...
		/// <summary>Inits AuditActionTypeEntity's info objects</summary>
		private void InitAuditActionTypeEntityInfo()
		{
		...
		/// <summary>Inits AuditInfoEntity's info objects</summary>
		private void InitAuditInfoEntityInfo()
		{
			this.AddEntityInfo("AuditInfoEntity", string.Empty, new AuditInfoRelations(), new AuditInfoEntityFactory(), 0);			
		...
		/// <summary>Inits OrderAuditInfoEntity's info objects</summary>
		private void InitOrderAuditInfoEntityInfo()
		{
			this.AddEntityInfo("OrderAuditInfoEntity",  "AuditInfoEntity" , new OrderAuditInfoRelations(), new OrderAuditInfoEntityFactory(), 1);			
