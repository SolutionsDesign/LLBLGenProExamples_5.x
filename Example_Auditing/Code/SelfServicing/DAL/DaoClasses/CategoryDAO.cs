...
namespace SD.LLBLGen.Pro.Examples.Auditing.DaoClasses
{
	...
	public partial class CategoryDAO : CommonDaoBase
	{
		...
		public bool GetMultiUsingSuppliersCollectionViaProducts(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity supplierInstance, IPrefetchPath prefetchPathToUse, int pageNumber, int pageSize)
		{
