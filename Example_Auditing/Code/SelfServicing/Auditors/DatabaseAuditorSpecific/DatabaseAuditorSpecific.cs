...
namespace SD.LLBLGen.Pro.Examples.Auditing.Auditors
{
    ...
    /// This example uses LLBLGen Pro v5.x.0 Auditor Dependency Injection.
    /// </summary>
    /// <remarks>
    ...
    public class DatabaseAuditorSpecific : AuditorBase
    {
        ...
        public override void AuditEntityFieldSet(IEntityCore entity, int fieldIndex, object originalValue)
        {
            ...
            AddOrderAuditEntryToList(GetPrimaryKeyValueFromOrderEntity(entity), AuditType.EntityFieldSet,
        ...
        public override void AuditInsertOfNewEntity(IEntityCore entity)
        {
            ...
            AddOrderAuditEntryToList(GetPrimaryKeyValueFromOrderEntity(entity), AuditType.InsertOfNewEntity, string.Empty);
        }
        ...
        public override void AuditUpdateOfExistingEntity(IEntityCore entity)
        {
            ...
            AddOrderAuditEntryToList(GetPrimaryKeyValueFromOrderEntity(entity), AuditType.UpdateOfExistingEntity, string.Empty);
        }
