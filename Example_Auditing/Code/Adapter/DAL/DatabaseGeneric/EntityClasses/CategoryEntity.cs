		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class CategoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			public CategoryEntityStaticMetaData()
			{
				...
				AddNavigatorMetaData<CategoryEntity, EntityCollection<ProductEntity>>("Products", a => a._products, (a, b) => a._products = b, a => a.Products, () => new CategoryRelations().ProductEntityUsingCategoryId, typeof(ProductEntity), (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.ProductEntity);
				AddNavigatorMetaData<CategoryEntity, EntityCollection<SupplierEntity>>("SuppliersCollectionViaProducts", a => a._suppliersCollectionViaProducts, (a, b) => a._suppliersCollectionViaProducts = b, a => a.SuppliersCollectionViaProducts, () => new CategoryRelations().ProductEntityUsingCategoryId, () => new ProductRelations().SupplierEntityUsingSupplierId, "CategoryEntity__", "Product_", typeof(SupplierEntity), (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.SupplierEntity);
			}
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoSuppliersCollectionViaProducts() { return CreateRelationInfoForNavigator("SuppliersCollectionViaProducts"); }
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathSuppliersCollectionViaProducts { get { return _staticMetaData.GetPrefetchPathElement("SuppliersCollectionViaProducts", CommonEntityBase.CreateEntityCollection<SupplierEntity>()); } }
		...
		public virtual EntityCollection<ProductEntity> Products { get { return GetOrCreateEntityCollection<ProductEntity, ProductEntityFactory>("Categories", true, false, ref _products); } }
		...
		public virtual EntityCollection<SupplierEntity> SuppliersCollectionViaProducts { get { return GetOrCreateEntityCollection<SupplierEntity, SupplierEntityFactory>("CategoriesCollectionViaProducts", false, true, ref _suppliersCollectionViaProducts); } }
