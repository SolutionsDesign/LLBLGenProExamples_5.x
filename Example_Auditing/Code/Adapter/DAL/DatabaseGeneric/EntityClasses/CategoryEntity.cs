...
namespace SD.LLBLGen.Pro.Examples.Auditing.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<SupplierEntity> _suppliersCollectionViaProducts;
		...
		protected CategoryEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_suppliersCollectionViaProducts = (EntityCollection<SupplierEntity>)info.GetValue("_suppliersCollectionViaProducts", typeof(EntityCollection<SupplierEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "SuppliersCollectionViaProducts":
					this.SuppliersCollectionViaProducts.IsReadOnly = false;
					this.SuppliersCollectionViaProducts.Add((SupplierEntity)entity);
					this.SuppliersCollectionViaProducts.IsReadOnly = true;
					break;
				default:
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_suppliersCollectionViaProducts", ((_suppliersCollectionViaProducts!=null) && (_suppliersCollectionViaProducts.Count>0) && !this.MarkedForDeletion)?_suppliersCollectionViaProducts:null);
			}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoSuppliersCollectionViaProducts()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("SuppliersCollectionViaProducts"));
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(CategoryFields.CategoryId, null, ComparisonOperator.Equal, this.CategoryId, "CategoryEntity__"));
			return bucket;
		}
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._suppliersCollectionViaProducts);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._suppliersCollectionViaProducts = (EntityCollection<SupplierEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			toReturn |= (this._suppliersCollectionViaProducts != null);
		...
		protected override void CreateMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue, Queue<bool> requiredQueue) 
		{
			...
			collectionsQueue.Enqueue(requiredQueue.Dequeue() ? new EntityCollection<SupplierEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SupplierEntityFactory))) : null);
		}
#endif
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))), (IEntityRelation)GetRelationsForField("Products")[0], (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CategoryEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.ProductEntity, 0, null, null, null, null, "Products", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathSuppliersCollectionViaProducts
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<SupplierEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SupplierEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CategoryEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.SupplierEntity, 0, null, null, GetRelationsForField("SuppliersCollectionViaProducts"), null, "SuppliersCollectionViaProducts", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return GetOrCreateEntityCollection<ProductEntity, ProductEntityFactory>("Categories", true, false, ref _products);	}
		}
		...
		public virtual EntityCollection<SupplierEntity> SuppliersCollectionViaProducts
		{
			get { return GetOrCreateEntityCollection<SupplierEntity, SupplierEntityFactory>("CategoriesCollectionViaProducts", false, true, ref _suppliersCollectionViaProducts);	}
		}
