...
namespace SD.LLBLGen.Pro.Examples.Auditing.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public virtual EntityCollection<OrderEntity> Orders { get { return GetOrCreateEntityCollection<OrderEntity, OrderEntityFactory>("Shippers", true, false, ref _orders); } }
		...
		public virtual EntityCollection<CustomerEntity> CustomersCollectionViaOrders { get { return GetOrCreateEntityCollection<CustomerEntity, CustomerEntityFactory>("ShippersCollectionViaOrders", false, true, ref _customersCollectionViaOrders); } }
		...
		public virtual EntityCollection<EmployeeEntity> EmployeesCollectionViaOrders { get { return GetOrCreateEntityCollection<EmployeeEntity, EmployeeEntityFactory>("ShippersCollectionViaOrders", false, true, ref _employeesCollectionViaOrders); } }
