		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected TerritoryEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_employeesCollectionViaEmployeeTerritories = (EntityCollection<EmployeeEntity>)info.GetValue("_employeesCollectionViaEmployeeTerritories", typeof(EntityCollection<EmployeeEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "EmployeesCollectionViaEmployeeTerritories":
					this.EmployeesCollectionViaEmployeeTerritories.IsReadOnly = false;
					this.EmployeesCollectionViaEmployeeTerritories.Add((EmployeeEntity)entity);
					this.EmployeesCollectionViaEmployeeTerritories.IsReadOnly = true;
					break;
				default:
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_employeesCollectionViaEmployeeTerritories", ((_employeesCollectionViaEmployeeTerritories!=null) && (_employeesCollectionViaEmployeeTerritories.Count>0) && !this.MarkedForDeletion)?_employeesCollectionViaEmployeeTerritories:null);
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoEmployeesCollectionViaEmployeeTerritories()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("EmployeesCollectionViaEmployeeTerritories"));
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._employeesCollectionViaEmployeeTerritories);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._employeesCollectionViaEmployeeTerritories = (EntityCollection<EmployeeEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			toReturn |= (this._employeesCollectionViaEmployeeTerritories != null);
		...
		private void SetupSyncRegion(IEntityCore relatedEntity)
		{
			if(_region!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _region, new PropertyChangedEventHandler( OnRegionPropertyChanged ), "Region", SD.LLBLGen.Pro.Examples.Auditing.RelationClasses.StaticTerritoryRelations.RegionEntityUsingRegionIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<EmployeeTerritoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeTerritoryEntityFactory))), (IEntityRelation)GetRelationsForField("EmployeeTerritories")[0], (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.TerritoryEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.EmployeeTerritoryEntity, 0, null, null, null, null, "EmployeeTerritories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathEmployeesCollectionViaEmployeeTerritories
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<EmployeeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.TerritoryEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.EmployeeEntity, 0, null, null, GetRelationsForField("EmployeesCollectionViaEmployeeTerritories"), null, "EmployeesCollectionViaEmployeeTerritories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(RegionEntityFactory))),	(IEntityRelation)GetRelationsForField("Region")[0], (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.TerritoryEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.RegionEntity, 0, null, null, null, null, "Region", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get { return GetOrCreateEntityCollection<EmployeeTerritoryEntity, EmployeeTerritoryEntityFactory>("Territories", true, false, ref _employeeTerritories);	}
		}
		...
		public virtual EntityCollection<EmployeeEntity> EmployeesCollectionViaEmployeeTerritories
		{
			get { return GetOrCreateEntityCollection<EmployeeEntity, EmployeeEntityFactory>("TerritoriesCollectionViaEmployeeTerritories", false, true, ref _employeesCollectionViaEmployeeTerritories);	}
		}
