		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class SupplierEntityStaticMetaData : EntityStaticMetaDataBase
		{
			public SupplierEntityStaticMetaData()
			{
				...
				AddNavigatorMetaData<SupplierEntity, EntityCollection<ProductEntity>>("Products", a => a._products, (a, b) => a._products = b, a => a.Products, () => new SupplierRelations().ProductEntityUsingSupplierId, typeof(ProductEntity), (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.ProductEntity);
		...
		public virtual EntityCollection<ProductEntity> Products { get { return GetOrCreateEntityCollection<ProductEntity, ProductEntityFactory>("Suppliers", true, false, ref _products); } }
		...
		public virtual EntityCollection<CategoryEntity> CategoriesCollectionViaProducts { get { return GetOrCreateEntityCollection<CategoryEntity, CategoryEntityFactory>("SuppliersCollectionViaProducts", false, true, ref _categoriesCollectionViaProducts); } }
