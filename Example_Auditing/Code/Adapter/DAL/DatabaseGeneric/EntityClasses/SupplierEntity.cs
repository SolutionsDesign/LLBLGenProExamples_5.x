		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected SupplierEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_categoriesCollectionViaProducts = (EntityCollection<CategoryEntity>)info.GetValue("_categoriesCollectionViaProducts", typeof(EntityCollection<CategoryEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "CategoriesCollectionViaProducts":
					this.CategoriesCollectionViaProducts.IsReadOnly = false;
					this.CategoriesCollectionViaProducts.Add((CategoryEntity)entity);
					this.CategoriesCollectionViaProducts.IsReadOnly = true;
					break;
				default:
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_categoriesCollectionViaProducts", ((_categoriesCollectionViaProducts!=null) && (_categoriesCollectionViaProducts.Count>0) && !this.MarkedForDeletion)?_categoriesCollectionViaProducts:null);
			}
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._categoriesCollectionViaProducts);
		}
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			toReturn |= (this._categoriesCollectionViaProducts != null);
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))), (IEntityRelation)GetRelationsForField("Products")[0], (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.SupplierEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.ProductEntity, 0, null, null, null, null, "Products", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathCategoriesCollectionViaProducts
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CategoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CategoryEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.SupplierEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CategoryEntity, 0, null, null, GetRelationsForField("CategoriesCollectionViaProducts"), null, "CategoriesCollectionViaProducts", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return GetOrCreateEntityCollection<ProductEntity, ProductEntityFactory>("Suppliers", true, false, ref _products);	}
		}
		...
		public virtual EntityCollection<CategoryEntity> CategoriesCollectionViaProducts
		{
			get { return GetOrCreateEntityCollection<CategoryEntity, CategoryEntityFactory>("SuppliersCollectionViaProducts", false, true, ref _categoriesCollectionViaProducts);	}
		}
