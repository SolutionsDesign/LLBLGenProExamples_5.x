...
namespace SD.LLBLGen.Pro.Examples.Auditing.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class EmployeeTerritoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("EmployeeTerritoryEntity", InheritanceHierarchyType.None, false, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.EmployeeTerritoryEntity, typeof(EmployeeTerritoryEntity), typeof(EmployeeTerritoryEntityFactory), false);
				AddNavigatorMetaData<EmployeeTerritoryEntity, EmployeeEntity>("Employees", "EmployeeTerritories", (a, b) => a._employees = b, a => a._employees, (a, b) => a.Employees = b, SD.LLBLGen.Pro.Examples.Auditing.RelationClasses.StaticEmployeeTerritoryRelations.EmployeeEntityUsingEmployeeIdStatic, ()=>new EmployeeTerritoryRelations().EmployeeEntityUsingEmployeeId, null, new int[] { (int)EmployeeTerritoryFieldIndex.EmployeeId }, null, true, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.EmployeeEntity);
				AddNavigatorMetaData<EmployeeTerritoryEntity, TerritoryEntity>("Territories", "EmployeeTerritories", (a, b) => a._territories = b, a => a._territories, (a, b) => a.Territories = b, SD.LLBLGen.Pro.Examples.Auditing.RelationClasses.StaticEmployeeTerritoryRelations.TerritoryEntityUsingTerritoryIdStatic, ()=>new EmployeeTerritoryRelations().TerritoryEntityUsingTerritoryId, null, new int[] { (int)EmployeeTerritoryFieldIndex.TerritoryId }, null, true, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.TerritoryEntity);
			}
		}
		...
		public virtual TerritoryEntity Territories
		{
			...
			set { SetSingleRelatedEntityNavigator(value, "Territories"); }
		}
...
namespace SD.LLBLGen.Pro.Examples.Auditing.RelationClasses
{
	...
	public partial class EmployeeTerritoryRelations: RelationFactory
	{
		...
		{
			get	{ return ModelInfoProviderSingleton.GetInstance().CreateRelation(RelationType.ManyToOne, "Employees", false, new[] { EmployeeFields.EmployeeId, EmployeeTerritoryFields.EmployeeId }); }
		}
		...
		{
			get	{ return ModelInfoProviderSingleton.GetInstance().CreateRelation(RelationType.ManyToOne, "Territories", false, new[] { TerritoryFields.TerritoryId, EmployeeTerritoryFields.TerritoryId }); }
		}
