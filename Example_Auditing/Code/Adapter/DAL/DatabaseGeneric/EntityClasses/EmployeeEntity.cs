		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class EmployeeEntityStaticMetaData : EntityStaticMetaDataBase
		{
			public EmployeeEntityStaticMetaData()
			{
				...
				AddNavigatorMetaData<EmployeeEntity, EntityCollection<EmployeeEntity>>("Employees_", a => a._employees_, (a, b) => a._employees_ = b, a => a.Employees_, () => new EmployeeRelations().EmployeeEntityUsingReportsTo, typeof(EmployeeEntity), (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.EmployeeEntity);
				...
				AddNavigatorMetaData<EmployeeEntity, EntityCollection<OrderEntity>>("Orders", a => a._orders, (a, b) => a._orders = b, a => a.Orders, () => new EmployeeRelations().OrderEntityUsingEmployeeId, typeof(OrderEntity), (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderEntity);
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoTerritoriesCollectionViaEmployeeTerritories() { return CreateRelationInfoForNavigator("TerritoriesCollectionViaEmployeeTerritories"); }
		...
		public static IPrefetchPathElement2 PrefetchPathEmployees_ { get { return _staticMetaData.GetPrefetchPathElement("Employees_", CommonEntityBase.CreateEntityCollection<EmployeeEntity>()); } }
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathCustomersCollectionViaOrders { get { return _staticMetaData.GetPrefetchPathElement("CustomersCollectionViaOrders", CommonEntityBase.CreateEntityCollection<CustomerEntity>()); } }
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathTerritoriesCollectionViaEmployeeTerritories { get { return _staticMetaData.GetPrefetchPathElement("TerritoriesCollectionViaEmployeeTerritories", CommonEntityBase.CreateEntityCollection<TerritoryEntity>()); } }
		...
		public virtual EntityCollection<EmployeeEntity> Employees_ { get { return GetOrCreateEntityCollection<EmployeeEntity, EmployeeEntityFactory>("Employees", true, false, ref _employees_); } }
		...
		public virtual EntityCollection<EmployeeTerritoryEntity> EmployeeTerritories { get { return GetOrCreateEntityCollection<EmployeeTerritoryEntity, EmployeeTerritoryEntityFactory>("Employees", true, false, ref _employeeTerritories); } }
		...
		public virtual EntityCollection<OrderEntity> Orders { get { return GetOrCreateEntityCollection<OrderEntity, OrderEntityFactory>("Employees", true, false, ref _orders); } }
		...
		public virtual EntityCollection<CustomerEntity> CustomersCollectionViaOrders { get { return GetOrCreateEntityCollection<CustomerEntity, CustomerEntityFactory>("EmployeesCollectionViaOrders", false, true, ref _customersCollectionViaOrders); } }
		...
		public virtual EntityCollection<ShipperEntity> ShippersCollectionViaOrders { get { return GetOrCreateEntityCollection<ShipperEntity, ShipperEntityFactory>("EmployeesCollectionViaOrders", false, true, ref _shippersCollectionViaOrders); } }
		...
		public virtual EntityCollection<TerritoryEntity> TerritoriesCollectionViaEmployeeTerritories { get { return GetOrCreateEntityCollection<TerritoryEntity, TerritoryEntityFactory>("EmployeesCollectionViaEmployeeTerritories", false, true, ref _territoriesCollectionViaEmployeeTerritories); } }
