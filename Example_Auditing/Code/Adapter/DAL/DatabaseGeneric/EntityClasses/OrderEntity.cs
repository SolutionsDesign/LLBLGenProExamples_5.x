		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class OrderEntityStaticMetaData : EntityStaticMetaDataBase
		{
			public OrderEntityStaticMetaData()
			{
				...
				AddNavigatorMetaData<OrderEntity, EntityCollection<OrderAuditInfoEntity>>("OrderAuditInfo", a => a._orderAuditInfo, (a, b) => a._orderAuditInfo = b, a => a.OrderAuditInfo, () => new OrderRelations().OrderAuditInfoEntityUsingOrderId, typeof(OrderAuditInfoEntity), (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderAuditInfoEntity);
				AddNavigatorMetaData<OrderEntity, EntityCollection<OrderDetailEntity>>("OrderDetails", a => a._orderDetails, (a, b) => a._orderDetails = b, a => a.OrderDetails, () => new OrderRelations().OrderDetailEntityUsingOrderId, typeof(OrderDetailEntity), (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderDetailEntity);
				...
				AddNavigatorMetaData<OrderEntity, EntityCollection<ProductEntity>>("ProductsCollectionViaOrderDetails", a => a._productsCollectionViaOrderDetails, (a, b) => a._productsCollectionViaOrderDetails = b, a => a.ProductsCollectionViaOrderDetails, () => new OrderRelations().OrderDetailEntityUsingOrderId, () => new OrderDetailRelations().ProductEntityUsingProductId, "OrderEntity__", "OrderDetail_", typeof(ProductEntity), (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.ProductEntity);
			}
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoOrderAuditInfo() { return CreateRelationInfoForNavigator("OrderAuditInfo"); }
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoProductsCollectionViaOrderDetails() { return CreateRelationInfoForNavigator("ProductsCollectionViaOrderDetails"); }
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoShippers() { return CreateRelationInfoForNavigator("Shippers"); }
		...
		public static IPrefetchPathElement2 PrefetchPathOrderAuditInfo { get { return _staticMetaData.GetPrefetchPathElement("OrderAuditInfo", CommonEntityBase.CreateEntityCollection<OrderAuditInfoEntity>()); } }
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathProductsCollectionViaOrderDetails { get { return _staticMetaData.GetPrefetchPathElement("ProductsCollectionViaOrderDetails", CommonEntityBase.CreateEntityCollection<ProductEntity>()); } }
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathShippers { get { return _staticMetaData.GetPrefetchPathElement("Shippers", CommonEntityBase.CreateEntityCollection<ShipperEntity>()); } }
		...
		public virtual EntityCollection<OrderAuditInfoEntity> OrderAuditInfo { get { return GetOrCreateEntityCollection<OrderAuditInfoEntity, OrderAuditInfoEntityFactory>("Order", true, false, ref _orderAuditInfo); } }
		...
		public virtual EntityCollection<OrderDetailEntity> OrderDetails { get { return GetOrCreateEntityCollection<OrderDetailEntity, OrderDetailEntityFactory>("Orders", true, false, ref _orderDetails); } }
		...
		public virtual EntityCollection<ProductEntity> ProductsCollectionViaOrderDetails { get { return GetOrCreateEntityCollection<ProductEntity, ProductEntityFactory>("OrdersCollectionViaOrderDetails", false, true, ref _productsCollectionViaOrderDetails); } }
