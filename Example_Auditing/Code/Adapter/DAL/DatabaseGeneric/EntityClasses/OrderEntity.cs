...
namespace SD.LLBLGen.Pro.Examples.Auditing.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<OrderAuditInfoEntity> _orderAuditInfo;
		private EntityCollection<OrderDetailEntity> _orderDetails;
		private EntityCollection<ProductEntity> _productsCollectionViaOrderDetails;
		...
		protected OrderEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			{
				_orderAuditInfo = (EntityCollection<OrderAuditInfoEntity>)info.GetValue("_orderAuditInfo", typeof(EntityCollection<OrderAuditInfoEntity>));
				_orderDetails = (EntityCollection<OrderDetailEntity>)info.GetValue("_orderDetails", typeof(EntityCollection<OrderDetailEntity>));
				_productsCollectionViaOrderDetails = (EntityCollection<ProductEntity>)info.GetValue("_productsCollectionViaOrderDetails", typeof(EntityCollection<ProductEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "ProductsCollectionViaOrderDetails":
					this.ProductsCollectionViaOrderDetails.IsReadOnly = false;
					this.ProductsCollectionViaOrderDetails.Add((ProductEntity)entity);
					this.ProductsCollectionViaOrderDetails.IsReadOnly = true;
					break;
				default:
		...
		protected override void SetRelatedEntity(IEntityCore relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				...
				case "Shippers":
					...
					break;
				case "OrderAuditInfo":
					this.OrderAuditInfo.Add((OrderAuditInfoEntity)relatedEntity);
					break;
				case "OrderDetails":
		...
		protected override void UnsetRelatedEntity(IEntityCore relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			switch(fieldName)
			{
				...
				case "Shippers":
					...
					break;
				case "OrderAuditInfo":
					this.PerformRelatedEntityRemoval(this.OrderAuditInfo, relatedEntity, signalRelatedEntityManyToOne);
					break;
				case "OrderDetails":
		...
		protected override List<IEntityCollection2> GetMemberEntityCollections()
		{
			...
			toReturn.Add(this.OrderAuditInfo);
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				info.AddValue("_orderAuditInfo", ((_orderAuditInfo!=null) && (_orderAuditInfo.Count>0) && !this.MarkedForDeletion)?_orderAuditInfo:null);
				info.AddValue("_orderDetails", ((_orderDetails!=null) && (_orderDetails.Count>0) && !this.MarkedForDeletion)?_orderDetails:null);
				info.AddValue("_productsCollectionViaOrderDetails", ((_productsCollectionViaOrderDetails!=null) && (_productsCollectionViaOrderDetails.Count>0) && !this.MarkedForDeletion)?_productsCollectionViaOrderDetails:null);
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoOrderAuditInfo()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(OrderAuditInfoFields.OrderId, null, ComparisonOperator.Equal, this.OrderId));
			return bucket;
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoProductsCollectionViaOrderDetails()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("ProductsCollectionViaOrderDetails"));
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoShippers()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._orderAuditInfo);
			collectionsQueue.Enqueue(this._orderDetails);
			collectionsQueue.Enqueue(this._productsCollectionViaOrderDetails);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._orderAuditInfo = (EntityCollection<OrderAuditInfoEntity>) collectionsQueue.Dequeue();
			this._orderDetails = (EntityCollection<OrderDetailEntity>) collectionsQueue.Dequeue();
			this._productsCollectionViaOrderDetails = (EntityCollection<ProductEntity>) collectionsQueue.Dequeue();
		...
		{
			bool toReturn = false;
			toReturn |=(this._orderAuditInfo != null);
			toReturn |=(this._orderDetails != null);
			toReturn |= (this._productsCollectionViaOrderDetails != null);
		...
		protected override void CreateMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue, Queue<bool> requiredQueue) 
		{
			...
			collectionsQueue.Enqueue(requiredQueue.Dequeue() ? new EntityCollection<OrderAuditInfoEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrderAuditInfoEntityFactory))) : null);
		...
		private void SetupSyncCustomers(IEntityCore relatedEntity)
		{
			if(_customers!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _customers, new PropertyChangedEventHandler( OnCustomersPropertyChanged ), "Customers", SD.LLBLGen.Pro.Examples.Auditing.RelationClasses.StaticOrderRelations.CustomerEntityUsingCustomerIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncEmployees(IEntityCore relatedEntity)
		{
			if(_employees!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employees, new PropertyChangedEventHandler( OnEmployeesPropertyChanged ), "Employees", SD.LLBLGen.Pro.Examples.Auditing.RelationClasses.StaticOrderRelations.EmployeeEntityUsingEmployeeIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncShippers(IEntityCore relatedEntity)
		{
			if(_shippers!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _shippers, new PropertyChangedEventHandler( OnShippersPropertyChanged ), "Shippers", SD.LLBLGen.Pro.Examples.Auditing.RelationClasses.StaticOrderRelations.ShipperEntityUsingShipViaStatic, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrderAuditInfo
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<OrderAuditInfoEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrderAuditInfoEntityFactory))), (IEntityRelation)GetRelationsForField("OrderAuditInfo")[0], (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderAuditInfoEntity, 0, null, null, null, null, "OrderAuditInfo", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<OrderDetailEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrderDetailEntityFactory))), (IEntityRelation)GetRelationsForField("OrderDetails")[0], (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderDetailEntity, 0, null, null, null, null, "OrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}

		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'Product' for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathProductsCollectionViaOrderDetails
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.ProductEntity, 0, null, null, GetRelationsForField("ProductsCollectionViaOrderDetails"), null, "ProductsCollectionViaOrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))),	(IEntityRelation)GetRelationsForField("Customers")[0], (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CustomerEntity, 0, null, null, null, null, "Customers", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))),	(IEntityRelation)GetRelationsForField("Employees")[0], (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.EmployeeEntity, 0, null, null, null, null, "Employees", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathShippers
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShipperEntityFactory))),	(IEntityRelation)GetRelationsForField("Shippers")[0], (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.ShipperEntity, 0, null, null, null, null, "Shippers", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual EntityCollection<OrderAuditInfoEntity> OrderAuditInfo
		{
			get { return GetOrCreateEntityCollection<OrderAuditInfoEntity, OrderAuditInfoEntityFactory>("Order", true, false, ref _orderAuditInfo);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<OrderDetailEntity, OrderDetailEntityFactory>("Orders", true, false, ref _orderDetails);	}
		}
		...
		public virtual EntityCollection<ProductEntity> ProductsCollectionViaOrderDetails
		{
			get { return GetOrCreateEntityCollection<ProductEntity, ProductEntityFactory>("OrdersCollectionViaOrderDetails", false, true, ref _productsCollectionViaOrderDetails);	}
		}
