...
namespace SD.LLBLGen.Pro.Examples.Auditing.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoCustomerDemographics() { return CreateRelationInfoForNavigator("CustomerDemographics"); }
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathCustomerDemographics { get { return _staticMetaData.GetPrefetchPathElement("CustomerDemographics", CommonEntityBase.CreateEntityCollection<CustomerDemographyEntity>()); } }
