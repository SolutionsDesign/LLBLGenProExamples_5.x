...
namespace SD.LLBLGen.Pro.Examples.Auditing.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected CustomerEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			{
				_customerCustomerDemo = (EntityCollection<CustomerCustomerDemoEntity>)info.GetValue("_customerCustomerDemo", typeof(EntityCollection<CustomerCustomerDemoEntity>));
				_orders = (EntityCollection<OrderEntity>)info.GetValue("_orders", typeof(EntityCollection<OrderEntity>));
				_customerDemographicsCollectionViaCustomerCustomerDemo = (EntityCollection<CustomerDemographyEntity>)info.GetValue("_customerDemographicsCollectionViaCustomerCustomerDemo", typeof(EntityCollection<CustomerDemographyEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "CustomerDemographicsCollectionViaCustomerCustomerDemo":
					this.CustomerDemographicsCollectionViaCustomerCustomerDemo.IsReadOnly = false;
					this.CustomerDemographicsCollectionViaCustomerCustomerDemo.Add((CustomerDemographyEntity)entity);
					this.CustomerDemographicsCollectionViaCustomerCustomerDemo.IsReadOnly = true;
					break;
		...
		protected override void SetRelatedEntity(IEntityCore relatedEntity, string fieldName)
		{
			...
			{
				case "CustomerCustomerDemo":
					this.CustomerCustomerDemo.Add((CustomerCustomerDemoEntity)relatedEntity);
					break;
				case "Orders":
		...
		protected override void UnsetRelatedEntity(IEntityCore relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			...
			{
				case "CustomerCustomerDemo":
					this.PerformRelatedEntityRemoval(this.CustomerCustomerDemo, relatedEntity, signalRelatedEntityManyToOne);
					break;
				case "Orders":
		...
		protected override List<IEntityCollection2> GetMemberEntityCollections()
		{
			...
			toReturn.Add(this.CustomerCustomerDemo);
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				info.AddValue("_customerCustomerDemo", ((_customerCustomerDemo!=null) && (_customerCustomerDemo.Count>0) && !this.MarkedForDeletion)?_customerCustomerDemo:null);
				info.AddValue("_orders", ((_orders!=null) && (_orders.Count>0) && !this.MarkedForDeletion)?_orders:null);
				info.AddValue("_customerDemographicsCollectionViaCustomerCustomerDemo", ((_customerDemographicsCollectionViaCustomerCustomerDemo!=null) && (_customerDemographicsCollectionViaCustomerCustomerDemo.Count>0) && !this.MarkedForDeletion)?_customerDemographicsCollectionViaCustomerCustomerDemo:null);
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoCustomerCustomerDemo()
		{
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoCustomerDemographicsCollectionViaCustomerCustomerDemo()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("CustomerDemographicsCollectionViaCustomerCustomerDemo"));
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._customerCustomerDemo);
			collectionsQueue.Enqueue(this._orders);
			collectionsQueue.Enqueue(this._customerDemographicsCollectionViaCustomerCustomerDemo);
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._customerCustomerDemo = (EntityCollection<CustomerCustomerDemoEntity>) collectionsQueue.Dequeue();
			this._orders = (EntityCollection<OrderEntity>) collectionsQueue.Dequeue();
			this._customerDemographicsCollectionViaCustomerCustomerDemo = (EntityCollection<CustomerDemographyEntity>) collectionsQueue.Dequeue();
		...
		{
			bool toReturn = false;
			toReturn |=(this._customerCustomerDemo != null);
			toReturn |=(this._orders != null);
			toReturn |= (this._customerDemographicsCollectionViaCustomerCustomerDemo != null);
		...
		public static IPrefetchPathElement2 PrefetchPathCustomerCustomerDemo
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<CustomerCustomerDemoEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CustomerCustomerDemoEntityFactory))), (IEntityRelation)GetRelationsForField("CustomerCustomerDemo")[0], (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CustomerEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CustomerCustomerDemoEntity, 0, null, null, null, null, "CustomerCustomerDemo", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<OrderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrderEntityFactory))), (IEntityRelation)GetRelationsForField("Orders")[0], (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CustomerEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderEntity, 0, null, null, null, null, "Orders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathCustomerDemographicsCollectionViaCustomerCustomerDemo
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CustomerDemographyEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CustomerDemographyEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CustomerEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CustomerDemographyEntity, 0, null, null, GetRelationsForField("CustomerDemographicsCollectionViaCustomerCustomerDemo"), null, "CustomerDemographicsCollectionViaCustomerCustomerDemo", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEmployeesCollectionViaOrders
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<EmployeeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CustomerEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.EmployeeEntity, 0, null, null, GetRelationsForField("EmployeesCollectionViaOrders"), null, "EmployeesCollectionViaOrders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathShippersCollectionViaOrders
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ShipperEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ShipperEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CustomerEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.ShipperEntity, 0, null, null, GetRelationsForField("ShippersCollectionViaOrders"), null, "ShippersCollectionViaOrders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public virtual EntityCollection<CustomerCustomerDemoEntity> CustomerCustomerDemo
		{
			get { return GetOrCreateEntityCollection<CustomerCustomerDemoEntity, CustomerCustomerDemoEntityFactory>("Customers", true, false, ref _customerCustomerDemo);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<OrderEntity, OrderEntityFactory>("Customers", true, false, ref _orders);	}
		}
		...
		public virtual EntityCollection<CustomerDemographyEntity> CustomerDemographicsCollectionViaCustomerCustomerDemo
		{
			get { return GetOrCreateEntityCollection<CustomerDemographyEntity, CustomerDemographyEntityFactory>("CustomersCollectionViaCustomerCustomerDemo", false, true, ref _customerDemographicsCollectionViaCustomerCustomerDemo);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<ShipperEntity, ShipperEntityFactory>("CustomersCollectionViaOrders", false, true, ref _shippersCollectionViaOrders);	}
		}
