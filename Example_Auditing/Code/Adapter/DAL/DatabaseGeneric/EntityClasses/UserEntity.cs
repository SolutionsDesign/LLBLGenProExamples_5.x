...
// Code is generated on: donderdag 21 april 2016 11:37:06
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected UserEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_auditActionTypeCollectionViaAuditInfo = (EntityCollection<AuditActionTypeEntity>)info.GetValue("_auditActionTypeCollectionViaAuditInfo", typeof(EntityCollection<AuditActionTypeEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "AuditActionTypeCollectionViaAuditInfo":
					this.AuditActionTypeCollectionViaAuditInfo.IsReadOnly = false;
					this.AuditActionTypeCollectionViaAuditInfo.Add((AuditActionTypeEntity)entity);
					this.AuditActionTypeCollectionViaAuditInfo.IsReadOnly = true;
					break;
				default:
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_auditActionTypeCollectionViaAuditInfo", ((_auditActionTypeCollectionViaAuditInfo!=null) && (_auditActionTypeCollectionViaAuditInfo.Count>0) && !this.MarkedForDeletion)?_auditActionTypeCollectionViaAuditInfo:null);
			}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoAuditActionTypeCollectionViaAuditInfo()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("AuditActionTypeCollectionViaAuditInfo"));
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._auditActionTypeCollectionViaAuditInfo);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._auditActionTypeCollectionViaAuditInfo = (EntityCollection<AuditActionTypeEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			toReturn |= (this._auditActionTypeCollectionViaAuditInfo != null);
		...
		protected override void CreateMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue, Queue<bool> requiredQueue) 
		{
			...
			collectionsQueue.Enqueue(requiredQueue.Dequeue() ? new EntityCollection<AuditActionTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AuditActionTypeEntityFactory))) : null);
		}
#endif
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<AuditInfoEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AuditInfoEntityFactory))), (IEntityRelation)GetRelationsForField("AuditInfo")[0], (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.UserEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.AuditInfoEntity, 0, null, null, null, null, "AuditInfo", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathAuditActionTypeCollectionViaAuditInfo
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<AuditActionTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AuditActionTypeEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.UserEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.AuditActionTypeEntity, 0, null, null, GetRelationsForField("AuditActionTypeCollectionViaAuditInfo"), null, "AuditActionTypeCollectionViaAuditInfo", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return GetOrCreateEntityCollection<AuditInfoEntity, AuditInfoEntityFactory>("User", true, false, ref _auditInfo);	}
		}
		...
		public virtual EntityCollection<AuditActionTypeEntity> AuditActionTypeCollectionViaAuditInfo
		{
			get { return GetOrCreateEntityCollection<AuditActionTypeEntity, AuditActionTypeEntityFactory>("UserCollectionViaAuditInfo", false, true, ref _auditActionTypeCollectionViaAuditInfo);	}
		}
