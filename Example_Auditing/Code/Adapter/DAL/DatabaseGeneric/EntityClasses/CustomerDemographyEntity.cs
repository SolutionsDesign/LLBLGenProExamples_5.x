...
namespace SD.LLBLGen.Pro.Examples.Auditing.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public CustomerDemographyEntity(IEntityFields2 fields):base("CustomerDemographyEntity")
		{
		...
		public CustomerDemographyEntity(IValidator validator):base("CustomerDemographyEntity")
		{
		...
		protected CustomerDemographyEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_customersCollectionViaCustomerCustomerDemo = (EntityCollection<CustomerEntity>)info.GetValue("_customersCollectionViaCustomerCustomerDemo", typeof(EntityCollection<CustomerEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "CustomersCollectionViaCustomerCustomerDemo":
					this.CustomersCollectionViaCustomerCustomerDemo.IsReadOnly = false;
					this.CustomersCollectionViaCustomerCustomerDemo.Add((CustomerEntity)entity);
					this.CustomersCollectionViaCustomerCustomerDemo.IsReadOnly = true;
					break;
				default:
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_customersCollectionViaCustomerCustomerDemo", ((_customersCollectionViaCustomerCustomerDemo!=null) && (_customersCollectionViaCustomerCustomerDemo.Count>0) && !this.MarkedForDeletion)?_customersCollectionViaCustomerCustomerDemo:null);
			}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(CustomerDemographyEntityFactory));
		}
#if !CF
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._customersCollectionViaCustomerCustomerDemo);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._customersCollectionViaCustomerCustomerDemo = (EntityCollection<CustomerEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			toReturn |= (this._customersCollectionViaCustomerCustomerDemo != null);
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathCustomersCollectionViaCustomerCustomerDemo
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CustomerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CustomerDemographyEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.CustomerEntity, 0, null, null, GetRelationsForField("CustomersCollectionViaCustomerCustomerDemo"), null, "CustomersCollectionViaCustomerCustomerDemo", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return GetOrCreateEntityCollection<CustomerCustomerDemoEntity, CustomerCustomerDemoEntityFactory>("CustomerDemographics", true, false, ref _customerCustomerDemo);	}
		}
		...
		public virtual EntityCollection<CustomerEntity> CustomersCollectionViaCustomerCustomerDemo
		{
			get { return GetOrCreateEntityCollection<CustomerEntity, CustomerEntityFactory>("CustomerDemographicsCollectionViaCustomerCustomerDemo", false, true, ref _customersCollectionViaCustomerCustomerDemo);	}
		}
