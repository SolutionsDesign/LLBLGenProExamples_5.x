		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class ProductEntityStaticMetaData : EntityStaticMetaDataBase
		{
			public ProductEntityStaticMetaData()
			{
				...
				AddNavigatorMetaData<ProductEntity, EntityCollection<OrderDetailEntity>>("OrderDetails", a => a._orderDetails, (a, b) => a._orderDetails = b, a => a.OrderDetails, () => new ProductRelations().OrderDetailEntityUsingProductId, typeof(OrderDetailEntity), (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderDetailEntity);
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoSuppliers() { return CreateRelationInfoForNavigator("Suppliers"); }
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathSuppliers { get { return _staticMetaData.GetPrefetchPathElement("Suppliers", CommonEntityBase.CreateEntityCollection<SupplierEntity>()); } }
		...
		public virtual EntityCollection<OrderDetailEntity> OrderDetails { get { return GetOrCreateEntityCollection<OrderDetailEntity, OrderDetailEntityFactory>("Products", true, false, ref _orderDetails); } }
