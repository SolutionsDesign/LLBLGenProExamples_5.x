		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncUser(IEntityCore relatedEntity)
		{
			if(_user!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", SD.LLBLGen.Pro.Examples.Auditing.RelationClasses.StaticAuditInfoRelations.UserEntityUsingUserIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AuditActionTypeEntityFactory))),	(IEntityRelation)GetRelationsForField("AuditActionType")[0], (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.AuditInfoEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.AuditActionTypeEntity, 0, null, null, null, null, "AuditActionType", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("User")[0], (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.AuditInfoEntity, (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.UserEntity, 0, null, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
