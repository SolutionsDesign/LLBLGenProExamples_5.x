		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class RegionEntityStaticMetaData : EntityStaticMetaDataBase
		{
			public RegionEntityStaticMetaData()
			{
				...
				AddNavigatorMetaData<RegionEntity, EntityCollection<TerritoryEntity>>("Territories", a => a._territories, (a, b) => a._territories = b, a => a.Territories, () => new RegionRelations().TerritoryEntityUsingRegionId, typeof(TerritoryEntity), (int)SD.LLBLGen.Pro.Examples.Auditing.EntityType.TerritoryEntity);
			}
		}
