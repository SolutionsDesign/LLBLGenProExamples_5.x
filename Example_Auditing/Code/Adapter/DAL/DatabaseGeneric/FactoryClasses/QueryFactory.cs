...
namespace SD.LLBLGen.Pro.Examples.Auditing.FactoryClasses
{
	...
	public partial class QueryFactory
	{
		...
		public EntityQuery<AuditActionTypeEntity> AuditActionType
		{
			get { return Create<AuditActionTypeEntity>(); }
		}
		...
		public EntityQuery<CustomerDemographyEntity> CustomerDemography
		{
			get { return Create<CustomerDemographyEntity>(); }
		}
		...
		public EntityQuery<OrderAuditInfoEntity> OrderAuditInfo
		{
			get { return Create<OrderAuditInfoEntity>(); }
		}
