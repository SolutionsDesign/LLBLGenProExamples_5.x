...
namespace SD.LLBLGen.Pro.Examples.Auditing.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, SD.LLBLGen.Pro.Examples.Auditing.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
	...
	public partial class AuditActionTypeEntityFactory : EntityFactoryBase2<AuditActionTypeEntity> {
		/// <summary>CTor</summary>
		public AuditActionTypeEntityFactory() : base("AuditActionTypeEntity", SD.LLBLGen.Pro.Examples.Auditing.EntityType.AuditActionTypeEntity, false) { }
		
		/// <summary>Creates a new AuditActionTypeEntity instance but uses a special constructor which will set the Fields object of the new IEntity2 instance to the passed in fields object.</summary>
	...
	public partial class AuditInfoEntityFactory : EntityFactoryBase2<AuditInfoEntity> {
		/// <summary>CTor</summary>
		public AuditInfoEntityFactory() : base("AuditInfoEntity", SD.LLBLGen.Pro.Examples.Auditing.EntityType.AuditInfoEntity, true) { }
	...
	public partial class CategoryEntityFactory : EntityFactoryBase2<CategoryEntity> {
		/// <summary>CTor</summary>
		public CategoryEntityFactory() : base("CategoryEntity", SD.LLBLGen.Pro.Examples.Auditing.EntityType.CategoryEntity, false) { }
	...
	public partial class CustomerEntityFactory : EntityFactoryBase2<CustomerEntity> {
		/// <summary>CTor</summary>
		public CustomerEntityFactory() : base("CustomerEntity", SD.LLBLGen.Pro.Examples.Auditing.EntityType.CustomerEntity, false) { }
	...
	public partial class CustomerCustomerDemoEntityFactory : EntityFactoryBase2<CustomerCustomerDemoEntity> {
		/// <summary>CTor</summary>
		public CustomerCustomerDemoEntityFactory() : base("CustomerCustomerDemoEntity", SD.LLBLGen.Pro.Examples.Auditing.EntityType.CustomerCustomerDemoEntity, false) { }
	...
	public partial class CustomerDemographyEntityFactory : EntityFactoryBase2<CustomerDemographyEntity> {
		/// <summary>CTor</summary>
		public CustomerDemographyEntityFactory() : base("CustomerDemographyEntity", SD.LLBLGen.Pro.Examples.Auditing.EntityType.CustomerDemographyEntity, false) { }
	...
	public partial class EmployeeEntityFactory : EntityFactoryBase2<EmployeeEntity> {
		/// <summary>CTor</summary>
		public EmployeeEntityFactory() : base("EmployeeEntity", SD.LLBLGen.Pro.Examples.Auditing.EntityType.EmployeeEntity, false) { }
	...
	public partial class EmployeeTerritoryEntityFactory : EntityFactoryBase2<EmployeeTerritoryEntity> {
		/// <summary>CTor</summary>
		public EmployeeTerritoryEntityFactory() : base("EmployeeTerritoryEntity", SD.LLBLGen.Pro.Examples.Auditing.EntityType.EmployeeTerritoryEntity, false) { }
	...
	public partial class OrderEntityFactory : EntityFactoryBase2<OrderEntity> {
		/// <summary>CTor</summary>
		public OrderEntityFactory() : base("OrderEntity", SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderEntity, false) { }
	...
	public partial class OrderAuditInfoEntityFactory : EntityFactoryBase2<OrderAuditInfoEntity> {
		/// <summary>CTor</summary>
		public OrderAuditInfoEntityFactory() : base("OrderAuditInfoEntity", SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderAuditInfoEntity, true) { }
		
		/// <summary>Creates a new OrderAuditInfoEntity instance but uses a special constructor which will set the Fields object of the new IEntity2 instance to the passed in fields object.</summary>
		/// <param name="fields">Populated IEntityFields2 object for the new IEntity2 to create</param>
		/// <returns>Fully created and populated (due to the IEntityFields2 object) IEntity2 object</returns>
		public override IEntity2 Create(IEntityFields2 fields) {
	...
	public partial class OrderDetailEntityFactory : EntityFactoryBase2<OrderDetailEntity> {
		/// <summary>CTor</summary>
		public OrderDetailEntityFactory() : base("OrderDetailEntity", SD.LLBLGen.Pro.Examples.Auditing.EntityType.OrderDetailEntity, false) { }
	...
	public partial class ProductEntityFactory : EntityFactoryBase2<ProductEntity> {
		/// <summary>CTor</summary>
		public ProductEntityFactory() : base("ProductEntity", SD.LLBLGen.Pro.Examples.Auditing.EntityType.ProductEntity, false) { }
	...
	public partial class RegionEntityFactory : EntityFactoryBase2<RegionEntity> {
		/// <summary>CTor</summary>
		public RegionEntityFactory() : base("RegionEntity", SD.LLBLGen.Pro.Examples.Auditing.EntityType.RegionEntity, false) { }
	...
	public partial class ShipperEntityFactory : EntityFactoryBase2<ShipperEntity> {
		/// <summary>CTor</summary>
		public ShipperEntityFactory() : base("ShipperEntity", SD.LLBLGen.Pro.Examples.Auditing.EntityType.ShipperEntity, false) { }
	...
	public partial class SupplierEntityFactory : EntityFactoryBase2<SupplierEntity> {
		/// <summary>CTor</summary>
		public SupplierEntityFactory() : base("SupplierEntity", SD.LLBLGen.Pro.Examples.Auditing.EntityType.SupplierEntity, false) { }
	...
	public partial class TerritoryEntityFactory : EntityFactoryBase2<TerritoryEntity> {
		/// <summary>CTor</summary>
		public TerritoryEntityFactory() : base("TerritoryEntity", SD.LLBLGen.Pro.Examples.Auditing.EntityType.TerritoryEntity, false) { }
	...
	public partial class UserEntityFactory : EntityFactoryBase2<UserEntity> {
		/// <summary>CTor</summary>
		public UserEntityFactory() : base("UserEntity", SD.LLBLGen.Pro.Examples.Auditing.EntityType.UserEntity, false) { }
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(SD.LLBLGen.Pro.Examples.Auditing.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		static EntityFactoryFactory()
		{
			...
			{
				IEntity2 dummy = GeneralEntityFactory.Create((SD.LLBLGen.Pro.Examples.Auditing.EntityType)entityTypeValue);
		...
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(SD.LLBLGen.Pro.Examples.Auditing.EntityType typeOfEntity)
		{
