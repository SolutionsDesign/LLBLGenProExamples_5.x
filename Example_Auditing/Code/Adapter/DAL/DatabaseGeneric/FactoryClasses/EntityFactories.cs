...
namespace SD.LLBLGen.Pro.Examples.Auditing.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, SD.LLBLGen.Pro.Examples.Auditing.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((SD.LLBLGen.Pro.Examples.Auditing.EntityType)entityTypeValue); }
