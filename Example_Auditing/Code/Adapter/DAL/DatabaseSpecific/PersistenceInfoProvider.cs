...
namespace SD.LLBLGen.Pro.Examples.Auditing.DatabaseSpecific
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		private void Init()
		{
			...
			InitCustomerDemographyEntityMappings();
		...
		private void InitAuditInfoEntityMappings()
		{
			...
			this.AddElementFieldMapping("AuditInfoEntity", "AuditActionTypeId", "AuditActionTypeID", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 3);
			this.AddElementFieldMapping("AuditInfoEntity", "AuditInfoId", "AuditInfoID", false, "Int", 0, 10, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int32), 4);
		...
		/// <summary>Inits CustomerDemographyEntity's mappings</summary>
		private void InitCustomerDemographyEntityMappings()
		{
			this.AddElementMapping("CustomerDemographyEntity", @"Northwind", @"dbo", "CustomerDemographics", 2, 0);
			this.AddElementFieldMapping("CustomerDemographyEntity", "CustomerDesc", "CustomerDesc", true, "NText", 1073741823, 0, 0, false, "", null, typeof(System.String), 0);
			this.AddElementFieldMapping("CustomerDemographyEntity", "CustomerTypeId", "CustomerTypeID", false, "NChar", 10, 0, 0, false, "", null, typeof(System.String), 1);
		}
