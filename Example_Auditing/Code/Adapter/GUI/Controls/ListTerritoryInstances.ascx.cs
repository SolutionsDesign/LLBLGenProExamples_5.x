...
public partial class Controls_ListTerritoryInstances : System.Web.UI.UserControl, IListControl
{
	...
	protected void btnAddNew_Click(object sender, EventArgs e)
	{
		...
		Response.Redirect("~/AddNew.aspx?EntityType=" + (int)EntityType.TerritoryEntity + additionalFiltersAsString);
	}
	...
	public void SetContainingEntity(IEntity2 containingEntity, string name)
	{
		switch(containingEntity.LLBLGenProEntityName)
		{
			...
			case "RegionEntity":
				...
				{
					case "Territories":
						_TerritoryDS.FilterToUse = ((RegionEntity)containingEntity).GetRelationInfoTerritories();
						ViewState["additionalFilters"] = "&RegionId=" + 
								((RegionEntity)containingEntity).RegionId +
								"&20FkField=RegionId";
						break;
					default:
						break;
			...
			case "EmployeeEntity":
				switch(name)
				{
					case "TerritoriesCollectionViaEmployeeTerritories":
						_TerritoryDS.FilterToUse = ((EmployeeEntity)containingEntity).GetRelationInfoTerritoriesCollectionViaEmployeeTerritories();
						break;
					default:
						break;
				}
	...
	{
		set { _TerritoryDS.FilterToUse = value; }
	}
