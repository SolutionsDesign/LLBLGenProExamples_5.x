...
public partial class Controls_ListOrderAuditInfoInstances : System.Web.UI.UserControl, IListControl
{
	...
	protected void btnAddNew_Click(object sender, EventArgs e)
	{
		...
		Response.Redirect("~/AddNew.aspx?EntityType=" + (int)EntityType.OrderAuditInfoEntity + additionalFiltersAsString);
	}
	...
	public void SetContainingEntity(IEntity2 containingEntity, string name)
	{
		switch(containingEntity.LLBLGenProEntityName)
		{
			...
			case "OrderEntity":
				...
				{
					case "OrderAuditInfo":
						_OrderAuditInfoDS.FilterToUse = ((OrderEntity)containingEntity).GetRelationInfoOrderAuditInfo();
	...
	{
		set { _OrderAuditInfoDS.FilterToUse = value; }
	}
