...
public partial class Controls_ListCustomerCustomerDemoInstances : System.Web.UI.UserControl, IListControl
{
	...
	protected void btnAddNew_Click(object sender, EventArgs e)
	{
		...
		Response.Redirect("~/AddNew.aspx?EntityType=" + (int)EntityType.CustomerCustomerDemoEntity + additionalFiltersAsString);
	}
	...
	public void SetContainingEntity(IEntity2 containingEntity, string name)
	{
		switch(containingEntity.LLBLGenProEntityName)
		{
			case "CustomerDemographyEntity":
				switch(name)
				{
					case "CustomerCustomerDemo":
						_CustomerCustomerDemoDS.FilterToUse = ((CustomerDemographyEntity)containingEntity).GetRelationInfoCustomerCustomerDemo();
						ViewState["additionalFilters"] = "&CustomerTypeId=" + 
								((CustomerDemographyEntity)containingEntity).CustomerTypeId +
								"&20FkField=CustomerTypeId";
						break;
					default:
						break;
				}
			...
			case "CustomerEntity":
				...
				{
					case "CustomerCustomerDemo":
						_CustomerCustomerDemoDS.FilterToUse = ((CustomerEntity)containingEntity).GetRelationInfoCustomerCustomerDemo();
	...
	{
		set { _CustomerCustomerDemoDS.FilterToUse = value; }
	}
