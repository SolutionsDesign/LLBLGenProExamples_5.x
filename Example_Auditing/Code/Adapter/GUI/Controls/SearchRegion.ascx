...
<%@ Control Language="C#" AutoEventWireup="true" Inherits="Controls_SearchRegion" Codebehind="SearchRegion.ascx.cs" %>
...
<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
	...
	<tr>
		...
		<td class="content">
			<asp:textbox id="tbxRegionId" runat="server" maxlength="11" size="11" Text="" ValidationGroup="PkSearchValidation"  CssClass="required"/>  <asp:RangeValidator ID="valRegionId" runat="server" ControlToValidate="tbxRegionId" ValidationGroup="PkSearchValidation" Display="dynamic" ErrorMessage="Invalid value" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/> <asp:RequiredFieldValidator ValidationGroup="PkSearchValidation" ID="reqRegionId" runat="server" ControlToValidate="tbxRegionId" Display="Dynamic" ErrorMessage="Required" />
		</td>
		<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
	</tr>
	<tr>
...
<table cellpadding="2" border="0" cellspacing="0" class="formtexts">
	...
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnableRegionDescription" runat="server" /></td>
		<td class="formtexts tableborder">
			RegionDescription:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotRegionDescription" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opRegionDescription" runat="server">
				<asp:ListItem Value="0" Text="Equal"/>
				<asp:ListItem Value="7" Text="Like"/>
			</asp:DropDownList>
		</td>
		<td class="content tableborder" nowrap="nowrap">
			<asp:textbox id="tbxRegionDescriptionMiFrom" runat="server" maxlength="50" size="25" Text="" ValidationGroup="SubSetSearchValidation" /> 
