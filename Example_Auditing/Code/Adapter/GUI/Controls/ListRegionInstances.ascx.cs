...
public partial class Controls_ListRegionInstances : System.Web.UI.UserControl, IListControl
{
	...
	protected void btnAddNew_Click(object sender, EventArgs e)
	{
		...
		Response.Redirect("~/AddNew.aspx?EntityType=" + (int)EntityType.RegionEntity + additionalFiltersAsString);
	}
	...
	{
		set { _RegionDS.FilterToUse = value; }
	}
