...
public partial class Controls_ListShipperInstances : System.Web.UI.UserControl, IListControl
{
	...
	protected void btnAddNew_Click(object sender, EventArgs e)
	{
		...
		Response.Redirect("~/AddNew.aspx?EntityType=" + (int)EntityType.ShipperEntity + additionalFiltersAsString);
	}
	...
	public void SetContainingEntity(IEntity2 containingEntity, string name)
	{
		switch(containingEntity.LLBLGenProEntityName)
		{
			...
			case "CustomerEntity":
				switch(name)
				{
					case "ShippersCollectionViaOrders":
						_ShipperDS.FilterToUse = ((CustomerEntity)containingEntity).GetRelationInfoShippersCollectionViaOrders();
						break;
					default:
						break;
				}
			...
			case "EmployeeEntity":
				...
				{
					case "ShippersCollectionViaOrders":
						_ShipperDS.FilterToUse = ((EmployeeEntity)containingEntity).GetRelationInfoShippersCollectionViaOrders();
						break;
					default:
						break;
				}
	...
	{
		set { _ShipperDS.FilterToUse = value; }
	}
