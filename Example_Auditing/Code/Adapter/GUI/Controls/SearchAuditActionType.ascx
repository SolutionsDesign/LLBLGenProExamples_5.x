...
<%@ Control Language="C#" AutoEventWireup="true" Inherits="Controls_SearchAuditActionType" Codebehind="SearchAuditActionType.ascx.cs" %>
...
<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
	...
	<tr>
		...
		<td class="content">
			<asp:textbox id="tbxAuditActionTypeId" runat="server" maxlength="11" size="11" Text="" ValidationGroup="PkSearchValidation"  CssClass="required"/>  <asp:RangeValidator ID="valAuditActionTypeId" runat="server" ControlToValidate="tbxAuditActionTypeId" ValidationGroup="PkSearchValidation" Display="dynamic" ErrorMessage="Invalid value" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/> <asp:RequiredFieldValidator ValidationGroup="PkSearchValidation" ID="reqAuditActionTypeId" runat="server" ControlToValidate="tbxAuditActionTypeId" Display="Dynamic" ErrorMessage="Required" />
		</td>
		<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
	</tr>
	<tr>
