...
public partial class Controls_ListAuditActionTypeInstances : System.Web.UI.UserControl, IListControl
{
	...
	protected void btnAddNew_Click(object sender, EventArgs e)
	{
		...
		Response.Redirect("~/AddNew.aspx?EntityType=" + (int)EntityType.AuditActionTypeEntity + additionalFiltersAsString);
	}
	...
	{
		set { _AuditActionTypeDS.FilterToUse = value; }
	}
