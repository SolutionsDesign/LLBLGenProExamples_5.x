...
public partial class Controls_ListCustomerDemographyInstances : System.Web.UI.UserControl, IListControl
{
	...
	protected void btnAddNew_Click(object sender, EventArgs e)
	{
		...
		Response.Redirect("~/AddNew.aspx?EntityType=" + (int)EntityType.CustomerDemographyEntity + additionalFiltersAsString);
	}
			...
			case "CustomerEntity":
				switch(name)
				{
					case "CustomerDemographicsCollectionViaCustomerCustomerDemo":
						_CustomerDemographyDS.FilterToUse = ((CustomerEntity)containingEntity).GetRelationInfoCustomerDemographicsCollectionViaCustomerCustomerDemo();
						break;
					default:
						break;
				}
	...
	{
		set { _CustomerDemographyDS.FilterToUse = value; }
	}
