...
namespace SD.LLBLGen.Pro.Examples.WCF.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class EmployeeEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("EmployeeEntity", InheritanceHierarchyType.None, false, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.EmployeeEntity, typeof(EmployeeEntity), typeof(EmployeeEntityFactory), false);
				AddNavigatorMetaData<EmployeeEntity, EntityCollection<EmployeeEntity>>("ManagedEmployees", a => a._managedEmployees, (a, b) => a._managedEmployees = b, a => a.ManagedEmployees, () => new EmployeeRelations().EmployeeEntityUsingReportsTo, typeof(EmployeeEntity), (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.EmployeeEntity);
				AddNavigatorMetaData<EmployeeEntity, EntityCollection<OrderEntity>>("Orders", a => a._orders, (a, b) => a._orders = b, a => a.Orders, () => new EmployeeRelations().OrderEntityUsingEmployeeId, typeof(OrderEntity), (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrderEntity);
				AddNavigatorMetaData<EmployeeEntity, EmployeeEntity>("Manager", "ManagedEmployees", (a, b) => a._manager = b, a => a._manager, (a, b) => a.Manager = b, SD.LLBLGen.Pro.Examples.WCF.RelationClasses.StaticEmployeeRelations.EmployeeEntityUsingEmployeeIdReportsToStatic, ()=>new EmployeeRelations().EmployeeEntityUsingEmployeeIdReportsTo, null, new int[] { (int)EmployeeFieldIndex.ReportsTo }, null, true, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.EmployeeEntity);
				AddNavigatorMetaData<EmployeeEntity, EntityCollection<CustomerEntity>>("CustomersCollectionViaOrders", a => a._customersCollectionViaOrders, (a, b) => a._customersCollectionViaOrders = b, a => a.CustomersCollectionViaOrders, () => new EmployeeRelations().OrderEntityUsingEmployeeId, () => new OrderRelations().CustomerEntityUsingCustomerId, "EmployeeEntity__", "Order_", typeof(CustomerEntity), (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.CustomerEntity);
			}
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoManagedEmployees() { return CreateRelationInfoForNavigator("ManagedEmployees"); }
		...
		public static IPrefetchPathElement2 PrefetchPathManagedEmployees { get { return _staticMetaData.GetPrefetchPathElement("ManagedEmployees", CommonEntityBase.CreateEntityCollection<EmployeeEntity>()); } }
		...
		/// <remarks>Mapped on  table field: "Employees"."ReportsTo".<br/>Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		...
		public virtual EntityCollection<EmployeeEntity> ManagedEmployees { get { return GetOrCreateEntityCollection<EmployeeEntity, EmployeeEntityFactory>("Manager", true, false, ref _managedEmployees); } }
...
namespace SD.LLBLGen.Pro.Examples.WCF.RelationClasses
{
	...
	public partial class EmployeeRelations: RelationFactory
	{
		...
		{
			get { return ModelInfoProviderSingleton.GetInstance().CreateRelation(RelationType.OneToMany, "ManagedEmployees", true, new[] { EmployeeFields.EmployeeId, EmployeeFields.ReportsTo }); }
		}
		...
		{
			get	{ return ModelInfoProviderSingleton.GetInstance().CreateRelation(RelationType.ManyToOne, "Manager", false, new[] { EmployeeFields.EmployeeId, EmployeeFields.ReportsTo }); }
		}
