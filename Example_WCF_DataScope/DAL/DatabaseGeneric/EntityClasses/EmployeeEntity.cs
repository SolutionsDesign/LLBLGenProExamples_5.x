...
namespace SD.LLBLGen.Pro.Examples.WCF.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<EmployeeEntity> _managedEmployees;
		...
		public static partial class MemberNames
		{
			...
			/// <summary>Member name ManagedEmployees</summary>
			public static readonly string ManagedEmployees = "ManagedEmployees";
		...
		protected EmployeeEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			{
				_managedEmployees = (EntityCollection<EmployeeEntity>)info.GetValue("_managedEmployees", typeof(EntityCollection<EmployeeEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "ManagedEmployees":
					this.ManagedEmployees.Add((EmployeeEntity)entity);
					break;
				case "Orders":
		...
		protected override void SetRelatedEntity(IEntityCore relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				case "Manager":
					...
					break;
				case "ManagedEmployees":
					this.ManagedEmployees.Add((EmployeeEntity)relatedEntity);
					break;
				case "Orders":
		...
		protected override void UnsetRelatedEntity(IEntityCore relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			switch(fieldName)
			{
				case "Manager":
					...
					break;
				case "ManagedEmployees":
					this.PerformRelatedEntityRemoval(this.ManagedEmployees, relatedEntity, signalRelatedEntityManyToOne);
					break;
				case "Orders":
		...
		protected override List<IEntityCollection2> GetMemberEntityCollections()
		{
			...
			toReturn.Add(this.ManagedEmployees);
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				info.AddValue("_managedEmployees", ((_managedEmployees!=null) && (_managedEmployees.Count>0) && !this.MarkedForDeletion)?_managedEmployees:null);
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoManagedEmployees()
		{
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._managedEmployees);
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._managedEmployees = (EntityCollection<EmployeeEntity>) collectionsQueue.Dequeue();
		...
		{
			bool toReturn = false;
			toReturn |=(this._managedEmployees != null);
		...
		protected override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("ManagedEmployees", _managedEmployees);
		...
		{
			this.PerformDesetupSyncRelatedEntity( _manager, new PropertyChangedEventHandler( OnManagerPropertyChanged ), "Manager", SD.LLBLGen.Pro.Examples.WCF.RelationClasses.StaticEmployeeRelations.EmployeeEntityUsingEmployeeIdReportsToStatic, true, signalRelatedEntity, "ManagedEmployees", resetFKFields, new int[] { (int)EmployeeFieldIndex.ReportsTo } );
			_manager = null;
		}
		...
		private void SetupSyncManager(IEntityCore relatedEntity)
		{
			if(_manager!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _manager, new PropertyChangedEventHandler( OnManagerPropertyChanged ), "Manager", SD.LLBLGen.Pro.Examples.WCF.RelationClasses.StaticEmployeeRelations.EmployeeEntityUsingEmployeeIdReportsToStatic, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathManagedEmployees
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<EmployeeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))), (IEntityRelation)GetRelationsForField("ManagedEmployees")[0], (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.EmployeeEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.EmployeeEntity, 0, null, null, null, null, "ManagedEmployees", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCustomersCollectionViaOrders
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CustomerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.WCF.EntityType.EmployeeEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.CustomerEntity, 0, null, null, GetRelationsForField("CustomersCollectionViaOrders"), null, "CustomersCollectionViaOrders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))),	(IEntityRelation)GetRelationsForField("Manager")[0], (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.EmployeeEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.EmployeeEntity, 0, null, null, null, null, "Manager", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get { return (System.Int32)GetValue((int)EmployeeFieldIndex.ReportsTo, true); }
		...
		public virtual EntityCollection<EmployeeEntity> ManagedEmployees
		{
			get { return GetOrCreateEntityCollection<EmployeeEntity, EmployeeEntityFactory>("Manager", true, false, ref _managedEmployees);	}
		}
		...
		public virtual EmployeeEntity Manager
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "ManagedEmployees", "Manager", _manager, true); 
				}
			}
		}
		...
		{ 
			get { return (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.EmployeeEntity; }
		}
