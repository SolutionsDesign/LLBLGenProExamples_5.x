		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncOrder(IEntityCore relatedEntity)
		{
			if(_order!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _order, new PropertyChangedEventHandler( OnOrderPropertyChanged ), "Order", SD.LLBLGen.Pro.Examples.WCF.RelationClasses.StaticOrderDetailsRelations.OrderEntityUsingOrderIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncProduct(IEntityCore relatedEntity)
		{
			if(_product!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", SD.LLBLGen.Pro.Examples.WCF.RelationClasses.StaticOrderDetailsRelations.ProductEntityUsingProductIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(OrderEntityFactory))),	(IEntityRelation)GetRelationsForField("Order")[0], (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrderDetailsEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrderEntity, 0, null, null, null, null, "Order", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrderDetailsEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrderDetailsEntity; }
		}
