...
namespace SD.LLBLGen.Pro.Examples.WCF.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class OrderDetailsEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("OrderDetailsEntity", InheritanceHierarchyType.None, false, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrderDetailsEntity, typeof(OrderDetailsEntity), typeof(OrderDetailsEntityFactory), false);
				AddNavigatorMetaData<OrderDetailsEntity, OrderEntity>("Order", "OrderDetails", (a, b) => a._order = b, a => a._order, (a, b) => a.Order = b, SD.LLBLGen.Pro.Examples.WCF.RelationClasses.StaticOrderDetailsRelations.OrderEntityUsingOrderIdStatic, ()=>new OrderDetailsRelations().OrderEntityUsingOrderId, null, new int[] { (int)OrderDetailsFieldIndex.OrderId }, null, true, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrderEntity);
				AddNavigatorMetaData<OrderDetailsEntity, ProductEntity>("Product", "OrderDetails", (a, b) => a._product = b, a => a._product, (a, b) => a.Product = b, SD.LLBLGen.Pro.Examples.WCF.RelationClasses.StaticOrderDetailsRelations.ProductEntityUsingProductIdStatic, ()=>new OrderDetailsRelations().ProductEntityUsingProductId, null, new int[] { (int)OrderDetailsFieldIndex.ProductId }, null, true, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.ProductEntity);
			}
		}
...
namespace SD.LLBLGen.Pro.Examples.WCF.RelationClasses
{
	...
	public partial class OrderDetailsRelations: RelationFactory
	{
		...
		/// <summary>Returns a new IEntityRelation object, between OrderDetailsEntity and OrderEntity over the m:1 relation they have, using the relation between the fields: OrderDetails.OrderId - Order.OrderId</summary>
		public virtual IEntityRelation OrderEntityUsingOrderId
		{
			get	{ return ModelInfoProviderSingleton.GetInstance().CreateRelation(RelationType.ManyToOne, "Order", false, new[] { OrderFields.OrderId, OrderDetailsFields.OrderId }); }
		}

		/// <summary>Returns a new IEntityRelation object, between OrderDetailsEntity and ProductEntity over the m:1 relation they have, using the relation between the fields: OrderDetails.ProductId - Product.ProductId</summary>
		public virtual IEntityRelation ProductEntityUsingProductId
		{
			get	{ return ModelInfoProviderSingleton.GetInstance().CreateRelation(RelationType.ManyToOne, "Product", false, new[] { ProductFields.ProductId, OrderDetailsFields.ProductId }); }
		}
