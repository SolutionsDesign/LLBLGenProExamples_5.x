		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "OrderDetails":
					...
					break;
				case "OrdersCollectionViaOrderDetails":
					toReturn.Add(Relations.OrderDetailsEntityUsingProductId, "ProductEntity__", "OrderDetails_", JoinHint.None);
					toReturn.Add(OrderDetailsEntity.Relations.OrderEntityUsingOrderId, "OrderDetails_", string.Empty, JoinHint.None);
					break;
				default:
					break;				
			}
		...
		private void SetupSyncCategory(IEntityCore relatedEntity)
		{
			if(_category!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _category, new PropertyChangedEventHandler( OnCategoryPropertyChanged ), "Category", SD.LLBLGen.Pro.Examples.WCF.RelationClasses.StaticProductRelations.CategoryEntityUsingCategoryIdStatic, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrdersCollectionViaOrderDetails
		{
			get
			{
				IEntityRelation intermediateRelation = Relations.OrderDetailsEntityUsingProductId;
				...
				return new PrefetchPathElement2(new EntityCollection<OrderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrderEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.WCF.EntityType.ProductEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrderEntity, 0, null, null, GetRelationsForField("OrdersCollectionViaOrderDetails"), null, "OrdersCollectionViaOrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CategoryEntityFactory))),	(IEntityRelation)GetRelationsForField("Category")[0], (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.ProductEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.CategoryEntity, 0, null, null, null, null, "Category", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get { return GetOrCreateEntityCollection<OrderDetailsEntity, OrderDetailsEntityFactory>("Product", true, false, ref _orderDetails);	}
		}
		...
		{ 
			get { return (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.ProductEntity; }
		}
