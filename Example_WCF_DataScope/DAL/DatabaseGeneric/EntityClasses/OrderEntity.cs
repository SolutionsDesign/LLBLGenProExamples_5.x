...
namespace SD.LLBLGen.Pro.Examples.WCF.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class OrderEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("OrderEntity", InheritanceHierarchyType.None, false, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrderEntity, typeof(OrderEntity), typeof(OrderEntityFactory), false);
				AddNavigatorMetaData<OrderEntity, EntityCollection<OrderDetailsEntity>>("OrderDetails", a => a._orderDetails, (a, b) => a._orderDetails = b, a => a.OrderDetails, () => new OrderRelations().OrderDetailsEntityUsingOrderId, typeof(OrderDetailsEntity), (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrderDetailsEntity);
				AddNavigatorMetaData<OrderEntity, CustomerEntity>("Customer", "Orders", (a, b) => a._customer = b, a => a._customer, (a, b) => a.Customer = b, SD.LLBLGen.Pro.Examples.WCF.RelationClasses.StaticOrderRelations.CustomerEntityUsingCustomerIdStatic, ()=>new OrderRelations().CustomerEntityUsingCustomerId, null, new int[] { (int)OrderFieldIndex.CustomerId }, null, true, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.CustomerEntity);
				AddNavigatorMetaData<OrderEntity, EmployeeEntity>("Employee", "Orders", (a, b) => a._employee = b, a => a._employee, (a, b) => a.Employee = b, SD.LLBLGen.Pro.Examples.WCF.RelationClasses.StaticOrderRelations.EmployeeEntityUsingEmployeeIdStatic, ()=>new OrderRelations().EmployeeEntityUsingEmployeeId, null, new int[] { (int)OrderFieldIndex.EmployeeId }, null, true, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.EmployeeEntity);
				AddNavigatorMetaData<OrderEntity, EntityCollection<ProductEntity>>("ProductsCollectionViaOrderDetails", a => a._productsCollectionViaOrderDetails, (a, b) => a._productsCollectionViaOrderDetails = b, a => a.ProductsCollectionViaOrderDetails, () => new OrderRelations().OrderDetailsEntityUsingOrderId, () => new OrderDetailsRelations().ProductEntityUsingProductId, "OrderEntity__", "OrderDetails_", typeof(ProductEntity), (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.ProductEntity);
			}
		}
		...
		/// <remarks>Mapped on  table field: "Orders"."CustomerID".<br/>Table field type characteristics (type, precision, scale, length): NChar, 0, 0, 5.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		...
		/// <remarks>Mapped on  table field: "Orders"."EmployeeID".<br/>Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		...
		public virtual EntityCollection<OrderDetailsEntity> OrderDetails { get { return GetOrCreateEntityCollection<OrderDetailsEntity, OrderDetailsEntityFactory>("Order", true, false, ref _orderDetails); } }
...
namespace SD.LLBLGen.Pro.Examples.WCF.RelationClasses
{
	...
	{
		/// <summary>Returns a new IEntityRelation object, between OrderEntity and OrderDetailsEntity over the 1:n relation they have, using the relation between the fields: Order.OrderId - OrderDetails.OrderId</summary>
		public virtual IEntityRelation OrderDetailsEntityUsingOrderId
		{
			get { return ModelInfoProviderSingleton.GetInstance().CreateRelation(RelationType.OneToMany, "OrderDetails", true, new[] { OrderFields.OrderId, OrderDetailsFields.OrderId }); }
		}
