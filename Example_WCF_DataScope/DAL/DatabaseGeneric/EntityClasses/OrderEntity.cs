...
namespace SD.LLBLGen.Pro.Examples.WCF.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "OrderDetails":
					...
					break;
				case "ProductsCollectionViaOrderDetails":
					toReturn.Add(Relations.OrderDetailsEntityUsingOrderId, "OrderEntity__", "OrderDetails_", JoinHint.None);
					toReturn.Add(OrderDetailsEntity.Relations.ProductEntityUsingProductId, "OrderDetails_", string.Empty, JoinHint.None);
					break;
				default:
					break;				
			}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", SD.LLBLGen.Pro.Examples.WCF.RelationClasses.StaticOrderRelations.CustomerEntityUsingCustomerIdStatic, true, signalRelatedEntity, "Orders", resetFKFields, new int[] { (int)OrderFieldIndex.CustomerId } );
			_customer = null;
		}
		...
		private void SetupSyncCustomer(IEntityCore relatedEntity)
		{
			if(_customer!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", SD.LLBLGen.Pro.Examples.WCF.RelationClasses.StaticOrderRelations.CustomerEntityUsingCustomerIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", SD.LLBLGen.Pro.Examples.WCF.RelationClasses.StaticOrderRelations.EmployeeEntityUsingEmployeeIdStatic, true, signalRelatedEntity, "Orders", resetFKFields, new int[] { (int)OrderFieldIndex.EmployeeId } );
			_employee = null;
		}
		...
		private void SetupSyncEmployee(IEntityCore relatedEntity)
		{
			if(_employee!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", SD.LLBLGen.Pro.Examples.WCF.RelationClasses.StaticOrderRelations.EmployeeEntityUsingEmployeeIdStatic, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathProductsCollectionViaOrderDetails
		{
			get
			{
				IEntityRelation intermediateRelation = Relations.OrderDetailsEntityUsingOrderId;
				intermediateRelation.SetAliases(string.Empty, "OrderDetails_");
				return new PrefetchPathElement2(new EntityCollection<ProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrderEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.ProductEntity, 0, null, null, GetRelationsForField("ProductsCollectionViaOrderDetails"), null, "ProductsCollectionViaOrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))),	(IEntityRelation)GetRelationsForField("Customer")[0], (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrderEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.CustomerEntity, 0, null, null, null, null, "Customer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))),	(IEntityRelation)GetRelationsForField("Employee")[0], (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrderEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.EmployeeEntity, 0, null, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get { return (System.Int32)GetValue((int)OrderFieldIndex.EmployeeId, true); }
		...
		{
			get { return GetOrCreateEntityCollection<OrderDetailsEntity, OrderDetailsEntityFactory>("Order", true, false, ref _orderDetails);	}
		}
		...
		{ 
			get { return (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrderEntity; }
		}
