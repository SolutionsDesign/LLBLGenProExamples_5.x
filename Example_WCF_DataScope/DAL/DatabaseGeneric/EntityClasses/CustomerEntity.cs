...
namespace SD.LLBLGen.Pro.Examples.WCF.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class CustomerEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("CustomerEntity", InheritanceHierarchyType.None, false, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.CustomerEntity, typeof(CustomerEntity), typeof(CustomerEntityFactory), false);
				AddNavigatorMetaData<CustomerEntity, EntityCollection<OrderEntity>>("Orders", a => a._orders, (a, b) => a._orders = b, a => a.Orders, () => new CustomerRelations().OrderEntityUsingCustomerId, typeof(OrderEntity), (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrderEntity);
				AddNavigatorMetaData<CustomerEntity, EntityCollection<EmployeeEntity>>("EmployeesCollectionViaOrders", a => a._employeesCollectionViaOrders, (a, b) => a._employeesCollectionViaOrders = b, a => a.EmployeesCollectionViaOrders, () => new CustomerRelations().OrderEntityUsingCustomerId, () => new OrderRelations().EmployeeEntityUsingEmployeeId, "CustomerEntity__", "Order_", typeof(EmployeeEntity), (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.EmployeeEntity);
			}
		}
