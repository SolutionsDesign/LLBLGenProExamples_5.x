...
namespace SD.LLBLGen.Pro.Examples.WCF.FactoryClasses
{
	...
	{
		private readonly SD.LLBLGen.Pro.Examples.WCF.EntityType _typeOfEntity;
		...
		public EntityFactoryBase2(string entityName, SD.LLBLGen.Pro.Examples.WCF.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
		...
		{
			return GeneralEntityFactory.Create((SD.LLBLGen.Pro.Examples.WCF.EntityType)entityTypeValue);
		}
	...
	public static class EntityFactoryFactory
	{
		...
		{
			Array entityTypeValues = Enum.GetValues(typeof(SD.LLBLGen.Pro.Examples.WCF.EntityType));
			foreach(int entityTypeValue in entityTypeValues)
			{
				IEntity2 dummy = GeneralEntityFactory.Create((SD.LLBLGen.Pro.Examples.WCF.EntityType)entityTypeValue);
	...
	public class ElementCreator : ElementCreatorBase, IElementCreator2
	{
		...
		/// <summary>Implementation of the routine which gets the factory of the Entity type with the SD.LLBLGen.Pro.Examples.WCF.EntityType value passed in</summary>
		/// <param name="entityTypeValue">The entity type value.</param>
		/// <returns>the entity factory of the entity type or null if not found</returns>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue)
		{
			return EntityFactoryFactory.GetFactory((SD.LLBLGen.Pro.Examples.WCF.EntityType)entityTypeValue);
		}
