...
namespace Northwind.GUI
{
	...
	/// </summary>
	public class SSCustomerManagerUsingBO : System.Windows.Forms.Form
	{
		#region Components
		...
		private SSCustomerWithOrdersDataScope _customerScope;
		#endregion

		/// <summary>
		/// CTor
		/// </summary>
		public SSCustomerManagerUsingBO()
		{
			InitializeComponent();

			// block resizing beyond a minimum;
			this.MinimumSize = this.Size;
			_customerScope = new SSCustomerWithOrdersDataScope();
		...
		public SSCustomerManagerUsingBO(CustomerEntity customer)
			: this()
		{
		...
		private void InitializeComponent()
		{
			...
			// 
			this._customerBindingSource.DataSource = typeof(Northwind.SSDAL.EntityClasses.CustomerEntity);
			// 
			// label32
			// 
			...
			// 
			// SSCustomerManagerUsingBO
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(679, 656);
			this.Controls.Add(this.groupBox2);
			this.Controls.Add(this.groupBox1);
			this.Name = "SSCustomerManagerUsingBO";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "SelfServicing Northwind Customer manager form";
		...
		{
			using(SSCustomerSelector selector = new SSCustomerSelector())
			{
		...
		private void saveCustomerButton_Click(object sender, System.EventArgs e)
		{
			...
			using(var trans = new Transaction(System.Data.IsolationLevel.ReadCommitted, "BOTrans"))
			{
				bool succeeded = _customerScope.CommitChanges(trans);
				if(succeeded)
				{
