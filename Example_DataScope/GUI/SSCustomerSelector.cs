...
namespace Northwind.GUI
{
	...
	/// </summary>
	public class SSCustomerSelector : System.Windows.Forms.Form
	{
		#region Components
		...
		private CustomerCollection _allCustomers;
		#endregion

		/// <summary>
		/// CTor
		/// </summary>
		public SSCustomerSelector()
		{
			InitializeComponent();

			// get all customers
			_allCustomers = new CustomerCollection();
			_allCustomers.GetMulti(null);
		...
		private void InitializeComponent()
		{
			...
			this.Name = "SSCustomerSelector";
			this.Text = "Selfservicing Customer selector";
