namespace Northwind.GUI
{
	partial class SSReparentOrder
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this._employeesFromBindingSource.DataSource = typeof(Northwind.SSDAL.EntityClasses.EmployeeEntity);
			// 
			...
			// 
			this._employeesToBindingSource.DataSource = typeof(Northwind.SSDAL.EntityClasses.EmployeeEntity);
			// 
			// label2
			// 
			...
			this.Name = "SSReparentOrder";
			this.Text = "SelfServicing ReparentOrder";
