		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public virtual Northwind.SSDAL.CollectionClasses.AuditInfoCollection GetMultiAuditInfos(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedAuditInfos || forceFetch || _alwaysFetchAuditInfos) && !this.IsSerializing && !this.IsDeserializing && !this.InDesignMode)
			{
				...
				_auditInfos.GetMultiManyToOne(this, null, filter);
		...
		{
			get { return new PrefetchPathElement(new Northwind.SSDAL.CollectionClasses.AuditInfoCollection(), (IEntityRelation)GetRelationsForField("AuditInfos")[0], (int)Northwind.SSDAL.EntityType.AuditActionTypeEntity, (int)Northwind.SSDAL.EntityType.AuditInfoEntity, 0, null, null, null, "AuditInfos", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		{ 
			get { return (int)Northwind.SSDAL.EntityType.AuditActionTypeEntity; }
		}
