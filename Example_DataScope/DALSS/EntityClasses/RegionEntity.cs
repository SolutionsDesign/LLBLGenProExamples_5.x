...
namespace Northwind.SSDAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class RegionEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("RegionEntity", InheritanceHierarchyType.None, false, (int)Northwind.SSDAL.EntityType.RegionEntity, typeof(RegionEntity), typeof(RegionEntityFactory), false);
				AddNavigatorMetaData<RegionEntity, Northwind.SSDAL.CollectionClasses.TerritoryCollection>("Territories", a => a._territories, (a, b) => a._territories = b, a => a.Territories, () => new RegionRelations().TerritoryEntityUsingRegionId, typeof(TerritoryEntity), (int)Northwind.SSDAL.EntityType.TerritoryEntity);
			}
		}
		...
		{
			return PerformMultiEntityLazyLoading<Northwind.SSDAL.CollectionClasses.TerritoryCollection>("Territories", forceFetch, entityFactoryToUse, (c,r)=>c.GetMultiManyToOne(this, filter));
		}
		...
		public static IPrefetchPathElement PrefetchPathTerritories { get { return _staticMetaData.GetPrefetchPathElement("Territories", new Northwind.SSDAL.CollectionClasses.TerritoryCollection()); } }
		...
		public virtual Northwind.SSDAL.CollectionClasses.TerritoryCollection Territories { get { return GetMultiTerritories(false); } }
