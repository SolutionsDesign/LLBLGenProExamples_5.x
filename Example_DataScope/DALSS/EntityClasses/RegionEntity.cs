...
namespace Northwind.SSDAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public Northwind.SSDAL.CollectionClasses.TerritoryCollection GetMultiTerritories(bool forceFetch)
		{
		...
		/// <returns>Filled collection with all related entities of type 'TerritoryEntity'</returns>
		public Northwind.SSDAL.CollectionClasses.TerritoryCollection GetMultiTerritories(bool forceFetch, IPredicateExpression filter)
		{
		...
		public Northwind.SSDAL.CollectionClasses.TerritoryCollection GetMultiTerritories(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
		...
		/// <param name="filter">Extra filter to limit the resultset.</param>
		/// <returns>Filled collection with all related entities of the type constructed by the passed in entity factory</returns>
		public virtual Northwind.SSDAL.CollectionClasses.TerritoryCollection GetMultiTerritories(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
		...
		{
			get { return new PrefetchPathElement(new Northwind.SSDAL.CollectionClasses.TerritoryCollection(), (IEntityRelation)GetRelationsForField("Territories")[0], (int)Northwind.SSDAL.EntityType.RegionEntity, (int)Northwind.SSDAL.EntityType.TerritoryEntity, 0, null, null, null, "Territories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		public virtual Northwind.SSDAL.CollectionClasses.TerritoryCollection Territories
		{
		...
		{ 
			get { return (int)Northwind.SSDAL.EntityType.RegionEntity; }
		}
