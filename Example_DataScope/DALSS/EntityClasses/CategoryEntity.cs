...
namespace Northwind.SSDAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			get { return new PrefetchPathElement(new Northwind.SSDAL.CollectionClasses.ProductCollection(), (IEntityRelation)GetRelationsForField("Products")[0], (int)Northwind.SSDAL.EntityType.CategoryEntity, (int)Northwind.SSDAL.EntityType.ProductEntity, 0, null, null, null, "Products", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		{ 
			get { return (int)Northwind.SSDAL.EntityType.CategoryEntity; }
		}
