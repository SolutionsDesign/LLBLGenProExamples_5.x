...
namespace Northwind.SSDAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// <inheritdoc/>
		protected override IEntityFactory GetEntityFactoryFromCache(int entityTypeEnumValue) { return EntityFactoryFactory.GetFactory((Northwind.SSDAL.EntityType)entityTypeEnumValue); }

		/// <inheritdoc/>
		protected override Type LLBLGenProEntityTypeEnumType
		{
			get { return typeof(Northwind.SSDAL.EntityType); }
		}
