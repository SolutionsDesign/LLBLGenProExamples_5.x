...
namespace Northwind.SSDAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class EmployeeTerritoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("EmployeeTerritoryEntity", InheritanceHierarchyType.None, false, (int)Northwind.SSDAL.EntityType.EmployeeTerritoryEntity, typeof(EmployeeTerritoryEntity), typeof(EmployeeTerritoryEntityFactory), false);
				AddNavigatorMetaData<EmployeeTerritoryEntity, EmployeeEntity>("Employee", "EmployeeTerritories", (a, b) => a._employee = b, a => a._employee, (a, b) => a.Employee = b, Northwind.SSDAL.RelationClasses.StaticEmployeeTerritoryRelations.EmployeeEntityUsingEmployeeIdStatic, ()=>new EmployeeTerritoryRelations().EmployeeEntityUsingEmployeeId, null, new int[] { (int)EmployeeTerritoryFieldIndex.EmployeeId }, null, true, (int)Northwind.SSDAL.EntityType.EmployeeEntity);
				AddNavigatorMetaData<EmployeeTerritoryEntity, TerritoryEntity>("Territory", "EmployeeTerritories", (a, b) => a._territory = b, a => a._territory, (a, b) => a.Territory = b, Northwind.SSDAL.RelationClasses.StaticEmployeeTerritoryRelations.TerritoryEntityUsingTerritoryIdStatic, ()=>new EmployeeTerritoryRelations().TerritoryEntityUsingTerritoryId, null, new int[] { (int)EmployeeTerritoryFieldIndex.TerritoryId }, null, true, (int)Northwind.SSDAL.EntityType.TerritoryEntity);
			}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathTerritory { get { return _staticMetaData.GetPrefetchPathElement("Territory", new Northwind.SSDAL.CollectionClasses.TerritoryCollection()); } }
