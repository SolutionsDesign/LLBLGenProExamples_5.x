...
namespace Northwind.SSDAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void InitClassMembers()
		{
			...
			_territoryReturnsNewIfNotFound = false;
		...
		private void SetupSyncEmployee(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", Northwind.SSDAL.RelationClasses.StaticEmployeeTerritoryRelations.EmployeeEntityUsingEmployeeIdStatic, true, ref _alreadyFetchedEmployee, new string[] {  } );
			}
		}
		...
		private void SetupSyncTerritory(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _territory, new PropertyChangedEventHandler( OnTerritoryPropertyChanged ), "Territory", Northwind.SSDAL.RelationClasses.StaticEmployeeTerritoryRelations.TerritoryEntityUsingTerritoryIdStatic, true, ref _alreadyFetchedTerritory, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement(new Northwind.SSDAL.CollectionClasses.EmployeeCollection(), (IEntityRelation)GetRelationsForField("Employee")[0], (int)Northwind.SSDAL.EntityType.EmployeeTerritoryEntity, (int)Northwind.SSDAL.EntityType.EmployeeEntity, 0, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new Northwind.SSDAL.CollectionClasses.TerritoryCollection(), (IEntityRelation)GetRelationsForField("Territory")[0], (int)Northwind.SSDAL.EntityType.EmployeeTerritoryEntity, (int)Northwind.SSDAL.EntityType.TerritoryEntity, 0, null, null, null, "Territory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)Northwind.SSDAL.EntityType.EmployeeTerritoryEntity; }
		}
