...
namespace Northwind.SSDAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _category, new PropertyChangedEventHandler( OnCategoryPropertyChanged ), "Category", Northwind.SSDAL.RelationClasses.StaticProductRelations.CategoryEntityUsingCategoryIdStatic, true, signalRelatedEntity, "Products", resetFKFields, new int[] { (int)ProductFieldIndex.CategoryId } );		
			_category = null;
		}
		...
		private void SetupSyncCategory(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _category, new PropertyChangedEventHandler( OnCategoryPropertyChanged ), "Category", Northwind.SSDAL.RelationClasses.StaticProductRelations.CategoryEntityUsingCategoryIdStatic, true, ref _alreadyFetchedCategory, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _supplier, new PropertyChangedEventHandler( OnSupplierPropertyChanged ), "Supplier", Northwind.SSDAL.RelationClasses.StaticProductRelations.SupplierEntityUsingSupplierIdStatic, true, signalRelatedEntity, "Products", resetFKFields, new int[] { (int)ProductFieldIndex.SupplierId } );		
			_supplier = null;
		}
		...
		private void SetupSyncSupplier(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _supplier, new PropertyChangedEventHandler( OnSupplierPropertyChanged ), "Supplier", Northwind.SSDAL.RelationClasses.StaticProductRelations.SupplierEntityUsingSupplierIdStatic, true, ref _alreadyFetchedSupplier, new string[] {  } );
			}
		}
		...
		{
			get { return new PrefetchPathElement(new Northwind.SSDAL.CollectionClasses.OrderDetailCollection(), (IEntityRelation)GetRelationsForField("OrderDetails")[0], (int)Northwind.SSDAL.EntityType.ProductEntity, (int)Northwind.SSDAL.EntityType.OrderDetailEntity, 0, null, null, null, "OrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new Northwind.SSDAL.CollectionClasses.CategoryCollection(), (IEntityRelation)GetRelationsForField("Category")[0], (int)Northwind.SSDAL.EntityType.ProductEntity, (int)Northwind.SSDAL.EntityType.CategoryEntity, 0, null, null, null, "Category", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new Northwind.SSDAL.CollectionClasses.SupplierCollection(), (IEntityRelation)GetRelationsForField("Supplier")[0], (int)Northwind.SSDAL.EntityType.ProductEntity, (int)Northwind.SSDAL.EntityType.SupplierEntity, 0, null, null, null, "Supplier", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)Northwind.SSDAL.EntityType.ProductEntity; }
		}
