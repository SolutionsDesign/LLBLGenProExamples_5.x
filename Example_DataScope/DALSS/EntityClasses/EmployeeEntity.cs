...
namespace Northwind.SSDAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class EmployeeEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("EmployeeEntity", InheritanceHierarchyType.None, false, (int)Northwind.SSDAL.EntityType.EmployeeEntity, typeof(EmployeeEntity), typeof(EmployeeEntityFactory), false);
				AddNavigatorMetaData<EmployeeEntity, Northwind.SSDAL.CollectionClasses.EmployeeCollection>("Employees", a => a._employees, (a, b) => a._employees = b, a => a.Employees, () => new EmployeeRelations().EmployeeEntityUsingReportsTo, typeof(EmployeeEntity), (int)Northwind.SSDAL.EntityType.EmployeeEntity);
				AddNavigatorMetaData<EmployeeEntity, Northwind.SSDAL.CollectionClasses.EmployeeTerritoryCollection>("EmployeeTerritories", a => a._employeeTerritories, (a, b) => a._employeeTerritories = b, a => a.EmployeeTerritories, () => new EmployeeRelations().EmployeeTerritoryEntityUsingEmployeeId, typeof(EmployeeTerritoryEntity), (int)Northwind.SSDAL.EntityType.EmployeeTerritoryEntity);
				AddNavigatorMetaData<EmployeeEntity, Northwind.SSDAL.CollectionClasses.OrderCollection>("Orders", a => a._orders, (a, b) => a._orders = b, a => a.Orders, () => new EmployeeRelations().OrderEntityUsingEmployeeId, typeof(OrderEntity), (int)Northwind.SSDAL.EntityType.OrderEntity);
				AddNavigatorMetaData<EmployeeEntity, EmployeeEntity>("Employee", "Employees", (a, b) => a._employee = b, a => a._employee, (a, b) => a.Employee = b, Northwind.SSDAL.RelationClasses.StaticEmployeeRelations.EmployeeEntityUsingEmployeeIdReportsToStatic, ()=>new EmployeeRelations().EmployeeEntityUsingEmployeeIdReportsTo, null, new int[] { (int)EmployeeFieldIndex.ReportsTo }, null, true, (int)Northwind.SSDAL.EntityType.EmployeeEntity);
			}
		}
		...
		{
			return PerformMultiEntityLazyLoading<Northwind.SSDAL.CollectionClasses.EmployeeCollection>("Employees", forceFetch, entityFactoryToUse, (c,r)=>c.GetMultiManyToOne(this, filter));
		}
		...
		{
			return PerformMultiEntityLazyLoading<Northwind.SSDAL.CollectionClasses.EmployeeTerritoryCollection>("EmployeeTerritories", forceFetch, entityFactoryToUse, (c,r)=>c.GetMultiManyToOne(this, null, filter));
		}
		...
		{
			return PerformMultiEntityLazyLoading<Northwind.SSDAL.CollectionClasses.OrderCollection>("Orders", forceFetch, entityFactoryToUse, (c,r)=>c.GetMultiManyToOne(null, this, null, filter));
		}
		...
		{
			return PerformSingleEntityLazyLoading<EmployeeEntity>("Employee", forceFetch, _employeeReturnsNewIfNotFound, e=>e.FetchUsingPK(this.ReportsTo.GetValueOrDefault()));
		}
		...
		public static IPrefetchPathElement PrefetchPathEmployees { get { return _staticMetaData.GetPrefetchPathElement("Employees", new Northwind.SSDAL.CollectionClasses.EmployeeCollection()); } }
		...
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathEmployeeTerritories { get { return _staticMetaData.GetPrefetchPathElement("EmployeeTerritories", new Northwind.SSDAL.CollectionClasses.EmployeeTerritoryCollection()); } }
		...
		public virtual Northwind.SSDAL.CollectionClasses.EmployeeCollection Employees { get { return GetMultiEmployees(false); } }
		...
		public virtual Northwind.SSDAL.CollectionClasses.EmployeeTerritoryCollection EmployeeTerritories { get { return GetMultiEmployeeTerritories(false); } }
...
namespace Northwind.SSDAL.RelationClasses
{
	...
	public partial class EmployeeRelations: RelationFactory
	{
		...
		{
			get	{ return ModelInfoProviderSingleton.GetInstance().CreateRelation(RelationType.ManyToOne, "Employee", false, new[] { EmployeeFields.EmployeeId, EmployeeFields.ReportsTo }); }
		}
