...
namespace Northwind.SSDAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public AuditInfoEntity(System.Int32 auditInfoId, IPrefetchPath prefetchPathToUse):base("AuditInfoEntity")
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("AuditInfoEntity", ((Northwind.SSDAL.EntityType)typeOfEntity).ToString());
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _auditActionType, new PropertyChangedEventHandler( OnAuditActionTypePropertyChanged ), "AuditActionType", Northwind.SSDAL.RelationClasses.StaticAuditInfoRelations.AuditActionTypeEntityUsingAuditActionTypeIdStatic, true, signalRelatedEntity, "AuditInfos", resetFKFields, new int[] { (int)AuditInfoFieldIndex.AuditActionTypeId } );		
		...
		private void SetupSyncAuditActionType(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _auditActionType, new PropertyChangedEventHandler( OnAuditActionTypePropertyChanged ), "AuditActionType", Northwind.SSDAL.RelationClasses.StaticAuditInfoRelations.AuditActionTypeEntityUsingAuditActionTypeIdStatic, true, ref _alreadyFetchedAuditActionType, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", Northwind.SSDAL.RelationClasses.StaticAuditInfoRelations.UserEntityUsingUserIdStatic, true, signalRelatedEntity, "AuditInfos", resetFKFields, new int[] { (int)AuditInfoFieldIndex.UserId } );		
			_user = null;
		}
		...
		private void SetupSyncUser(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", Northwind.SSDAL.RelationClasses.StaticAuditInfoRelations.UserEntityUsingUserIdStatic, true, ref _alreadyFetchedUser, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement(new Northwind.SSDAL.CollectionClasses.AuditActionTypeCollection(), (IEntityRelation)GetRelationsForField("AuditActionType")[0], (int)Northwind.SSDAL.EntityType.AuditInfoEntity, (int)Northwind.SSDAL.EntityType.AuditActionTypeEntity, 0, null, null, null, "AuditActionType", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new Northwind.SSDAL.CollectionClasses.UserCollection(), (IEntityRelation)GetRelationsForField("User")[0], (int)Northwind.SSDAL.EntityType.AuditInfoEntity, (int)Northwind.SSDAL.EntityType.UserEntity, 0, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)Northwind.SSDAL.EntityType.AuditInfoEntity; }
		}
