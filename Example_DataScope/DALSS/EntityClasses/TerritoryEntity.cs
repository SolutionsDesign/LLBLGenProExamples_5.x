...
namespace Northwind.SSDAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class TerritoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("TerritoryEntity", InheritanceHierarchyType.None, false, (int)Northwind.SSDAL.EntityType.TerritoryEntity, typeof(TerritoryEntity), typeof(TerritoryEntityFactory), false);
				AddNavigatorMetaData<TerritoryEntity, Northwind.SSDAL.CollectionClasses.EmployeeTerritoryCollection>("EmployeeTerritories", a => a._employeeTerritories, (a, b) => a._employeeTerritories = b, a => a.EmployeeTerritories, () => new TerritoryRelations().EmployeeTerritoryEntityUsingTerritoryId, typeof(EmployeeTerritoryEntity), (int)Northwind.SSDAL.EntityType.EmployeeTerritoryEntity);
				AddNavigatorMetaData<TerritoryEntity, RegionEntity>("Region", "Territories", (a, b) => a._region = b, a => a._region, (a, b) => a.Region = b, Northwind.SSDAL.RelationClasses.StaticTerritoryRelations.RegionEntityUsingRegionIdStatic, ()=>new TerritoryRelations().RegionEntityUsingRegionId, null, new int[] { (int)TerritoryFieldIndex.RegionId }, null, true, (int)Northwind.SSDAL.EntityType.RegionEntity);
			}
		}
		...
		{
			return PerformMultiEntityLazyLoading<Northwind.SSDAL.CollectionClasses.EmployeeTerritoryCollection>("EmployeeTerritories", forceFetch, entityFactoryToUse, (c,r)=>c.GetMultiManyToOne(null, this, filter));
		}
		...
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathRegion { get { return _staticMetaData.GetPrefetchPathElement("Region", new Northwind.SSDAL.CollectionClasses.RegionCollection()); } }
