...
namespace Northwind.SSDAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void InitClassMembers()
		{
			...
			_regionReturnsNewIfNotFound = false;
		...
		{
			this.PerformDesetupSyncRelatedEntity( _region, new PropertyChangedEventHandler( OnRegionPropertyChanged ), "Region", Northwind.SSDAL.RelationClasses.StaticTerritoryRelations.RegionEntityUsingRegionIdStatic, true, signalRelatedEntity, "Territories", resetFKFields, new int[] { (int)TerritoryFieldIndex.RegionId } );		
			_region = null;
		}
		...
		private void SetupSyncRegion(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _region, new PropertyChangedEventHandler( OnRegionPropertyChanged ), "Region", Northwind.SSDAL.RelationClasses.StaticTerritoryRelations.RegionEntityUsingRegionIdStatic, true, ref _alreadyFetchedRegion, new string[] {  } );
			}
		}
		...
		{
			get { return new PrefetchPathElement(new Northwind.SSDAL.CollectionClasses.EmployeeTerritoryCollection(), (IEntityRelation)GetRelationsForField("EmployeeTerritories")[0], (int)Northwind.SSDAL.EntityType.TerritoryEntity, (int)Northwind.SSDAL.EntityType.EmployeeTerritoryEntity, 0, null, null, null, "EmployeeTerritories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new Northwind.SSDAL.CollectionClasses.RegionCollection(), (IEntityRelation)GetRelationsForField("Region")[0], (int)Northwind.SSDAL.EntityType.TerritoryEntity, (int)Northwind.SSDAL.EntityType.RegionEntity, 0, null, null, null, "Region", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual System.Byte[] Test
		{
			...
			set	{ SetValue((int)TerritoryFieldIndex.Test, value, true); }
		}
		...
		{ 
			get { return (int)Northwind.SSDAL.EntityType.TerritoryEntity; }
		}
