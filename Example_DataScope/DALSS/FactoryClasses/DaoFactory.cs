...
namespace Northwind.SSDAL.FactoryClasses
{
	...
	public partial class DAOFactory
	{
		...
		public static AuditActionTypeDAO CreateAuditActionTypeDAO()
		{
		...
		public static AuditInfoDAO CreateAuditInfoDAO()
		{
			return new AuditInfoDAO();
		}
		...
		/// <summary>Creates a new CustomerDemographicDAO object</summary>
		/// <returns>the new DAO object ready to use for CustomerDemographic Entities</returns>
		public static CustomerDemographicDAO CreateCustomerDemographicDAO()
		{
		...
		/// <summary>Creates a new GroupDAO object</summary>
		/// <returns>the new DAO object ready to use for Group Entities</returns>
		...
		public static OrderAuditInfoDAO CreateOrderAuditInfoDAO()
		{
			return new OrderAuditInfoDAO();
		}
