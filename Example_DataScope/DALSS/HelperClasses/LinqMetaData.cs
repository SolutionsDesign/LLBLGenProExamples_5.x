...
namespace Northwind.SSDAL.Linq
{
	...
	public partial class LinqMetaData : ILinqMetaData
	{
		...
		{
			get { return new DataSource<AuditActionTypeEntity>(this.TransactionToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); }
		}
		...
		{
			get { return new DataSource<AuditInfoEntity>(this.TransactionToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); }
		}
		...
		{
			get { return new DataSource<CustomerDemographicEntity>(this.TransactionToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); }
		}
		...
		{
			get { return new DataSource<GroupEntity>(this.TransactionToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); }
		}
		...
		{
			get { return new DataSource<OrderAuditInfoEntity>(this.TransactionToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); }
		}
		...
		{
			get { return new DataSource<UserGroupEntity>(this.TransactionToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); }
		}
