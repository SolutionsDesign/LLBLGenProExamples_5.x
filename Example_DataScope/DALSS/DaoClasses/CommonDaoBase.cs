...
namespace Northwind.SSDAL.DaoClasses
{
	...
	public partial class CommonDaoBase : DaoBase
	{
		...
		public CommonDaoBase(InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory)
				: base(ModelInfoProviderSingleton.GetInstance(), PersistenceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), typeOfInheritance, entityName, entityFactory)
		{
		}
