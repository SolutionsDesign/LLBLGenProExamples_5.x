...
namespace Northwind.DAL.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, Northwind.DAL.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		static EntityFactoryFactory()
		{
			...
			{
				IEntity2 dummy = GeneralEntityFactory.Create((Northwind.DAL.EntityType)entityTypeValue);
