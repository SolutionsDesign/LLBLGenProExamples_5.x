...
namespace Northwind.DAL.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		public DataSource2<AuditActionTypeEntity> AuditActionType {	get { return new DataSource2<AuditActionTypeEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		
		/// <summary>returns the datasource to use in a Linq query when targeting AuditInfoEntity instances in the database.</summary>
		public DataSource2<AuditInfoEntity> AuditInfo {	get { return new DataSource2<AuditInfoEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		...
		public DataSource2<CustomerCustomerDemoEntity> CustomerCustomerDemo {	get { return new DataSource2<CustomerCustomerDemoEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		...
		public DataSource2<CustomerDemographicEntity> CustomerDemographic {	get { return new DataSource2<CustomerDemographicEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		...
		public DataSource2<EmployeeTerritoryEntity> EmployeeTerritory {	get { return new DataSource2<EmployeeTerritoryEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		
		/// <summary>returns the datasource to use in a Linq query when targeting GroupEntity instances in the database.</summary>
		public DataSource2<GroupEntity> Group {	get { return new DataSource2<GroupEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		...
		public DataSource2<OrderAuditInfoEntity> OrderAuditInfo {	get { return new DataSource2<OrderAuditInfoEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		...
		public DataSource2<UserGroupEntity> UserGroup {	get { return new DataSource2<UserGroupEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
