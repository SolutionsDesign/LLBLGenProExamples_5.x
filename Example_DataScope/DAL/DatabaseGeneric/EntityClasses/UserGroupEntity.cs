...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class UserGroupEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("UserGroupEntity", InheritanceHierarchyType.None, false, (int)Northwind.DAL.EntityType.UserGroupEntity, typeof(UserGroupEntity), typeof(UserGroupEntityFactory), false);
				AddNavigatorMetaData<UserGroupEntity, GroupEntity>("Group", "UserGroups", (a, b) => a._group = b, a => a._group, (a, b) => a.Group = b, Northwind.DAL.RelationClasses.StaticUserGroupRelations.GroupEntityUsingGroupIdStatic, ()=>new UserGroupRelations().GroupEntityUsingGroupId, null, new int[] { (int)UserGroupFieldIndex.GroupId }, null, true, (int)Northwind.DAL.EntityType.GroupEntity);
				AddNavigatorMetaData<UserGroupEntity, UserEntity>("User", "UserGroups", (a, b) => a._user = b, a => a._user, (a, b) => a.User = b, Northwind.DAL.RelationClasses.StaticUserGroupRelations.UserEntityUsingUserIdStatic, ()=>new UserGroupRelations().UserEntityUsingUserId, null, new int[] { (int)UserGroupFieldIndex.UserId }, null, true, (int)Northwind.DAL.EntityType.UserEntity);
			}
		}
