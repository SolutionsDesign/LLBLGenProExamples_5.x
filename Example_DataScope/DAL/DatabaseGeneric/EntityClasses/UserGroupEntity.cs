...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _group, new PropertyChangedEventHandler( OnGroupPropertyChanged ), "Group", Northwind.DAL.RelationClasses.StaticUserGroupRelations.GroupEntityUsingGroupIdStatic, true, signalRelatedEntity, "UserGroups", resetFKFields, new int[] { (int)UserGroupFieldIndex.GroupId } );
			_group = null;
		}
		...
		private void SetupSyncGroup(IEntityCore relatedEntity)
		{
			if(_group!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _group, new PropertyChangedEventHandler( OnGroupPropertyChanged ), "Group", Northwind.DAL.RelationClasses.StaticUserGroupRelations.GroupEntityUsingGroupIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", Northwind.DAL.RelationClasses.StaticUserGroupRelations.UserEntityUsingUserIdStatic, true, signalRelatedEntity, "UserGroups", resetFKFields, new int[] { (int)UserGroupFieldIndex.UserId } );
			_user = null;
		}
		...
		private void SetupSyncUser(IEntityCore relatedEntity)
		{
			if(_user!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", Northwind.DAL.RelationClasses.StaticUserGroupRelations.UserEntityUsingUserIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(GroupEntityFactory))),	(IEntityRelation)GetRelationsForField("Group")[0], (int)Northwind.DAL.EntityType.UserGroupEntity, (int)Northwind.DAL.EntityType.GroupEntity, 0, null, null, null, null, "Group", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("User")[0], (int)Northwind.DAL.EntityType.UserGroupEntity, (int)Northwind.DAL.EntityType.UserEntity, 0, null, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)Northwind.DAL.EntityType.UserGroupEntity; }
		}
