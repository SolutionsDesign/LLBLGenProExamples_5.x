...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<AuditInfoEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AuditInfoEntityFactory))), (IEntityRelation)GetRelationsForField("AuditInfos")[0], (int)Northwind.DAL.EntityType.AuditActionTypeEntity, (int)Northwind.DAL.EntityType.AuditInfoEntity, 0, null, null, null, null, "AuditInfos", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<AuditInfoEntity, AuditInfoEntityFactory>("AuditActionType", true, false, ref _auditInfos);	}
		}
		...
		{ 
			get { return (int)Northwind.DAL.EntityType.AuditActionTypeEntity; }
		}
