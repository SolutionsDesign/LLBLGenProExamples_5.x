...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class ShipperEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("ShipperEntity", InheritanceHierarchyType.None, false, (int)Northwind.DAL.EntityType.ShipperEntity, typeof(ShipperEntity), typeof(ShipperEntityFactory), false);
				AddNavigatorMetaData<ShipperEntity, EntityCollection<OrderEntity>>("Orders", a => a._orders, (a, b) => a._orders = b, a => a.Orders, () => new ShipperRelations().OrderEntityUsingShipVia, typeof(OrderEntity), (int)Northwind.DAL.EntityType.OrderEntity);
			}
		}
