...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<UserGroupEntity>(EntityFactoryCache2.GetEntityFactory(typeof(UserGroupEntityFactory))), (IEntityRelation)GetRelationsForField("UserGroups")[0], (int)Northwind.DAL.EntityType.GroupEntity, (int)Northwind.DAL.EntityType.UserGroupEntity, 0, null, null, null, null, "UserGroups", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<UserGroupEntity, UserGroupEntityFactory>("Group", true, false, ref _userGroups);	}
		}
		...
		{ 
			get { return (int)Northwind.DAL.EntityType.GroupEntity; }
		}
