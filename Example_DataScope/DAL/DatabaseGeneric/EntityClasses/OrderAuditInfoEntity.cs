...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class OrderAuditInfoEntityStaticMetaData : AuditInfoEntityStaticMetaData
		{
			...
			{
				SetEntityCoreInfo("OrderAuditInfoEntity", InheritanceHierarchyType.TargetPerEntity, true, (int)Northwind.DAL.EntityType.OrderAuditInfoEntity, typeof(OrderAuditInfoEntity), typeof(OrderAuditInfoEntityFactory), false);
				AddNavigatorMetaData<OrderAuditInfoEntity, OrderEntity>("Order", "OrderAuditInfos", (a, b) => a._order = b, a => a._order, (a, b) => a.Order = b, Northwind.DAL.RelationClasses.StaticOrderAuditInfoRelations.OrderEntityUsingOrderIdStatic, ()=>new OrderAuditInfoRelations().OrderEntityUsingOrderId, null, new int[] { (int)OrderAuditInfoFieldIndex.OrderId }, null, true, (int)Northwind.DAL.EntityType.OrderEntity);
			}
		}
