...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class AuditInfoEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("AuditInfoEntity", InheritanceHierarchyType.TargetPerEntity, false, (int)Northwind.DAL.EntityType.AuditInfoEntity, typeof(AuditInfoEntity), typeof(AuditInfoEntityFactory), false);
				AddNavigatorMetaData<AuditInfoEntity, AuditActionTypeEntity>("AuditActionType", "AuditInfos", (a, b) => a._auditActionType = b, a => a._auditActionType, (a, b) => a.AuditActionType = b, Northwind.DAL.RelationClasses.StaticAuditInfoRelations.AuditActionTypeEntityUsingAuditActionTypeIdStatic, ()=>new AuditInfoRelations().AuditActionTypeEntityUsingAuditActionTypeId, null, new int[] { (int)AuditInfoFieldIndex.AuditActionTypeId }, null, true, (int)Northwind.DAL.EntityType.AuditActionTypeEntity);
				AddNavigatorMetaData<AuditInfoEntity, UserEntity>("User", "AuditInfos", (a, b) => a._user = b, a => a._user, (a, b) => a.User = b, Northwind.DAL.RelationClasses.StaticAuditInfoRelations.UserEntityUsingUserIdStatic, ()=>new AuditInfoRelations().UserEntityUsingUserId, null, new int[] { (int)AuditInfoFieldIndex.UserId }, null, true, (int)Northwind.DAL.EntityType.UserEntity);
			}
		}
