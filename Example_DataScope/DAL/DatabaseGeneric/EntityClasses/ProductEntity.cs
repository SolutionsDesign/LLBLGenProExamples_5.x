...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _category, new PropertyChangedEventHandler( OnCategoryPropertyChanged ), "Category", Northwind.DAL.RelationClasses.StaticProductRelations.CategoryEntityUsingCategoryIdStatic, true, signalRelatedEntity, "Products", resetFKFields, new int[] { (int)ProductFieldIndex.CategoryId } );
			_category = null;
		}
		...
		private void SetupSyncCategory(IEntityCore relatedEntity)
		{
			if(_category!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _category, new PropertyChangedEventHandler( OnCategoryPropertyChanged ), "Category", Northwind.DAL.RelationClasses.StaticProductRelations.CategoryEntityUsingCategoryIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _supplier, new PropertyChangedEventHandler( OnSupplierPropertyChanged ), "Supplier", Northwind.DAL.RelationClasses.StaticProductRelations.SupplierEntityUsingSupplierIdStatic, true, signalRelatedEntity, "Products", resetFKFields, new int[] { (int)ProductFieldIndex.SupplierId } );
			_supplier = null;
		}
		...
		private void SetupSyncSupplier(IEntityCore relatedEntity)
		{
			if(_supplier!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _supplier, new PropertyChangedEventHandler( OnSupplierPropertyChanged ), "Supplier", Northwind.DAL.RelationClasses.StaticProductRelations.SupplierEntityUsingSupplierIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CategoryEntityFactory))),	(IEntityRelation)GetRelationsForField("Category")[0], (int)Northwind.DAL.EntityType.ProductEntity, (int)Northwind.DAL.EntityType.CategoryEntity, 0, null, null, null, null, "Category", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SupplierEntityFactory))),	(IEntityRelation)GetRelationsForField("Supplier")[0], (int)Northwind.DAL.EntityType.ProductEntity, (int)Northwind.DAL.EntityType.SupplierEntity, 0, null, null, null, null, "Supplier", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)Northwind.DAL.EntityType.ProductEntity; }
		}
