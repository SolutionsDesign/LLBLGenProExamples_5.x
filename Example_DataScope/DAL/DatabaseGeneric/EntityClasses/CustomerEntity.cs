...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class CustomerEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("CustomerEntity", InheritanceHierarchyType.None, false, (int)Northwind.DAL.EntityType.CustomerEntity, typeof(CustomerEntity), typeof(CustomerEntityFactory), false);
				AddNavigatorMetaData<CustomerEntity, EntityCollection<CustomerCustomerDemoEntity>>("CustomerCustomerDemos", a => a._customerCustomerDemos, (a, b) => a._customerCustomerDemos = b, a => a.CustomerCustomerDemos, () => new CustomerRelations().CustomerCustomerDemoEntityUsingCustomerId, typeof(CustomerCustomerDemoEntity), (int)Northwind.DAL.EntityType.CustomerCustomerDemoEntity);
				AddNavigatorMetaData<CustomerEntity, EntityCollection<OrderEntity>>("Orders", a => a._orders, (a, b) => a._orders = b, a => a.Orders, () => new CustomerRelations().OrderEntityUsingCustomerId, typeof(OrderEntity), (int)Northwind.DAL.EntityType.OrderEntity);
			}
		}
		...
		public virtual EntityCollection<CustomerCustomerDemoEntity> CustomerCustomerDemos { get { return GetOrCreateEntityCollection<CustomerCustomerDemoEntity, CustomerCustomerDemoEntityFactory>("Customer", true, false, ref _customerCustomerDemos); } }
