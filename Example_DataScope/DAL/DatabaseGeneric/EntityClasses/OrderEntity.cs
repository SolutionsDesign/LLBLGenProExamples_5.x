...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected OrderEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			{
				_orderAuditInfos = (EntityCollection<OrderAuditInfoEntity>)info.GetValue("_orderAuditInfos", typeof(EntityCollection<OrderAuditInfoEntity>));
		...
		protected override void SetRelatedEntity(IEntityCore relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				...
				case "Shipper":
					...
					break;
				case "OrderAuditInfos":
					this.OrderAuditInfos.Add((OrderAuditInfoEntity)relatedEntity);
					break;
				case "OrderDetails":
		...
		protected override void UnsetRelatedEntity(IEntityCore relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			switch(fieldName)
			{
				...
				case "Shipper":
					...
					break;
				case "OrderAuditInfos":
					this.PerformRelatedEntityRemoval(this.OrderAuditInfos, relatedEntity, signalRelatedEntityManyToOne);
					break;
				case "OrderDetails":
		...
		protected override List<IEntityCollection2> GetMemberEntityCollections()
		{
			...
			toReturn.Add(this.OrderAuditInfos);
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				info.AddValue("_orderAuditInfos", ((_orderAuditInfos!=null) && (_orderAuditInfos.Count>0) && !this.MarkedForDeletion)?_orderAuditInfos:null);
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoOrderAuditInfos()
		{
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._orderAuditInfos);
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._orderAuditInfos = (EntityCollection<OrderAuditInfoEntity>) collectionsQueue.Dequeue();
		...
		{
			bool toReturn = false;
			toReturn |=(this._orderAuditInfos != null);
		...
		{
			this.PerformDesetupSyncRelatedEntity( _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", Northwind.DAL.RelationClasses.StaticOrderRelations.CustomerEntityUsingCustomerIdStatic, true, signalRelatedEntity, "Orders", resetFKFields, new int[] { (int)OrderFieldIndex.CustomerId } );
			_customer = null;
		}
		...
		private void SetupSyncCustomer(IEntityCore relatedEntity)
		{
			if(_customer!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", Northwind.DAL.RelationClasses.StaticOrderRelations.CustomerEntityUsingCustomerIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", Northwind.DAL.RelationClasses.StaticOrderRelations.EmployeeEntityUsingEmployeeIdStatic, true, signalRelatedEntity, "Orders", resetFKFields, new int[] { (int)OrderFieldIndex.EmployeeId } );
			_employee = null;
		}
		...
		private void SetupSyncEmployee(IEntityCore relatedEntity)
		{
			if(_employee!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", Northwind.DAL.RelationClasses.StaticOrderRelations.EmployeeEntityUsingEmployeeIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _shipper, new PropertyChangedEventHandler( OnShipperPropertyChanged ), "Shipper", Northwind.DAL.RelationClasses.StaticOrderRelations.ShipperEntityUsingShipViaStatic, true, signalRelatedEntity, "Orders", resetFKFields, new int[] { (int)OrderFieldIndex.ShipVia } );
			_shipper = null;
		}
		...
		private void SetupSyncShipper(IEntityCore relatedEntity)
		{
			if(_shipper!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _shipper, new PropertyChangedEventHandler( OnShipperPropertyChanged ), "Shipper", Northwind.DAL.RelationClasses.StaticOrderRelations.ShipperEntityUsingShipViaStatic, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrderAuditInfos
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<OrderAuditInfoEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrderAuditInfoEntityFactory))), (IEntityRelation)GetRelationsForField("OrderAuditInfos")[0], (int)Northwind.DAL.EntityType.OrderEntity, (int)Northwind.DAL.EntityType.OrderAuditInfoEntity, 0, null, null, null, null, "OrderAuditInfos", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))),	(IEntityRelation)GetRelationsForField("Customer")[0], (int)Northwind.DAL.EntityType.OrderEntity, (int)Northwind.DAL.EntityType.CustomerEntity, 0, null, null, null, null, "Customer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))),	(IEntityRelation)GetRelationsForField("Employee")[0], (int)Northwind.DAL.EntityType.OrderEntity, (int)Northwind.DAL.EntityType.EmployeeEntity, 0, null, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShipperEntityFactory))),	(IEntityRelation)GetRelationsForField("Shipper")[0], (int)Northwind.DAL.EntityType.OrderEntity, (int)Northwind.DAL.EntityType.ShipperEntity, 0, null, null, null, null, "Shipper", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual EntityCollection<OrderAuditInfoEntity> OrderAuditInfos
		{
			get { return GetOrCreateEntityCollection<OrderAuditInfoEntity, OrderAuditInfoEntityFactory>("Order", true, false, ref _orderAuditInfos);	}
		}
		...
		{ 
			get { return (int)Northwind.DAL.EntityType.OrderEntity; }
		}
