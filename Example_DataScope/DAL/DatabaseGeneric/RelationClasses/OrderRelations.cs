...
namespace Northwind.DAL.RelationClasses
{
	...
	public partial class OrderRelations
	{
		...
		public virtual List<IEntityRelation> GetAllRelations()
		{
			...
			toReturn.Add(this.OrderAuditInfoEntityUsingOrderId);
		...
		/// <summary>Returns a new IEntityRelation object, between OrderEntity and OrderAuditInfoEntity over the 1:n relation they have, using the relation between the fields:
		/// Order.OrderId - OrderAuditInfo.OrderId
		/// </summary>
		public virtual IEntityRelation OrderAuditInfoEntityUsingOrderId
		{
			get
			{
				IEntityRelation relation = new EntityRelation(SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany, "OrderAuditInfos" , true);
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("OrderAuditInfoEntity", false);
				return relation;
			}
		}
