...
namespace SD.LLBLGen.Pro.Examples.HelperClasses
{
	...
	public partial class Transaction : TransactionBase
	{
		...
		protected override DbConnection CreateConnection() { return new CommonDaoBase().CreateConnection();	}
		...
		/// <returns>new DbConnection instance</returns>
		protected override DbConnection CreateConnection(string connectionStringToUse) { return new CommonDaoBase().CreateConnection(connectionStringToUse); }
