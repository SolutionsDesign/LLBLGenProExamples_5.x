...
namespace SD.LLBLGen.Pro.Examples.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'Supplier'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private SD.LLBLGen.Pro.Examples.CollectionClasses.ProductCollection	_products;
		private bool	_alwaysFetchProducts, _alreadyFetchedProducts;
		private SD.LLBLGen.Pro.Examples.CollectionClasses.CategoryCollection _categoriesCollectionViaProducts;
		private bool	_alwaysFetchCategoriesCollectionViaProducts, _alreadyFetchedCategoriesCollectionViaProducts;
		...
		public SupplierEntity(System.Int32 supplierId, IPrefetchPath prefetchPathToUse):base("SupplierEntity")
		{
		...
		protected SupplierEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			_categoriesCollectionViaProducts = (SD.LLBLGen.Pro.Examples.CollectionClasses.CategoryCollection)info.GetValue("_categoriesCollectionViaProducts", typeof(SD.LLBLGen.Pro.Examples.CollectionClasses.CategoryCollection));
			_alwaysFetchCategoriesCollectionViaProducts = info.GetBoolean("_alwaysFetchCategoriesCollectionViaProducts");
			_alreadyFetchedCategoriesCollectionViaProducts = info.GetBoolean("_alreadyFetchedCategoriesCollectionViaProducts");
		...
		protected override void PerformPostReadXmlFixups()
		{
			...
			_alreadyFetchedCategoriesCollectionViaProducts = (_categoriesCollectionViaProducts.Count > 0);
		}
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				case "Products":
					...
					break;
				case "CategoriesCollectionViaProducts":
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue("_categoriesCollectionViaProducts", (!this.MarkedForDeletion?_categoriesCollectionViaProducts:null));
			info.AddValue("_alwaysFetchCategoriesCollectionViaProducts", _alwaysFetchCategoriesCollectionViaProducts);
			info.AddValue("_alreadyFetchedCategoriesCollectionViaProducts", _alreadyFetchedCategoriesCollectionViaProducts);
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				case "Products":
					...
					break;
				case "CategoriesCollectionViaProducts":
					_alreadyFetchedCategoriesCollectionViaProducts = true;
					if(entity!=null)
					{
						this.CategoriesCollectionViaProducts.Add((CategoryEntity)entity);
					}
					break;
				default:
		...
		public SD.LLBLGen.Pro.Examples.CollectionClasses.ProductCollection GetMultiProducts(bool forceFetch)
		{
		...
		/// <returns>Filled collection with all related entities of type 'ProductEntity'</returns>
		public SD.LLBLGen.Pro.Examples.CollectionClasses.ProductCollection GetMultiProducts(bool forceFetch, IPredicateExpression filter)
		{
		...
		public SD.LLBLGen.Pro.Examples.CollectionClasses.ProductCollection GetMultiProducts(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
		...
		/// <param name="filter">Extra filter to limit the resultset.</param>
		/// <returns>Filled collection with all related entities of the type constructed by the passed in entity factory</returns>
		public virtual SD.LLBLGen.Pro.Examples.CollectionClasses.ProductCollection GetMultiProducts(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
		...
		public SD.LLBLGen.Pro.Examples.CollectionClasses.CategoryCollection GetMultiCategoriesCollectionViaProducts(bool forceFetch)
		{
		...
		/// <returns>Filled collection with all related entities of the type constructed by the passed in entity factory</returns>
		public SD.LLBLGen.Pro.Examples.CollectionClasses.CategoryCollection GetMultiCategoriesCollectionViaProducts(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
 			if( ( !_alreadyFetchedCategoriesCollectionViaProducts || forceFetch || _alwaysFetchCategoriesCollectionViaProducts) && !this.IsSerializing && !this.IsDeserializing && !this.InDesignMode)
			{
				AddToTransactionIfNecessary(_categoriesCollectionViaProducts);
				...
				_categoriesCollectionViaProducts.SuppressClearInGetMulti=!forceFetch;
				_categoriesCollectionViaProducts.EntityFactoryToUse = entityFactoryToUse;
				_categoriesCollectionViaProducts.GetMulti(filter, GetRelationsForField("CategoriesCollectionViaProducts"));
				_categoriesCollectionViaProducts.SuppressClearInGetMulti=false;
				_alreadyFetchedCategoriesCollectionViaProducts = true;
			}
			return _categoriesCollectionViaProducts;
		}
		...
		protected override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("CategoriesCollectionViaProducts", _categoriesCollectionViaProducts);
			return toReturn;
		}
		...
		{
			get { return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.CollectionClasses.ProductCollection(), (IEntityRelation)GetRelationsForField("Products")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.SupplierEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.ProductEntity, 0, null, null, null, "Products", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathCategoriesCollectionViaProducts
		{
			get
			{
				...
				return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.CollectionClasses.CategoryCollection(), intermediateRelation,	(int)SD.LLBLGen.Pro.Examples.EntityType.SupplierEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.CategoryEntity, 0, null, null, GetRelationsForField("CategoriesCollectionViaProducts"), "CategoriesCollectionViaProducts", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public virtual SD.LLBLGen.Pro.Examples.CollectionClasses.ProductCollection Products
		{
		...
		/// </summary>
		/// <remarks>This property is added for databinding conveniance, however it is recommeded to use the method 'GetMultiCategoriesCollectionViaProducts()', because 
		/// this property is rather expensive and a method tells the user to cache the result when it has to be used more than once in the same scope.</remarks>
		public virtual SD.LLBLGen.Pro.Examples.CollectionClasses.CategoryCollection CategoriesCollectionViaProducts
		{
			get { return GetMultiCategoriesCollectionViaProducts(false); }
		}
		...
		{
			get	{ return _alwaysFetchCategoriesCollectionViaProducts; }
			set	{ _alwaysFetchCategoriesCollectionViaProducts = value; }
		}
		...
		{
			get { return _alreadyFetchedCategoriesCollectionViaProducts;}
			set 
			{
				if(_alreadyFetchedCategoriesCollectionViaProducts && !value && (_categoriesCollectionViaProducts != null))
				{
					_categoriesCollectionViaProducts.Clear();
				}
				_alreadyFetchedCategoriesCollectionViaProducts = value;
			}
		}
		...
		{ 
			get { return (int)SD.LLBLGen.Pro.Examples.EntityType.SupplierEntity; }
		}
