...
namespace SD.LLBLGen.Pro.Examples.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private bool	_alwaysFetchCustomerCollectionViaOrders, _alreadyFetchedCustomerCollectionViaOrders;
		private SD.LLBLGen.Pro.Examples.CollectionClasses.EmployeeCollection _employeeCollectionViaOrders;
		private bool	_alwaysFetchEmployeeCollectionViaOrders, _alreadyFetchedEmployeeCollectionViaOrders;
		...
		protected override void PerformPostReadXmlFixups()
		{
			...
			_alreadyFetchedCustomerCollectionViaOrders = (_customerCollectionViaOrders.Count > 0);
			_alreadyFetchedEmployeeCollectionViaOrders = (_employeeCollectionViaOrders.Count > 0);
		}
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				case "Orders":
					...
					break;
				case "CustomerCollectionViaOrders":
					...
					break;
				case "EmployeeCollectionViaOrders":
					toReturn.Add(Relations.OrderEntityUsingShipVia, "ShipperEntity__", "Order_", JoinHint.None);
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue("_customerCollectionViaOrders", (!this.MarkedForDeletion?_customerCollectionViaOrders:null));
			info.AddValue("_alwaysFetchCustomerCollectionViaOrders", _alwaysFetchCustomerCollectionViaOrders);
			info.AddValue("_alreadyFetchedCustomerCollectionViaOrders", _alreadyFetchedCustomerCollectionViaOrders);
			info.AddValue("_employeeCollectionViaOrders", (!this.MarkedForDeletion?_employeeCollectionViaOrders:null));
			info.AddValue("_alwaysFetchEmployeeCollectionViaOrders", _alwaysFetchEmployeeCollectionViaOrders);
			info.AddValue("_alreadyFetchedEmployeeCollectionViaOrders", _alreadyFetchedEmployeeCollectionViaOrders);
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				case "Orders":
					...
					break;
				case "CustomerCollectionViaOrders":
					_alreadyFetchedCustomerCollectionViaOrders = true;
					if(entity!=null)
					{
						this.CustomerCollectionViaOrders.Add((CustomerEntity)entity);
					}
					break;
				case "EmployeeCollectionViaOrders":
					_alreadyFetchedEmployeeCollectionViaOrders = true;
					if(entity!=null)
					{
						this.EmployeeCollectionViaOrders.Add((EmployeeEntity)entity);
					}
					break;
				default:
		...
		{
 			if( ( !_alreadyFetchedCustomerCollectionViaOrders || forceFetch || _alwaysFetchCustomerCollectionViaOrders) && !this.IsSerializing && !this.IsDeserializing && !this.InDesignMode)
			{
				AddToTransactionIfNecessary(_customerCollectionViaOrders);
				...
				_customerCollectionViaOrders.SuppressClearInGetMulti=!forceFetch;
				_customerCollectionViaOrders.EntityFactoryToUse = entityFactoryToUse;
				_customerCollectionViaOrders.GetMulti(filter, GetRelationsForField("CustomerCollectionViaOrders"));
				_customerCollectionViaOrders.SuppressClearInGetMulti=false;
				_alreadyFetchedCustomerCollectionViaOrders = true;
			}
			return _customerCollectionViaOrders;
		}
		...
		{
 			if( ( !_alreadyFetchedEmployeeCollectionViaOrders || forceFetch || _alwaysFetchEmployeeCollectionViaOrders) && !this.IsSerializing && !this.IsDeserializing && !this.InDesignMode)
			{
				AddToTransactionIfNecessary(_employeeCollectionViaOrders);
				IPredicateExpression filter = new PredicateExpression();
				filter.Add(new FieldCompareValuePredicate(ShipperFields.ShipperId, ComparisonOperator.Equal, this.ShipperId, "ShipperEntity__"));
				_employeeCollectionViaOrders.SuppressClearInGetMulti=!forceFetch;
				_employeeCollectionViaOrders.EntityFactoryToUse = entityFactoryToUse;
				_employeeCollectionViaOrders.GetMulti(filter, GetRelationsForField("EmployeeCollectionViaOrders"));
				_employeeCollectionViaOrders.SuppressClearInGetMulti=false;
				_alreadyFetchedEmployeeCollectionViaOrders = true;
			}
			return _employeeCollectionViaOrders;
		}
		...
		protected override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("CustomerCollectionViaOrders", _customerCollectionViaOrders);
			toReturn.Add("EmployeeCollectionViaOrders", _employeeCollectionViaOrders);
			return toReturn;
		}
		...
		{
			get { return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.CollectionClasses.OrderCollection(), (IEntityRelation)GetRelationsForField("Orders")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.ShipperEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.OrderEntity, 0, null, null, null, "Orders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathCustomerCollectionViaOrders
		{
			get
			{
				...
				return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.CollectionClasses.CustomerCollection(), intermediateRelation,	(int)SD.LLBLGen.Pro.Examples.EntityType.ShipperEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.CustomerEntity, 0, null, null, GetRelationsForField("CustomerCollectionViaOrders"), "CustomerCollectionViaOrders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathEmployeeCollectionViaOrders
		{
			get
			{
				IEntityRelation intermediateRelation = Relations.OrderEntityUsingShipVia;
				intermediateRelation.SetAliases(string.Empty, "Order_");
				return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.CollectionClasses.EmployeeCollection(), intermediateRelation,	(int)SD.LLBLGen.Pro.Examples.EntityType.ShipperEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeEntity, 0, null, null, GetRelationsForField("EmployeeCollectionViaOrders"), "EmployeeCollectionViaOrders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		/// </summary>
		/// <remarks>This property is added for databinding conveniance, however it is recommeded to use the method 'GetMultiCustomerCollectionViaOrders()', because 
		/// this property is rather expensive and a method tells the user to cache the result when it has to be used more than once in the same scope.</remarks>
		public virtual SD.LLBLGen.Pro.Examples.CollectionClasses.CustomerCollection CustomerCollectionViaOrders
		{
			get { return GetMultiCustomerCollectionViaOrders(false); }
		}
		...
		{
			get	{ return _alwaysFetchCustomerCollectionViaOrders; }
			set	{ _alwaysFetchCustomerCollectionViaOrders = value; }
		}
		...
		{
			get { return _alreadyFetchedCustomerCollectionViaOrders;}
			set 
			{
				if(_alreadyFetchedCustomerCollectionViaOrders && !value && (_customerCollectionViaOrders != null))
				{
					_customerCollectionViaOrders.Clear();
				}
				_alreadyFetchedCustomerCollectionViaOrders = value;
			}
		}

		/// <summary> Retrieves all related entities of type 'EmployeeEntity' using a relation of type 'm:n'.<br/><br/>
		/// </summary>
		/// <remarks>This property is added for databinding conveniance, however it is recommeded to use the method 'GetMultiEmployeeCollectionViaOrders()', because 
		/// this property is rather expensive and a method tells the user to cache the result when it has to be used more than once in the same scope.</remarks>
		public virtual SD.LLBLGen.Pro.Examples.CollectionClasses.EmployeeCollection EmployeeCollectionViaOrders
		{
			get { return GetMultiEmployeeCollectionViaOrders(false); }
		}
		...
		{
			get	{ return _alwaysFetchEmployeeCollectionViaOrders; }
			set	{ _alwaysFetchEmployeeCollectionViaOrders = value; }
		}
		...
		{
			get { return _alreadyFetchedEmployeeCollectionViaOrders;}
			set 
			{
				if(_alreadyFetchedEmployeeCollectionViaOrders && !value && (_employeeCollectionViaOrders != null))
				{
					_employeeCollectionViaOrders.Clear();
				}
				_alreadyFetchedEmployeeCollectionViaOrders = value;
			}
		}
		...
		{ 
			get { return (int)SD.LLBLGen.Pro.Examples.EntityType.ShipperEntity; }
		}
