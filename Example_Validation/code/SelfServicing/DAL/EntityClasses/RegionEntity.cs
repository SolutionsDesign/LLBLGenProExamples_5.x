...
namespace SD.LLBLGen.Pro.Examples.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class RegionEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("RegionEntity", InheritanceHierarchyType.None, false, (int)SD.LLBLGen.Pro.Examples.EntityType.RegionEntity, typeof(RegionEntity), typeof(RegionEntityFactory), false);
				AddNavigatorMetaData<RegionEntity, SD.LLBLGen.Pro.Examples.CollectionClasses.TerritoryCollection>("Territories", a => a._territories, (a, b) => a._territories = b, a => a.Territories, () => new RegionRelations().TerritoryEntityUsingRegionId, typeof(TerritoryEntity), (int)SD.LLBLGen.Pro.Examples.EntityType.TerritoryEntity);
			}
		}
		...
		{
			return PerformMultiEntityLazyLoading<SD.LLBLGen.Pro.Examples.CollectionClasses.TerritoryCollection>("Territories", forceFetch, entityFactoryToUse, (c,r)=>c.GetMultiManyToOne(this, filter));
		}
		...
		public static IPrefetchPathElement PrefetchPathTerritories { get { return _staticMetaData.GetPrefetchPathElement("Territories", new SD.LLBLGen.Pro.Examples.CollectionClasses.TerritoryCollection()); } }
		...
		public virtual SD.LLBLGen.Pro.Examples.CollectionClasses.TerritoryCollection Territories { get { return GetMultiTerritories(false); } }
