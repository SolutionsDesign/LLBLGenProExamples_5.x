...
namespace SD.LLBLGen.Pro.Examples.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private bool	_alwaysFetchProductCollectionViaOrderDetails, _alreadyFetchedProductCollectionViaOrderDetails;
		...
		protected OrderEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			_productCollectionViaOrderDetails = (SD.LLBLGen.Pro.Examples.CollectionClasses.ProductCollection)info.GetValue("_productCollectionViaOrderDetails", typeof(SD.LLBLGen.Pro.Examples.CollectionClasses.ProductCollection));
			_alwaysFetchProductCollectionViaOrderDetails = info.GetBoolean("_alwaysFetchProductCollectionViaOrderDetails");
			_alreadyFetchedProductCollectionViaOrderDetails = info.GetBoolean("_alreadyFetchedProductCollectionViaOrderDetails");
		...
		protected override void PerformPostReadXmlFixups()
		{
			...
			_alreadyFetchedProductCollectionViaOrderDetails = (_productCollectionViaOrderDetails.Count > 0);
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "OrderDetails":
					...
					break;
				case "ProductCollectionViaOrderDetails":
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue("_productCollectionViaOrderDetails", (!this.MarkedForDeletion?_productCollectionViaOrderDetails:null));
			info.AddValue("_alwaysFetchProductCollectionViaOrderDetails", _alwaysFetchProductCollectionViaOrderDetails);
			info.AddValue("_alreadyFetchedProductCollectionViaOrderDetails", _alreadyFetchedProductCollectionViaOrderDetails);
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "OrderDetails":
					...
					break;
				case "ProductCollectionViaOrderDetails":
					_alreadyFetchedProductCollectionViaOrderDetails = true;
					if(entity!=null)
					{
						this.ProductCollectionViaOrderDetails.Add((ProductEntity)entity);
					}
					break;
				default:
		...
		{
 			if( ( !_alreadyFetchedProductCollectionViaOrderDetails || forceFetch || _alwaysFetchProductCollectionViaOrderDetails) && !this.IsSerializing && !this.IsDeserializing && !this.InDesignMode)
			{
				AddToTransactionIfNecessary(_productCollectionViaOrderDetails);
				...
				_productCollectionViaOrderDetails.SuppressClearInGetMulti=!forceFetch;
				_productCollectionViaOrderDetails.EntityFactoryToUse = entityFactoryToUse;
				_productCollectionViaOrderDetails.GetMulti(filter, GetRelationsForField("ProductCollectionViaOrderDetails"));
				_productCollectionViaOrderDetails.SuppressClearInGetMulti=false;
				_alreadyFetchedProductCollectionViaOrderDetails = true;
			}
			return _productCollectionViaOrderDetails;
		}
		...
		protected override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("ProductCollectionViaOrderDetails", _productCollectionViaOrderDetails);
			return toReturn;
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", SD.LLBLGen.Pro.Examples.RelationClasses.StaticOrderRelations.CustomerEntityUsingCustomerIdStatic, true, signalRelatedEntity, "Orders", resetFKFields, new int[] { (int)OrderFieldIndex.CustomerId } );		
			_customer = null;
		}
		...
		private void SetupSyncCustomer(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", SD.LLBLGen.Pro.Examples.RelationClasses.StaticOrderRelations.CustomerEntityUsingCustomerIdStatic, true, ref _alreadyFetchedCustomer, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", SD.LLBLGen.Pro.Examples.RelationClasses.StaticOrderRelations.EmployeeEntityUsingEmployeeIdStatic, true, signalRelatedEntity, "Orders", resetFKFields, new int[] { (int)OrderFieldIndex.EmployeeId } );		
			_employee = null;
		}
		...
		private void SetupSyncEmployee(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", SD.LLBLGen.Pro.Examples.RelationClasses.StaticOrderRelations.EmployeeEntityUsingEmployeeIdStatic, true, ref _alreadyFetchedEmployee, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _shipper, new PropertyChangedEventHandler( OnShipperPropertyChanged ), "Shipper", SD.LLBLGen.Pro.Examples.RelationClasses.StaticOrderRelations.ShipperEntityUsingShipViaStatic, true, signalRelatedEntity, "Orders", resetFKFields, new int[] { (int)OrderFieldIndex.ShipVia } );		
			_shipper = null;
		}
		...
		private void SetupSyncShipper(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _shipper, new PropertyChangedEventHandler( OnShipperPropertyChanged ), "Shipper", SD.LLBLGen.Pro.Examples.RelationClasses.StaticOrderRelations.ShipperEntityUsingShipViaStatic, true, ref _alreadyFetchedShipper, new string[] {  } );
			}
		}
		...
		{
			get { return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.CollectionClasses.OrderDetailCollection(), (IEntityRelation)GetRelationsForField("OrderDetails")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.OrderEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.OrderDetailEntity, 0, null, null, null, "OrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}

		/// <summary> Creates a new PrefetchPathElement object which contains all the information to prefetch the related entities of type 'Product'  for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathProductCollectionViaOrderDetails
		{
			get
			{
				...
				return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.CollectionClasses.ProductCollection(), intermediateRelation,	(int)SD.LLBLGen.Pro.Examples.EntityType.OrderEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.ProductEntity, 0, null, null, GetRelationsForField("ProductCollectionViaOrderDetails"), "ProductCollectionViaOrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get	{ return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.CollectionClasses.CustomerCollection(), (IEntityRelation)GetRelationsForField("Customer")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.OrderEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.CustomerEntity, 0, null, null, null, "Customer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.CollectionClasses.EmployeeCollection(), (IEntityRelation)GetRelationsForField("Employee")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.OrderEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeEntity, 0, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.CollectionClasses.ShipperCollection(), (IEntityRelation)GetRelationsForField("Shipper")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.OrderEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.ShipperEntity, 0, null, null, null, "Shipper", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// </summary>
		/// <remarks>This property is added for databinding conveniance, however it is recommeded to use the method 'GetMultiProductCollectionViaOrderDetails()', because 
		/// this property is rather expensive and a method tells the user to cache the result when it has to be used more than once in the same scope.</remarks>
		public virtual SD.LLBLGen.Pro.Examples.CollectionClasses.ProductCollection ProductCollectionViaOrderDetails
		{
			get { return GetMultiProductCollectionViaOrderDetails(false); }
		}
		...
		{
			get	{ return _alwaysFetchProductCollectionViaOrderDetails; }
			set	{ _alwaysFetchProductCollectionViaOrderDetails = value; }
		}
		...
		{
			get { return _alreadyFetchedProductCollectionViaOrderDetails;}
			set 
			{
				if(_alreadyFetchedProductCollectionViaOrderDetails && !value && (_productCollectionViaOrderDetails != null))
				{
					_productCollectionViaOrderDetails.Clear();
				}
				_alreadyFetchedProductCollectionViaOrderDetails = value;
			}
		}
		...
		{ 
			get { return (int)SD.LLBLGen.Pro.Examples.EntityType.OrderEntity; }
		}
