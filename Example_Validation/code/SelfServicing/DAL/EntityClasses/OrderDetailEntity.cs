...
namespace SD.LLBLGen.Pro.Examples.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class OrderDetailEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("OrderDetailEntity", InheritanceHierarchyType.None, false, (int)SD.LLBLGen.Pro.Examples.EntityType.OrderDetailEntity, typeof(OrderDetailEntity), typeof(OrderDetailEntityFactory), false);
				AddNavigatorMetaData<OrderDetailEntity, OrderEntity>("Order", "OrderDetails", (a, b) => a._order = b, a => a._order, (a, b) => a.Order = b, SD.LLBLGen.Pro.Examples.RelationClasses.StaticOrderDetailRelations.OrderEntityUsingOrderIdStatic, ()=>new OrderDetailRelations().OrderEntityUsingOrderId, null, new int[] { (int)OrderDetailFieldIndex.OrderId }, null, true, (int)SD.LLBLGen.Pro.Examples.EntityType.OrderEntity);
				AddNavigatorMetaData<OrderDetailEntity, ProductEntity>("Product", "OrderDetails", (a, b) => a._product = b, a => a._product, (a, b) => a.Product = b, SD.LLBLGen.Pro.Examples.RelationClasses.StaticOrderDetailRelations.ProductEntityUsingProductIdStatic, ()=>new OrderDetailRelations().ProductEntityUsingProductId, null, new int[] { (int)OrderDetailFieldIndex.ProductId }, null, true, (int)SD.LLBLGen.Pro.Examples.EntityType.ProductEntity);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathOrder { get { return _staticMetaData.GetPrefetchPathElement("Order", new SD.LLBLGen.Pro.Examples.CollectionClasses.OrderCollection()); } }

		/// <summary>Creates a new PrefetchPathElement object which contains all the information to prefetch the related entities of type 'Product'  for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathProduct { get { return _staticMetaData.GetPrefetchPathElement("Product", new SD.LLBLGen.Pro.Examples.CollectionClasses.ProductCollection()); } }
