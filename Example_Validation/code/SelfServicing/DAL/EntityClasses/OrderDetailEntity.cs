		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncOrder(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _order, new PropertyChangedEventHandler( OnOrderPropertyChanged ), "Order", SD.LLBLGen.Pro.Examples.RelationClasses.StaticOrderDetailRelations.OrderEntityUsingOrderIdStatic, true, ref _alreadyFetchedOrder, new string[] {  } );
			}
		}
		...
		private void SetupSyncProduct(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", SD.LLBLGen.Pro.Examples.RelationClasses.StaticOrderDetailRelations.ProductEntityUsingProductIdStatic, true, ref _alreadyFetchedProduct, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.CollectionClasses.OrderCollection(), (IEntityRelation)GetRelationsForField("Order")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.OrderDetailEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.OrderEntity, 0, null, null, null, "Order", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.CollectionClasses.ProductCollection(), (IEntityRelation)GetRelationsForField("Product")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.OrderDetailEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.ProductEntity, 0, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
