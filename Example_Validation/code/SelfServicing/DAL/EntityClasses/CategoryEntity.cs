		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class CategoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			public CategoryEntityStaticMetaData()
			{
				...
				AddNavigatorMetaData<CategoryEntity, SD.LLBLGen.Pro.Examples.CollectionClasses.ProductCollection>("Products", a => a._products, (a, b) => a._products = b, a => a.Products, () => new CategoryRelations().ProductEntityUsingCategoryId, typeof(ProductEntity), (int)SD.LLBLGen.Pro.Examples.EntityType.ProductEntity);
				AddNavigatorMetaData<CategoryEntity, SD.LLBLGen.Pro.Examples.CollectionClasses.SupplierCollection>("SupplierCollectionViaProduct", a => a._supplierCollectionViaProduct, (a, b) => a._supplierCollectionViaProduct = b, a => a.SupplierCollectionViaProduct, () => new CategoryRelations().ProductEntityUsingCategoryId, () => new ProductRelations().SupplierEntityUsingSupplierId, "CategoryEntity__", "Product_", typeof(SupplierEntity), (int)SD.LLBLGen.Pro.Examples.EntityType.SupplierEntity);
			}
		}
		...
		{
			return PerformMultiEntityLazyLoading<SD.LLBLGen.Pro.Examples.CollectionClasses.ProductCollection>("Products", forceFetch, entityFactoryToUse, (c,r)=>c.GetMultiManyToOne(this, null, filter));
		}
		...
		public SD.LLBLGen.Pro.Examples.CollectionClasses.SupplierCollection GetMultiSupplierCollectionViaProduct(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
			...
			return PerformMultiEntityLazyLoading<SD.LLBLGen.Pro.Examples.CollectionClasses.SupplierCollection>("SupplierCollectionViaProduct", forceFetch, entityFactoryToUse, (c,r)=>c.GetMulti(filter, r));
		}
		...
		/// <returns></returns>
		protected override IDao CreateDAOInstance() { return DAOFactory.CreateCategoryDAO(); }
		...
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathSupplierCollectionViaProduct { get { return _staticMetaData.GetPrefetchPathElement("SupplierCollectionViaProduct", new SD.LLBLGen.Pro.Examples.CollectionClasses.SupplierCollection()); } }
		...
		/// <summary>Retrieves all related entities of type 'SupplierEntity' using a relation of type 'm:n'.<br/><br/></summary>
		public virtual SD.LLBLGen.Pro.Examples.CollectionClasses.SupplierCollection SupplierCollectionViaProduct { get { return GetMultiSupplierCollectionViaProduct(false); } }
		...
		{
			get	{ return GetAlwaysFetchValueForNavigator("SupplierCollectionViaProduct"); }
			set	{ SetAlwaysFetchValueForNavigator("SupplierCollectionViaProduct", value); }
		}
		...
		{
			get { return GetAlreadyFetchedValueForNavigator("SupplierCollectionViaProduct");}
			set { SetAlreadyFetchedValueForNavigator("SupplierCollectionViaProduct", value, true);}
		}
