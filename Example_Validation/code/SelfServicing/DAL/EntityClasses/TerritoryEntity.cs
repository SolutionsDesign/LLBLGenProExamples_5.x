...
namespace SD.LLBLGen.Pro.Examples.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private SD.LLBLGen.Pro.Examples.CollectionClasses.EmployeeCollection _employeeCollectionViaEmployeeTerritory;
		private bool	_alwaysFetchEmployeeCollectionViaEmployeeTerritory, _alreadyFetchedEmployeeCollectionViaEmployeeTerritory;
		...
		public static partial class MemberNames
		{
			...
			/// <summary>Member name EmployeeCollectionViaEmployeeTerritory</summary>
			public static readonly string EmployeeCollectionViaEmployeeTerritory = "EmployeeCollectionViaEmployeeTerritory";
		}
		#endregion
		...
		protected TerritoryEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			_employeeCollectionViaEmployeeTerritory = (SD.LLBLGen.Pro.Examples.CollectionClasses.EmployeeCollection)info.GetValue("_employeeCollectionViaEmployeeTerritory", typeof(SD.LLBLGen.Pro.Examples.CollectionClasses.EmployeeCollection));
			_alwaysFetchEmployeeCollectionViaEmployeeTerritory = info.GetBoolean("_alwaysFetchEmployeeCollectionViaEmployeeTerritory");
			_alreadyFetchedEmployeeCollectionViaEmployeeTerritory = info.GetBoolean("_alreadyFetchedEmployeeCollectionViaEmployeeTerritory");
		...
		protected override void PerformPostReadXmlFixups()
		{
			...
			_alreadyFetchedEmployeeCollectionViaEmployeeTerritory = (_employeeCollectionViaEmployeeTerritory.Count > 0);
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "EmployeeTerritories":
					...
					break;
				case "EmployeeCollectionViaEmployeeTerritory":
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue("_employeeCollectionViaEmployeeTerritory", (!this.MarkedForDeletion?_employeeCollectionViaEmployeeTerritory:null));
			info.AddValue("_alwaysFetchEmployeeCollectionViaEmployeeTerritory", _alwaysFetchEmployeeCollectionViaEmployeeTerritory);
			info.AddValue("_alreadyFetchedEmployeeCollectionViaEmployeeTerritory", _alreadyFetchedEmployeeCollectionViaEmployeeTerritory);
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "EmployeeTerritories":
					...
					break;
				case "EmployeeCollectionViaEmployeeTerritory":
					_alreadyFetchedEmployeeCollectionViaEmployeeTerritory = true;
					if(entity!=null)
					{
						this.EmployeeCollectionViaEmployeeTerritory.Add((EmployeeEntity)entity);
					}
					break;
				default:
		...
		public SD.LLBLGen.Pro.Examples.CollectionClasses.EmployeeCollection GetMultiEmployeeCollectionViaEmployeeTerritory(bool forceFetch)
		{
			return GetMultiEmployeeCollectionViaEmployeeTerritory(forceFetch, _employeeCollectionViaEmployeeTerritory.EntityFactoryToUse);
		}
		...
		/// <returns>Filled collection with all related entities of the type constructed by the passed in entity factory</returns>
		public SD.LLBLGen.Pro.Examples.CollectionClasses.EmployeeCollection GetMultiEmployeeCollectionViaEmployeeTerritory(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
 			if( ( !_alreadyFetchedEmployeeCollectionViaEmployeeTerritory || forceFetch || _alwaysFetchEmployeeCollectionViaEmployeeTerritory) && !this.IsSerializing && !this.IsDeserializing && !this.InDesignMode)
			{
				AddToTransactionIfNecessary(_employeeCollectionViaEmployeeTerritory);
				...
				_employeeCollectionViaEmployeeTerritory.SuppressClearInGetMulti=!forceFetch;
				_employeeCollectionViaEmployeeTerritory.EntityFactoryToUse = entityFactoryToUse;
				_employeeCollectionViaEmployeeTerritory.GetMulti(filter, GetRelationsForField("EmployeeCollectionViaEmployeeTerritory"));
				_employeeCollectionViaEmployeeTerritory.SuppressClearInGetMulti=false;
				_alreadyFetchedEmployeeCollectionViaEmployeeTerritory = true;
			}
			return _employeeCollectionViaEmployeeTerritory;
		}

		/// <summary> Sets the collection parameters for the collection for 'EmployeeCollectionViaEmployeeTerritory'. These settings will be taken into account
		/// when the property EmployeeCollectionViaEmployeeTerritory is requested or GetMultiEmployeeCollectionViaEmployeeTerritory is called.</summary>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return. When set to 0, this parameter is ignored</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified (null), no sorting is applied.</param>
		public virtual void SetCollectionParametersEmployeeCollectionViaEmployeeTerritory(long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			_employeeCollectionViaEmployeeTerritory.SortClauses=sortClauses;
			_employeeCollectionViaEmployeeTerritory.MaxNumberOfItemsToReturn=maxNumberOfItemsToReturn;
		}
		...
		protected override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("EmployeeCollectionViaEmployeeTerritory", _employeeCollectionViaEmployeeTerritory);
			return toReturn;
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _region, new PropertyChangedEventHandler( OnRegionPropertyChanged ), "Region", SD.LLBLGen.Pro.Examples.RelationClasses.StaticTerritoryRelations.RegionEntityUsingRegionIdStatic, true, signalRelatedEntity, "Territories", resetFKFields, new int[] { (int)TerritoryFieldIndex.RegionId } );		
			_region = null;
		}
		...
		private void SetupSyncRegion(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _region, new PropertyChangedEventHandler( OnRegionPropertyChanged ), "Region", SD.LLBLGen.Pro.Examples.RelationClasses.StaticTerritoryRelations.RegionEntityUsingRegionIdStatic, true, ref _alreadyFetchedRegion, new string[] {  } );
			}
		}
		...
		{
			get { return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.CollectionClasses.EmployeeTerritoryCollection(), (IEntityRelation)GetRelationsForField("EmployeeTerritories")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.TerritoryEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeTerritoryEntity, 0, null, null, null, "EmployeeTerritories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathEmployeeCollectionViaEmployeeTerritory
		{
			get
			{
				...
				return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.CollectionClasses.EmployeeCollection(), intermediateRelation,	(int)SD.LLBLGen.Pro.Examples.EntityType.TerritoryEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeEntity, 0, null, null, GetRelationsForField("EmployeeCollectionViaEmployeeTerritory"), "EmployeeCollectionViaEmployeeTerritory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get	{ return new PrefetchPathElement(new SD.LLBLGen.Pro.Examples.CollectionClasses.RegionCollection(), (IEntityRelation)GetRelationsForField("Region")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.TerritoryEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.RegionEntity, 0, null, null, null, "Region", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// </summary>
		/// <remarks>This property is added for databinding conveniance, however it is recommeded to use the method 'GetMultiEmployeeCollectionViaEmployeeTerritory()', because 
		/// this property is rather expensive and a method tells the user to cache the result when it has to be used more than once in the same scope.</remarks>
		public virtual SD.LLBLGen.Pro.Examples.CollectionClasses.EmployeeCollection EmployeeCollectionViaEmployeeTerritory
		{
			get { return GetMultiEmployeeCollectionViaEmployeeTerritory(false); }
		}

		/// <summary> Gets / sets the lazy loading flag for EmployeeCollectionViaEmployeeTerritory. When set to true, EmployeeCollectionViaEmployeeTerritory is always refetched from the 
		/// persistent storage. When set to false, the data is only fetched the first time EmployeeCollectionViaEmployeeTerritory is accessed. You can always execute a forced fetch by calling GetMultiEmployeeCollectionViaEmployeeTerritory(true).</summary>
		[Browsable(false)]
		public bool AlwaysFetchEmployeeCollectionViaEmployeeTerritory
		{
			get	{ return _alwaysFetchEmployeeCollectionViaEmployeeTerritory; }
			set	{ _alwaysFetchEmployeeCollectionViaEmployeeTerritory = value; }
		}
				
		/// <summary>Gets / Sets the lazy loading flag if the property EmployeeCollectionViaEmployeeTerritory already has been fetched. Setting this property to false when EmployeeCollectionViaEmployeeTerritory has been fetched
		/// will clear the EmployeeCollectionViaEmployeeTerritory collection well. Setting this property to true while EmployeeCollectionViaEmployeeTerritory hasn't been fetched disables lazy loading for EmployeeCollectionViaEmployeeTerritory</summary>
		[Browsable(false)]
		public bool AlreadyFetchedEmployeeCollectionViaEmployeeTerritory
		{
			get { return _alreadyFetchedEmployeeCollectionViaEmployeeTerritory;}
			set 
			{
				if(_alreadyFetchedEmployeeCollectionViaEmployeeTerritory && !value && (_employeeCollectionViaEmployeeTerritory != null))
				{
					_employeeCollectionViaEmployeeTerritory.Clear();
				}
				_alreadyFetchedEmployeeCollectionViaEmployeeTerritory = value;
			}
		}
		...
		{ 
			get { return (int)SD.LLBLGen.Pro.Examples.EntityType.TerritoryEntity; }
		}
