...
namespace SD.LLBLGen.Pro.Examples.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class TerritoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("TerritoryEntity", InheritanceHierarchyType.None, false, (int)SD.LLBLGen.Pro.Examples.EntityType.TerritoryEntity, typeof(TerritoryEntity), typeof(TerritoryEntityFactory), false);
				AddNavigatorMetaData<TerritoryEntity, SD.LLBLGen.Pro.Examples.CollectionClasses.EmployeeTerritoryCollection>("EmployeeTerritories", a => a._employeeTerritories, (a, b) => a._employeeTerritories = b, a => a.EmployeeTerritories, () => new TerritoryRelations().EmployeeTerritoryEntityUsingTerritoryId, typeof(EmployeeTerritoryEntity), (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeTerritoryEntity);
				AddNavigatorMetaData<TerritoryEntity, RegionEntity>("Region", "Territories", (a, b) => a._region = b, a => a._region, (a, b) => a.Region = b, SD.LLBLGen.Pro.Examples.RelationClasses.StaticTerritoryRelations.RegionEntityUsingRegionIdStatic, ()=>new TerritoryRelations().RegionEntityUsingRegionId, null, new int[] { (int)TerritoryFieldIndex.RegionId }, null, true, (int)SD.LLBLGen.Pro.Examples.EntityType.RegionEntity);
				AddNavigatorMetaData<TerritoryEntity, SD.LLBLGen.Pro.Examples.CollectionClasses.EmployeeCollection>("EmployeeCollectionViaEmployeeTerritory", a => a._employeeCollectionViaEmployeeTerritory, (a, b) => a._employeeCollectionViaEmployeeTerritory = b, a => a.EmployeeCollectionViaEmployeeTerritory, () => new TerritoryRelations().EmployeeTerritoryEntityUsingTerritoryId, () => new EmployeeTerritoryRelations().EmployeeEntityUsingEmployeeId, "TerritoryEntity__", "EmployeeTerritory_", typeof(EmployeeEntity), (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeEntity);
			}
		}
		...
		{
			return PerformMultiEntityLazyLoading<SD.LLBLGen.Pro.Examples.CollectionClasses.EmployeeTerritoryCollection>("EmployeeTerritories", forceFetch, entityFactoryToUse, (c,r)=>c.GetMultiManyToOne(null, this, filter));
		}
		...
		public SD.LLBLGen.Pro.Examples.CollectionClasses.EmployeeCollection GetMultiEmployeeCollectionViaEmployeeTerritory(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
			...
			return PerformMultiEntityLazyLoading<SD.LLBLGen.Pro.Examples.CollectionClasses.EmployeeCollection>("EmployeeCollectionViaEmployeeTerritory", forceFetch, entityFactoryToUse, (c,r)=>c.GetMulti(filter, r));
		}
		...
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathEmployeeCollectionViaEmployeeTerritory { get { return _staticMetaData.GetPrefetchPathElement("EmployeeCollectionViaEmployeeTerritory", new SD.LLBLGen.Pro.Examples.CollectionClasses.EmployeeCollection()); } }
		...
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathRegion { get { return _staticMetaData.GetPrefetchPathElement("Region", new SD.LLBLGen.Pro.Examples.CollectionClasses.RegionCollection()); } }
		...
		public virtual SD.LLBLGen.Pro.Examples.CollectionClasses.EmployeeCollection EmployeeCollectionViaEmployeeTerritory { get { return GetMultiEmployeeCollectionViaEmployeeTerritory(false); } }
		...
		{
			get	{ return GetAlwaysFetchValueForNavigator("EmployeeCollectionViaEmployeeTerritory"); }
			set	{ SetAlwaysFetchValueForNavigator("EmployeeCollectionViaEmployeeTerritory", value); }
		}
		...
		{
			get { return GetAlreadyFetchedValueForNavigator("EmployeeCollectionViaEmployeeTerritory");}
			set { SetAlreadyFetchedValueForNavigator("EmployeeCollectionViaEmployeeTerritory", value, true);}
		}
