...
namespace SD.LLBLGen.Pro.Examples.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private bool	_customerDemographyReturnsNewIfNotFound;
		...
		public virtual CustomerDemographyEntity GetSingleCustomerDemography(bool forceFetch=false)
		{
			return PerformSingleEntityLazyLoading<CustomerDemographyEntity>("CustomerDemography", forceFetch, _customerDemographyReturnsNewIfNotFound, e=>e.FetchUsingPK(this.CustomerTypeId));
		}
		...
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathCustomerDemography { get { return _staticMetaData.GetPrefetchPathElement("CustomerDemography", new SD.LLBLGen.Pro.Examples.CollectionClasses.CustomerDemographyCollection()); } }
		...
		{
			get	{ return GetAlwaysFetchValueForNavigator("CustomerDemography"); }
			set	{ SetAlwaysFetchValueForNavigator("CustomerDemography", value); }	
		}
		...
		{
			get { return GetAlreadyFetchedValueForNavigator("CustomerDemography");}
			set { SetAlreadyFetchedValueForNavigator("CustomerDemography", value, true);}
		}
