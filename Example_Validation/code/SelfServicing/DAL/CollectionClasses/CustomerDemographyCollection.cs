...
namespace SD.LLBLGen.Pro.Examples.CollectionClasses
{
	...
	public partial class CustomerDemographyCollection : EntityCollectionBase<CustomerDemographyEntity>
	{
		...
		public bool GetMultiManyToManyUsingCustomerCollectionViaCustomerCustomerDemo(IEntity customerInstance)
		{
			return GetMultiManyToManyUsingCustomerCollectionViaCustomerCustomerDemo(customerInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, 0, 0);
		}
		...
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingCustomerCollectionViaCustomerCustomerDemo(IEntity customerInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			return GetMultiManyToManyUsingCustomerCollectionViaCustomerCustomerDemo(customerInstance, maxNumberOfItemsToReturn, sortClauses, 0, 0);
		}
		...
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingCustomerCollectionViaCustomerCustomerDemo(IEntity customerInstance, IPrefetchPath prefetchPathToUse)
		{
			return GetMultiManyToManyUsingCustomerCollectionViaCustomerCustomerDemo(customerInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, prefetchPathToUse);
		}
		...
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToManyUsingCustomerCollectionViaCustomerCustomerDemo(IEntity customerInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			if(!this.SuppressClearInGetMulti)
			{
				this.Clear();
			}
			return DAOFactory.CreateCustomerDemographyDAO().GetMultiUsingCustomerCollectionViaCustomerCustomerDemo(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, customerInstance, null, pageNumber, pageSize);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingCustomerCollectionViaCustomerCustomerDemo(IEntity customerInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			if(!this.SuppressClearInGetMulti)
			{
				this.Clear();
			}
			return DAOFactory.CreateCustomerDemographyDAO().GetMultiUsingCustomerCollectionViaCustomerCustomerDemo(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, customerInstance, prefetchPathToUse, 0, 0);
		}
