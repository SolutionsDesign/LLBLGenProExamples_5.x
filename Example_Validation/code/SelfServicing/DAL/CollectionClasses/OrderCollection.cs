...
namespace SD.LLBLGen.Pro.Examples.CollectionClasses
{
	...
	public partial class OrderCollection : EntityCollectionBase<OrderEntity>
	{
		...
		{
			return GetMultiManyToOne(customerInstance, employeeInstance, shipperInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, null, 0, 0);
		}
		...
		{
			return GetMultiManyToOne(customerInstance, employeeInstance, shipperInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, filter, 0, 0);
		}
		...
		{
			return DAOFactory.CreateOrderDAO().DeleteMulti(this.Transaction, customerInstance, employeeInstance, shipperInstance);
		}
		...
		/// <param name="shipperInstance">ShipperEntity instance to use as a filter for the OrderEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(OrderEntity entityWithNewValues, IEntity customerInstance, IEntity employeeInstance, IEntity shipperInstance)
		{
			return DAOFactory.CreateOrderDAO().UpdateMulti(entityWithNewValues, this.Transaction, customerInstance, employeeInstance, shipperInstance);
		}
		...
		public bool GetMultiManyToManyUsingProductCollectionViaOrderDetails(IEntity productInstance)
		{
			return GetMultiManyToManyUsingProductCollectionViaOrderDetails(productInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, 0, 0);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingProductCollectionViaOrderDetails(IEntity productInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			return GetMultiManyToManyUsingProductCollectionViaOrderDetails(productInstance, maxNumberOfItemsToReturn, sortClauses, 0, 0);
		}
		...
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingProductCollectionViaOrderDetails(IEntity productInstance, IPrefetchPath prefetchPathToUse)
		{
			return GetMultiManyToManyUsingProductCollectionViaOrderDetails(productInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, prefetchPathToUse);
		}
		...
		/// <param name="pageSize">The page size of the page to retrieve.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToManyUsingProductCollectionViaOrderDetails(IEntity productInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			if(!this.SuppressClearInGetMulti)
			{
				this.Clear();
			}
			return DAOFactory.CreateOrderDAO().GetMultiUsingProductCollectionViaOrderDetails(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, productInstance, null, pageNumber, pageSize);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingProductCollectionViaOrderDetails(IEntity productInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			if(!this.SuppressClearInGetMulti)
			{
				this.Clear();
			}
			return DAOFactory.CreateOrderDAO().GetMultiUsingProductCollectionViaOrderDetails(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, productInstance, prefetchPathToUse, 0, 0);
		}
