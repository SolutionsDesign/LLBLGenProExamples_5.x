		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected OrderEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_productCollectionViaOrderDetails = (EntityCollection<ProductEntity>)info.GetValue("_productCollectionViaOrderDetails", typeof(EntityCollection<ProductEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "ProductCollectionViaOrderDetails":
					this.ProductCollectionViaOrderDetails.IsReadOnly = false;
					this.ProductCollectionViaOrderDetails.Add((ProductEntity)entity);
					this.ProductCollectionViaOrderDetails.IsReadOnly = true;
					break;
				default:
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_productCollectionViaOrderDetails", ((_productCollectionViaOrderDetails!=null) && (_productCollectionViaOrderDetails.Count>0) && !this.MarkedForDeletion)?_productCollectionViaOrderDetails:null);
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoProductCollectionViaOrderDetails()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("ProductCollectionViaOrderDetails"));
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._productCollectionViaOrderDetails);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._productCollectionViaOrderDetails = (EntityCollection<ProductEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			toReturn |= (this._productCollectionViaOrderDetails != null);
		...
		private void SetupSyncCustomer(IEntityCore relatedEntity)
		{
			if(_customer!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", SD.LLBLGen.Pro.Examples.RelationClasses.StaticOrderRelations.CustomerEntityUsingCustomerIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncEmployee(IEntityCore relatedEntity)
		{
			if(_employee!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", SD.LLBLGen.Pro.Examples.RelationClasses.StaticOrderRelations.EmployeeEntityUsingEmployeeIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncShipper(IEntityCore relatedEntity)
		{
			if(_shipper!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _shipper, new PropertyChangedEventHandler( OnShipperPropertyChanged ), "Shipper", SD.LLBLGen.Pro.Examples.RelationClasses.StaticOrderRelations.ShipperEntityUsingShipViaStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<OrderDetailEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrderDetailEntityFactory))), (IEntityRelation)GetRelationsForField("OrderDetails")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.OrderEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.OrderDetailEntity, 0, null, null, null, null, "OrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}

		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'Product' for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathProductCollectionViaOrderDetails
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.EntityType.OrderEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.ProductEntity, 0, null, null, GetRelationsForField("ProductCollectionViaOrderDetails"), null, "ProductCollectionViaOrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))),	(IEntityRelation)GetRelationsForField("Customer")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.OrderEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.CustomerEntity, 0, null, null, null, null, "Customer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))),	(IEntityRelation)GetRelationsForField("Employee")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.OrderEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeEntity, 0, null, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShipperEntityFactory))),	(IEntityRelation)GetRelationsForField("Shipper")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.OrderEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.ShipperEntity, 0, null, null, null, null, "Shipper", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual EntityCollection<ProductEntity> ProductCollectionViaOrderDetails
		{
			get { return GetOrCreateEntityCollection<ProductEntity, ProductEntityFactory>("OrderCollectionViaOrderDetails", false, true, ref _productCollectionViaOrderDetails);	}
		}
