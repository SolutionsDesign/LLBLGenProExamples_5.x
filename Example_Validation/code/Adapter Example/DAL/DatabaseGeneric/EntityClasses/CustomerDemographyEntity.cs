...
namespace SD.LLBLGen.Pro.Examples.EntityClasses
{
	...
	
	{
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoCustomerCollectionViaCustomerCustomerDemo() { return CreateRelationInfoForNavigator("CustomerCollectionViaCustomerCustomerDemo"); }
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathCustomerCollectionViaCustomerCustomerDemo { get { return _staticMetaData.GetPrefetchPathElement("CustomerCollectionViaCustomerCustomerDemo", CommonEntityBase.CreateEntityCollection<CustomerEntity>()); } }
		...
		public virtual EntityCollection<CustomerCustomerDemoEntity> CustomerCustomerDemo { get { return GetOrCreateEntityCollection<CustomerCustomerDemoEntity, CustomerCustomerDemoEntityFactory>("CustomerDemography", true, false, ref _customerCustomerDemo); } }
		...
		public virtual EntityCollection<CustomerEntity> CustomerCollectionViaCustomerCustomerDemo { get { return GetOrCreateEntityCollection<CustomerEntity, CustomerEntityFactory>("CustomerDemographicsCollectionViaCustomerCustomerDemo", false, true, ref _customerCollectionViaCustomerCustomerDemo); } }
