...
namespace SD.LLBLGen.Pro.Examples.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public static IPrefetchPathElement2 PrefetchPathCustomerCollectionViaCustomerCustomerDemo
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CustomerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.EntityType.CustomerDemographyEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.CustomerEntity, 0, null, null, GetRelationsForField("CustomerCollectionViaCustomerCustomerDemo"), null, "CustomerCollectionViaCustomerCustomerDemo", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return GetOrCreateEntityCollection<CustomerCustomerDemoEntity, CustomerCustomerDemoEntityFactory>("CustomerDemography", true, false, ref _customerCustomerDemo);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<CustomerEntity, CustomerEntityFactory>("CustomerDemographicsCollectionViaCustomerCustomerDemo", false, true, ref _customerCollectionViaCustomerCustomerDemo);	}
		}
