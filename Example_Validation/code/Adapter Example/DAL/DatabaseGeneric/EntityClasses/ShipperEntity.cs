	...
	
	{
		...
		protected class ShipperEntityStaticMetaData : EntityStaticMetaDataBase
		{
			public ShipperEntityStaticMetaData()
			{
				...
				AddNavigatorMetaData<ShipperEntity, EntityCollection<OrderEntity>>("Orders", a => a._orders, (a, b) => a._orders = b, a => a.Orders, () => new ShipperRelations().OrderEntityUsingShipVia, typeof(OrderEntity), (int)SD.LLBLGen.Pro.Examples.EntityType.OrderEntity);
				AddNavigatorMetaData<ShipperEntity, EntityCollection<CustomerEntity>>("CustomerCollectionViaOrders", a => a._customerCollectionViaOrders, (a, b) => a._customerCollectionViaOrders = b, a => a.CustomerCollectionViaOrders, () => new ShipperRelations().OrderEntityUsingShipVia, () => new OrderRelations().CustomerEntityUsingCustomerId, "ShipperEntity__", "Order_", typeof(CustomerEntity), (int)SD.LLBLGen.Pro.Examples.EntityType.CustomerEntity);
				AddNavigatorMetaData<ShipperEntity, EntityCollection<EmployeeEntity>>("EmployeeCollectionViaOrders", a => a._employeeCollectionViaOrders, (a, b) => a._employeeCollectionViaOrders = b, a => a.EmployeeCollectionViaOrders, () => new ShipperRelations().OrderEntityUsingShipVia, () => new OrderRelations().EmployeeEntityUsingEmployeeId, "ShipperEntity__", "Order_", typeof(EmployeeEntity), (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeEntity);
			}
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoCustomerCollectionViaOrders() { return CreateRelationInfoForNavigator("CustomerCollectionViaOrders"); }
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoEmployeeCollectionViaOrders() { return CreateRelationInfoForNavigator("EmployeeCollectionViaOrders"); }
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathCustomerCollectionViaOrders { get { return _staticMetaData.GetPrefetchPathElement("CustomerCollectionViaOrders", CommonEntityBase.CreateEntityCollection<CustomerEntity>()); } }
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathEmployeeCollectionViaOrders { get { return _staticMetaData.GetPrefetchPathElement("EmployeeCollectionViaOrders", CommonEntityBase.CreateEntityCollection<EmployeeEntity>()); } }
		...
		public virtual EntityCollection<CustomerEntity> CustomerCollectionViaOrders { get { return GetOrCreateEntityCollection<CustomerEntity, CustomerEntityFactory>("ShipperCollectionViaOrder", false, true, ref _customerCollectionViaOrders); } }
		...
		public virtual EntityCollection<EmployeeEntity> EmployeeCollectionViaOrders { get { return GetOrCreateEntityCollection<EmployeeEntity, EmployeeEntityFactory>("ShipperCollectionViaOrder", false, true, ref _employeeCollectionViaOrders); } }
