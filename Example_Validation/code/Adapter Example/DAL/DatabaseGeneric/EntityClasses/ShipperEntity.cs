...
namespace SD.LLBLGen.Pro.Examples.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<CustomerEntity> _customerCollectionViaOrders;
		private EntityCollection<EmployeeEntity> _employeeCollectionViaOrders;
		...
		protected ShipperEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_customerCollectionViaOrders = (EntityCollection<CustomerEntity>)info.GetValue("_customerCollectionViaOrders", typeof(EntityCollection<CustomerEntity>));
				_employeeCollectionViaOrders = (EntityCollection<EmployeeEntity>)info.GetValue("_employeeCollectionViaOrders", typeof(EntityCollection<EmployeeEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "CustomerCollectionViaOrders":
					this.CustomerCollectionViaOrders.IsReadOnly = false;
					this.CustomerCollectionViaOrders.Add((CustomerEntity)entity);
					this.CustomerCollectionViaOrders.IsReadOnly = true;
					break;
				case "EmployeeCollectionViaOrders":
					this.EmployeeCollectionViaOrders.IsReadOnly = false;
					this.EmployeeCollectionViaOrders.Add((EmployeeEntity)entity);
					this.EmployeeCollectionViaOrders.IsReadOnly = true;
					break;
				default:
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_customerCollectionViaOrders", ((_customerCollectionViaOrders!=null) && (_customerCollectionViaOrders.Count>0) && !this.MarkedForDeletion)?_customerCollectionViaOrders:null);
				info.AddValue("_employeeCollectionViaOrders", ((_employeeCollectionViaOrders!=null) && (_employeeCollectionViaOrders.Count>0) && !this.MarkedForDeletion)?_employeeCollectionViaOrders:null);
			}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoCustomerCollectionViaOrders()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("CustomerCollectionViaOrders"));
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoEmployeeCollectionViaOrders()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("EmployeeCollectionViaOrders"));
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ShipperFields.ShipperId, null, ComparisonOperator.Equal, this.ShipperId, "ShipperEntity__"));
			return bucket;
		}
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._customerCollectionViaOrders);
			collectionsQueue.Enqueue(this._employeeCollectionViaOrders);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._customerCollectionViaOrders = (EntityCollection<CustomerEntity>) collectionsQueue.Dequeue();
			this._employeeCollectionViaOrders = (EntityCollection<EmployeeEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			toReturn |= (this._customerCollectionViaOrders != null);
			toReturn |= (this._employeeCollectionViaOrders != null);
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<OrderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrderEntityFactory))), (IEntityRelation)GetRelationsForField("Orders")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.ShipperEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.OrderEntity, 0, null, null, null, null, "Orders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathCustomerCollectionViaOrders
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CustomerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.EntityType.ShipperEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.CustomerEntity, 0, null, null, GetRelationsForField("CustomerCollectionViaOrders"), null, "CustomerCollectionViaOrders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathEmployeeCollectionViaOrders
		{
			get
			{
				IEntityRelation intermediateRelation = Relations.OrderEntityUsingShipVia;
				...
				return new PrefetchPathElement2(new EntityCollection<EmployeeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.EntityType.ShipperEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeEntity, 0, null, null, GetRelationsForField("EmployeeCollectionViaOrders"), null, "EmployeeCollectionViaOrders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public virtual EntityCollection<CustomerEntity> CustomerCollectionViaOrders
		{
			get { return GetOrCreateEntityCollection<CustomerEntity, CustomerEntityFactory>("ShipperCollectionViaOrder", false, true, ref _customerCollectionViaOrders);	}
		}
		...
		public virtual EntityCollection<EmployeeEntity> EmployeeCollectionViaOrders
		{
			get { return GetOrCreateEntityCollection<EmployeeEntity, EmployeeEntityFactory>("ShipperCollectionViaOrder", false, true, ref _employeeCollectionViaOrders);	}
		}
