...
namespace SD.LLBLGen.Pro.Examples.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "TerritoryCollectionViaEmployeeTerritory":
					this.TerritoryCollectionViaEmployeeTerritory.IsReadOnly = false;
					this.TerritoryCollectionViaEmployeeTerritory.Add((TerritoryEntity)entity);
					this.TerritoryCollectionViaEmployeeTerritory.IsReadOnly = true;
					break;
				default:
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoCustomerCollectionViaOrder()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("CustomerCollectionViaOrder"));
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoTerritoryCollectionViaEmployeeTerritory()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("TerritoryCollectionViaEmployeeTerritory"));
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(EmployeeFields.EmployeeId, null, ComparisonOperator.Equal, this.EmployeeId, "EmployeeEntity__"));
			return bucket;
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoEmployeeSuperior()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
		...
		private void SetupSyncEmployeeSuperior(IEntityCore relatedEntity)
		{
			if(_employeeSuperior!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employeeSuperior, new PropertyChangedEventHandler( OnEmployeeSuperiorPropertyChanged ), "EmployeeSuperior", SD.LLBLGen.Pro.Examples.RelationClasses.StaticEmployeeRelations.EmployeeEntityUsingEmployeeIdReportsToStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<EmployeeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))), (IEntityRelation)GetRelationsForField("Employees")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeEntity, 0, null, null, null, null, "Employees", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<EmployeeTerritoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeTerritoryEntityFactory))), (IEntityRelation)GetRelationsForField("EmployeeTerritories")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeTerritoryEntity, 0, null, null, null, null, "EmployeeTerritories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<OrderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrderEntityFactory))), (IEntityRelation)GetRelationsForField("Orders")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.OrderEntity, 0, null, null, null, null, "Orders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathCustomerCollectionViaOrder
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CustomerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.CustomerEntity, 0, null, null, GetRelationsForField("CustomerCollectionViaOrder"), null, "CustomerCollectionViaOrder", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathShipperCollectionViaOrder
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ShipperEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ShipperEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.ShipperEntity, 0, null, null, GetRelationsForField("ShipperCollectionViaOrder"), null, "ShipperCollectionViaOrder", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathTerritoryCollectionViaEmployeeTerritory
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TerritoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TerritoryEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.TerritoryEntity, 0, null, null, GetRelationsForField("TerritoryCollectionViaEmployeeTerritory"), null, "TerritoryCollectionViaEmployeeTerritory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}

		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'Employee' for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathEmployeeSuperior
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))),	(IEntityRelation)GetRelationsForField("EmployeeSuperior")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeEntity, 0, null, null, null, null, "EmployeeSuperior", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get { return GetOrCreateEntityCollection<EmployeeEntity, EmployeeEntityFactory>("EmployeeSuperior", true, false, ref _employees);	}
		}
		...
		public virtual EntityCollection<CustomerEntity> CustomerCollectionViaOrder
		{
		...
		{
			get { return GetOrCreateEntityCollection<ShipperEntity, ShipperEntityFactory>("EmployeeCollectionViaOrders", false, true, ref _shipperCollectionViaOrder);	}
		}
		...
		public virtual EntityCollection<TerritoryEntity> TerritoryCollectionViaEmployeeTerritory
		{
			get { return GetOrCreateEntityCollection<TerritoryEntity, TerritoryEntityFactory>("EmployeeCollectionViaEmployeeTerritory", false, true, ref _territoryCollectionViaEmployeeTerritory);	}
		}
