		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected ProductEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_orderCollectionViaOrderDetails = (EntityCollection<OrderEntity>)info.GetValue("_orderCollectionViaOrderDetails", typeof(EntityCollection<OrderEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "OrderCollectionViaOrderDetails":
					this.OrderCollectionViaOrderDetails.IsReadOnly = false;
					this.OrderCollectionViaOrderDetails.Add((OrderEntity)entity);
					this.OrderCollectionViaOrderDetails.IsReadOnly = true;
					break;
				default:
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_orderCollectionViaOrderDetails", ((_orderCollectionViaOrderDetails!=null) && (_orderCollectionViaOrderDetails.Count>0) && !this.MarkedForDeletion)?_orderCollectionViaOrderDetails:null);
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoOrderCollectionViaOrderDetails()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("OrderCollectionViaOrderDetails"));
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._orderCollectionViaOrderDetails);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._orderCollectionViaOrderDetails = (EntityCollection<OrderEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			toReturn |= (this._orderCollectionViaOrderDetails != null);
		...
		private void SetupSyncCategory(IEntityCore relatedEntity)
		{
			if(_category!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _category, new PropertyChangedEventHandler( OnCategoryPropertyChanged ), "Category", SD.LLBLGen.Pro.Examples.RelationClasses.StaticProductRelations.CategoryEntityUsingCategoryIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncSupplier(IEntityCore relatedEntity)
		{
			if(_supplier!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _supplier, new PropertyChangedEventHandler( OnSupplierPropertyChanged ), "Supplier", SD.LLBLGen.Pro.Examples.RelationClasses.StaticProductRelations.SupplierEntityUsingSupplierIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathOrderCollectionViaOrderDetails
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OrderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrderEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.EntityType.ProductEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.OrderEntity, 0, null, null, GetRelationsForField("OrderCollectionViaOrderDetails"), null, "OrderCollectionViaOrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CategoryEntityFactory))),	(IEntityRelation)GetRelationsForField("Category")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.ProductEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.CategoryEntity, 0, null, null, null, null, "Category", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SupplierEntityFactory))),	(IEntityRelation)GetRelationsForField("Supplier")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.ProductEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.SupplierEntity, 0, null, null, null, null, "Supplier", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual EntityCollection<OrderEntity> OrderCollectionViaOrderDetails
		{
			get { return GetOrCreateEntityCollection<OrderEntity, OrderEntityFactory>("ProductCollectionViaOrderDetails", false, true, ref _orderCollectionViaOrderDetails);	}
		}
