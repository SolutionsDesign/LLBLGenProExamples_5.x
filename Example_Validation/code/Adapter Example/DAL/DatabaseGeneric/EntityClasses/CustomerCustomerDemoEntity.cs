...
namespace SD.LLBLGen.Pro.Examples.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoCustomerDemography()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
		...
		private void SetupSyncCustomer(IEntityCore relatedEntity)
		{
			if(_customer!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", SD.LLBLGen.Pro.Examples.RelationClasses.StaticCustomerCustomerDemoRelations.CustomerEntityUsingCustomerIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))),	(IEntityRelation)GetRelationsForField("Customer")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.CustomerCustomerDemoEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.CustomerEntity, 0, null, null, null, null, "Customer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathCustomerDemography
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CustomerDemographyEntityFactory))),	(IEntityRelation)GetRelationsForField("CustomerDemography")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.CustomerCustomerDemoEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.CustomerDemographyEntity, 0, null, null, null, null, "CustomerDemography", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
