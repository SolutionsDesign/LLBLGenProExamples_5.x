...
namespace SD.LLBLGen.Pro.Examples.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))), (IEntityRelation)GetRelationsForField("Products")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.SupplierEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.ProductEntity, 0, null, null, null, null, "Products", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCategoriesCollectionViaProducts
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CategoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CategoryEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.EntityType.SupplierEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.CategoryEntity, 0, null, null, GetRelationsForField("CategoriesCollectionViaProducts"), null, "CategoriesCollectionViaProducts", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return GetOrCreateEntityCollection<CategoryEntity, CategoryEntityFactory>("SupplierCollectionViaProduct", false, true, ref _categoriesCollectionViaProducts);	}
		}
