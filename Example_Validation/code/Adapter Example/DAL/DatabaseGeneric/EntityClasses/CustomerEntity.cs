	...
	
	{
		...
		protected class CustomerEntityStaticMetaData : EntityStaticMetaDataBase
		{
			public CustomerEntityStaticMetaData()
			{
				...
				AddNavigatorMetaData<CustomerEntity, EntityCollection<OrderEntity>>("Orders", a => a._orders, (a, b) => a._orders = b, a => a.Orders, () => new CustomerRelations().OrderEntityUsingCustomerId, typeof(OrderEntity), (int)SD.LLBLGen.Pro.Examples.EntityType.OrderEntity);
				...
				AddNavigatorMetaData<CustomerEntity, EntityCollection<EmployeeEntity>>("EmployeeCollectionViaOrder", a => a._employeeCollectionViaOrder, (a, b) => a._employeeCollectionViaOrder = b, a => a.EmployeeCollectionViaOrder, () => new CustomerRelations().OrderEntityUsingCustomerId, () => new OrderRelations().EmployeeEntityUsingEmployeeId, "CustomerEntity__", "Order_", typeof(EmployeeEntity), (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeEntity);
				AddNavigatorMetaData<CustomerEntity, EntityCollection<ShipperEntity>>("ShipperCollectionViaOrder", a => a._shipperCollectionViaOrder, (a, b) => a._shipperCollectionViaOrder = b, a => a.ShipperCollectionViaOrder, () => new CustomerRelations().OrderEntityUsingCustomerId, () => new OrderRelations().ShipperEntityUsingShipVia, "CustomerEntity__", "Order_", typeof(ShipperEntity), (int)SD.LLBLGen.Pro.Examples.EntityType.ShipperEntity);
			}
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoEmployeeCollectionViaOrder() { return CreateRelationInfoForNavigator("EmployeeCollectionViaOrder"); }
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathEmployeeCollectionViaOrder { get { return _staticMetaData.GetPrefetchPathElement("EmployeeCollectionViaOrder", CommonEntityBase.CreateEntityCollection<EmployeeEntity>()); } }
		...
		public virtual EntityCollection<CustomerCustomerDemoEntity> CustomerCustomerDemo { get { return GetOrCreateEntityCollection<CustomerCustomerDemoEntity, CustomerCustomerDemoEntityFactory>("Customer", true, false, ref _customerCustomerDemo); } }
		...
		public virtual EntityCollection<CustomerDemographyEntity> CustomerDemographicsCollectionViaCustomerCustomerDemo { get { return GetOrCreateEntityCollection<CustomerDemographyEntity, CustomerDemographyEntityFactory>("CustomerCollectionViaCustomerCustomerDemo", false, true, ref _customerDemographicsCollectionViaCustomerCustomerDemo); } }
		...
		public virtual EntityCollection<EmployeeEntity> EmployeeCollectionViaOrder { get { return GetOrCreateEntityCollection<EmployeeEntity, EmployeeEntityFactory>("CustomerCollectionViaOrder", false, true, ref _employeeCollectionViaOrder); } }
		...
		public virtual EntityCollection<ShipperEntity> ShipperCollectionViaOrder { get { return GetOrCreateEntityCollection<ShipperEntity, ShipperEntityFactory>("CustomerCollectionViaOrders", false, true, ref _shipperCollectionViaOrder); } }
