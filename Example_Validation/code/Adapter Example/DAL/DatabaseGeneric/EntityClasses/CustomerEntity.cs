...
// Code is generated on: donderdag 21 april 2016 12:49:19
...
namespace SD.LLBLGen.Pro.Examples.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<OrderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrderEntityFactory))), (IEntityRelation)GetRelationsForField("Orders")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.CustomerEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.OrderEntity, 0, null, null, null, null, "Orders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCustomerDemographicsCollectionViaCustomerCustomerDemo
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CustomerDemographyEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CustomerDemographyEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.EntityType.CustomerEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.CustomerDemographyEntity, 0, null, null, GetRelationsForField("CustomerDemographicsCollectionViaCustomerCustomerDemo"), null, "CustomerDemographicsCollectionViaCustomerCustomerDemo", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEmployeeCollectionViaOrder
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<EmployeeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.EntityType.CustomerEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeEntity, 0, null, null, GetRelationsForField("EmployeeCollectionViaOrder"), null, "EmployeeCollectionViaOrder", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathShipperCollectionViaOrder
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ShipperEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ShipperEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.EntityType.CustomerEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.ShipperEntity, 0, null, null, GetRelationsForField("ShipperCollectionViaOrder"), null, "ShipperCollectionViaOrder", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return GetOrCreateEntityCollection<CustomerCustomerDemoEntity, CustomerCustomerDemoEntityFactory>("Customer", true, false, ref _customerCustomerDemo);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<CustomerDemographyEntity, CustomerDemographyEntityFactory>("CustomerCollectionViaCustomerCustomerDemo", false, true, ref _customerDemographicsCollectionViaCustomerCustomerDemo);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<ShipperEntity, ShipperEntityFactory>("CustomerCollectionViaOrders", false, true, ref _shipperCollectionViaOrder);	}
		}
