	...
	
	{
		...
		protected class TerritoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			public TerritoryEntityStaticMetaData()
			{
				...
				AddNavigatorMetaData<TerritoryEntity, EntityCollection<EmployeeEntity>>("EmployeeCollectionViaEmployeeTerritory", a => a._employeeCollectionViaEmployeeTerritory, (a, b) => a._employeeCollectionViaEmployeeTerritory = b, a => a.EmployeeCollectionViaEmployeeTerritory, () => new TerritoryRelations().EmployeeTerritoryEntityUsingTerritoryId, () => new EmployeeTerritoryRelations().EmployeeEntityUsingEmployeeId, "TerritoryEntity__", "EmployeeTerritory_", typeof(EmployeeEntity), (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeEntity);
			}
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoEmployeeCollectionViaEmployeeTerritory() { return CreateRelationInfoForNavigator("EmployeeCollectionViaEmployeeTerritory"); }
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathEmployeeCollectionViaEmployeeTerritory { get { return _staticMetaData.GetPrefetchPathElement("EmployeeCollectionViaEmployeeTerritory", CommonEntityBase.CreateEntityCollection<EmployeeEntity>()); } }
		...
		public virtual EntityCollection<EmployeeTerritoryEntity> EmployeeTerritories { get { return GetOrCreateEntityCollection<EmployeeTerritoryEntity, EmployeeTerritoryEntityFactory>("Territory", true, false, ref _employeeTerritories); } }
		...
		public virtual EntityCollection<EmployeeEntity> EmployeeCollectionViaEmployeeTerritory { get { return GetOrCreateEntityCollection<EmployeeEntity, EmployeeEntityFactory>("TerritoryCollectionViaEmployeeTerritory", false, true, ref _employeeCollectionViaEmployeeTerritory); } }
