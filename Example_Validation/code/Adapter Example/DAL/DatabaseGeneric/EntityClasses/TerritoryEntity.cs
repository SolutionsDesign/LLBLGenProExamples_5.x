...
namespace SD.LLBLGen.Pro.Examples.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<EmployeeEntity> _employeeCollectionViaEmployeeTerritory;
		...
		protected TerritoryEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_employeeCollectionViaEmployeeTerritory = (EntityCollection<EmployeeEntity>)info.GetValue("_employeeCollectionViaEmployeeTerritory", typeof(EntityCollection<EmployeeEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "EmployeeCollectionViaEmployeeTerritory":
					this.EmployeeCollectionViaEmployeeTerritory.IsReadOnly = false;
					this.EmployeeCollectionViaEmployeeTerritory.Add((EmployeeEntity)entity);
					this.EmployeeCollectionViaEmployeeTerritory.IsReadOnly = true;
					break;
				default:
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_employeeCollectionViaEmployeeTerritory", ((_employeeCollectionViaEmployeeTerritory!=null) && (_employeeCollectionViaEmployeeTerritory.Count>0) && !this.MarkedForDeletion)?_employeeCollectionViaEmployeeTerritory:null);
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._employeeCollectionViaEmployeeTerritory);
		}
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			toReturn |= (this._employeeCollectionViaEmployeeTerritory != null);
		...
		private void SetupSyncRegion(IEntityCore relatedEntity)
		{
			if(_region!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _region, new PropertyChangedEventHandler( OnRegionPropertyChanged ), "Region", SD.LLBLGen.Pro.Examples.RelationClasses.StaticTerritoryRelations.RegionEntityUsingRegionIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<EmployeeTerritoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeTerritoryEntityFactory))), (IEntityRelation)GetRelationsForField("EmployeeTerritories")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.TerritoryEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeTerritoryEntity, 0, null, null, null, null, "EmployeeTerritories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathEmployeeCollectionViaEmployeeTerritory
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<EmployeeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.EntityType.TerritoryEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.EmployeeEntity, 0, null, null, GetRelationsForField("EmployeeCollectionViaEmployeeTerritory"), null, "EmployeeCollectionViaEmployeeTerritory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(RegionEntityFactory))),	(IEntityRelation)GetRelationsForField("Region")[0], (int)SD.LLBLGen.Pro.Examples.EntityType.TerritoryEntity, (int)SD.LLBLGen.Pro.Examples.EntityType.RegionEntity, 0, null, null, null, null, "Region", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual EntityCollection<EmployeeEntity> EmployeeCollectionViaEmployeeTerritory
		{
			get { return GetOrCreateEntityCollection<EmployeeEntity, EmployeeEntityFactory>("TerritoryCollectionViaEmployeeTerritory", false, true, ref _employeeCollectionViaEmployeeTerritory);	}
		}
